...
/* 027 */
/* 028 */       boolean isNull1 = i.isNullAt(7);
/* 029 */       double value1 = isNull1 ? -1.0 : (i.getDouble(7));
/* 030 */       if (!isNull1) {
/* 031 */
/* 032 */         boolean isNull2 = i.isNullAt(6);
/* 033 */         double value2 = isNull2 ? -1.0 : (i.getDouble(6));
/* 034 */         if (!isNull2) {
/* 035 */
...
/* 052 */
/* 053 */       boolean isNull1 = i.isNullAt(7);
/* 054 */       double value1 = isNull1 ? -1.0 : (i.getDouble(7));
/* 055 */       if (!isNull1) {
/* 056 */
/* 057 */         boolean isNull2 = i.isNullAt(6);
/* 058 */         double value2 = isNull2 ? -1.0 : (i.getDouble(6));
/* 059 */         if (!isNull2) {
/* 060 */
...
/* 087 */     {
/* 088 */
/* 089 */       boolean isNull3 = i.isNullAt(2);
/* 090 */       UTF8String value3 = isNull3 ? null : (i.getUTF8String(2));
...
/* 097 */     {
/* 098 */
/* 099 */       boolean isNull3 = i.isNullAt(2);
/* 100 */       UTF8String value3 = isNull3 ? null : (i.getUTF8String(2));
