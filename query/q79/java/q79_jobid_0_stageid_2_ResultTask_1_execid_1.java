...
/* 096 */
/* 097 */         if (!scan_isNull1) {
/* 098 */           filter_isNull1 = false; // resultCode could change nullability.
/* 099 */           filter_value1 = scan_value1 == 6;
/* 100 */
/* 101 */         }
/* 102 */         boolean filter_isNull = false;
/* 103 */         boolean filter_value = true;
/* 104 */
/* 105 */         if (!filter_isNull1 && filter_value1) {
/* 106 */         } else {
/* 107 */           boolean filter_isNull4 = true;
/* 108 */           boolean filter_value4 = false;
/* 109 */
/* 110 */           if (!scan_isNull2) {
/* 111 */             filter_isNull4 = false; // resultCode could change nullability.
/* 112 */             filter_value4 = scan_value2 > 2;
/* 113 */
/* 114 */           }
/* 115 */           if (!filter_isNull4 && filter_value4) {
/* 116 */           } else if (!filter_isNull1 && !filter_isNull4) {
/* 117 */             filter_value = false;
/* 118 */           } else {
/* 119 */             filter_isNull = true;
/* 120 */           }
/* 121 */         }
/* 122 */         if (filter_isNull || !filter_value) continue;
/* 123 */
