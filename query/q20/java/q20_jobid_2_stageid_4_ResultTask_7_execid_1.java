...
/* 091 */     {
/* 092 */
/* 093 */       boolean isNull2 = i.isNullAt(6);
/* 094 */       UTF8String value2 = isNull2 ? null : (i.getUTF8String(6));
...
/* 101 */     {
/* 102 */
/* 103 */       boolean isNull2 = i.isNullAt(6);
/* 104 */       UTF8String value2 = isNull2 ? null : (i.getUTF8String(6));
...
/* 128 */       UTF8String value3 = isNull3 ? null : (i.getUTF8String(0));
...
/* 138 */       UTF8String value3 = isNull3 ? null : (i.getUTF8String(0));
...
/* 159 */     {
/* 160 */
/* 161 */       boolean isNull4 = i.isNullAt(5);
/* 162 */       double value4 = isNull4 ? -1.0 : (i.getDouble(5));
...
/* 169 */     {
/* 170 */
/* 171 */       boolean isNull4 = i.isNullAt(5);
/* 172 */       double value4 = isNull4 ? -1.0 : (i.getDouble(5));
