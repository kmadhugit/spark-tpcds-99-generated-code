...
/* 103 */           agg_value8 = org.apache.spark.unsafe.hash.Murmur3_x86_32.hashUnsafeBytes(inputadapter_value1.getBaseObject(), inputadapter_value1.getBaseOffset(), inputadapter_value1.numBytes(), agg_value8);
/* 104 */         }
/* 105 */
...
/* 207 */       UTF8String agg_value21 = agg_isNull20 ? null : (agg_aggKey.getUTF8String(1));
...
/* 231 */       } else {
/* 232 */         agg_rowWriter1.write(2, agg_value21);
/* 233 */       }
/* 234 */
/* 235 */       if (agg_isNull22) {
