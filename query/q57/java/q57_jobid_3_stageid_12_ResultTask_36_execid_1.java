...
/* 030 */       if (!isNull1) {
/* 031 */
/* 032 */         boolean isNull2 = i.isNullAt(5);
/* 033 */         double value2 = isNull2 ? -1.0 : (i.getDouble(5));
/* 034 */         if (!isNull2) {
/* 035 */
...
/* 055 */       if (!isNull1) {
/* 056 */
/* 057 */         boolean isNull2 = i.isNullAt(5);
/* 058 */         double value2 = isNull2 ? -1.0 : (i.getDouble(5));
/* 059 */         if (!isNull2) {
/* 060 */
