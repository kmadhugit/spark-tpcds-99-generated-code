...
/* 053 */
/* 054 */     while (inputadapter_input.hasNext()) {
...
/* 061 */       double inputadapter_value2 = inputadapter_isNull2 ? -1.0 : (inputadapter_row.getDouble(2));
/* 062 */
...
/* 102 */           agg_value6 = org.apache.spark.unsafe.hash.Murmur3_x86_32.hashLong(Double.doubleToLongBits(inputadapter_value2), agg_value6);
/* 103 */         }
/* 104 */         if (true) {
...
/* 166 */       double agg_value12 = agg_isNull12 ? -1.0 : (agg_aggKey.getDouble(2));
