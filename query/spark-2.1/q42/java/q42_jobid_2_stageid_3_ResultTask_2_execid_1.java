...
/* 023 */     {
/* 024 */
/* 025 */       boolean isNull = i.isNullAt(3);
/* 026 */       double value = isNull ? -1.0 : (i.getDouble(3));
/* 027 */       isNullA = isNull;
...
/* 033 */     {
/* 034 */
/* 035 */       boolean isNull = i.isNullAt(3);
/* 036 */       double value = isNull ? -1.0 : (i.getDouble(3));
/* 037 */       isNullB = isNull;
...
/* 060 */       double value1 = isNull1 ? -1.0 : (i.getDouble(4));
...
/* 070 */       double value1 = isNull1 ? -1.0 : (i.getDouble(4));
...
/* 091 */     {
/* 092 */
/* 093 */       boolean isNull2 = i.isNullAt(5);
/* 094 */       double value2 = isNull2 ? -1.0 : (i.getDouble(5));
...
/* 101 */     {
/* 102 */
/* 103 */       boolean isNull2 = i.isNullAt(5);
/* 104 */       double value2 = isNull2 ? -1.0 : (i.getDouble(5));
...
/* 159 */     {
/* 160 */
/* 161 */       boolean isNull4 = i.isNullAt(1);
/* 162 */       int value4 = isNull4 ? -1 : (i.getInt(1));
...
/* 169 */     {
/* 170 */
/* 171 */       boolean isNull4 = i.isNullAt(1);
/* 172 */       int value4 = isNull4 ? -1 : (i.getInt(1));
...
/* 193 */     {
/* 194 */
/* 195 */       boolean isNull5 = i.isNullAt(2);
/* 196 */       UTF8String value5 = isNull5 ? null : (i.getUTF8String(2));
...
/* 203 */     {
/* 204 */
/* 205 */       boolean isNull5 = i.isNullAt(2);
/* 206 */       UTF8String value5 = isNull5 ? null : (i.getUTF8String(2));
