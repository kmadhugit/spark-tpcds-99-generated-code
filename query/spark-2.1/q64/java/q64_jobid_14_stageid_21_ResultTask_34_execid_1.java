...
/* 171 */         } else {
/* 172 */           smj_matches.add(smj_rightRow.copy());
...
/* 182 */       int smj_size = smj_matches.size();
/* 183 */       boolean smj_loaded = false;
/* 184 */       smj_value25 = smj_leftRow.getLong(13);
/* 185 */       for (int smj_i = 0; smj_i < smj_size; smj_i ++) {
/* 186 */         InternalRow smj_rightRow1 = (InternalRow) smj_matches.get(smj_i);
