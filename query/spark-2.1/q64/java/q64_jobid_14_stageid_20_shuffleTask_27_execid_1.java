...
/* 480 */       } else {
/* 481 */         agg_rowWriter1.write(0, agg_value77);
/* 482 */       }
/* 483 */
/* 484 */       if (agg_isNull74) {
/* 485 */         agg_rowWriter1.setNullAt(1);
/* 486 */       } else {
/* 487 */         agg_rowWriter1.write(1, agg_value78);
/* 488 */       }
/* 489 */
/* 490 */       if (agg_isNull75) {
/* 491 */         agg_rowWriter1.setNullAt(2);
/* 492 */       } else {
/* 493 */         agg_rowWriter1.write(2, agg_value79);
/* 494 */       }
/* 495 */
/* 496 */       if (agg_isNull76) {
/* 497 */         agg_rowWriter1.setNullAt(3);
/* 498 */       } else {
/* 499 */         agg_rowWriter1.write(3, agg_value80);
/* 500 */       }
/* 501 */
/* 502 */       if (agg_isNull77) {
/* 503 */         agg_rowWriter1.setNullAt(4);
/* 504 */       } else {
/* 505 */         agg_rowWriter1.write(4, agg_value81);
/* 506 */       }
/* 507 */
/* 508 */       if (agg_isNull78) {
/* 509 */         agg_rowWriter1.setNullAt(5);
/* 510 */       } else {
/* 511 */         agg_rowWriter1.write(5, agg_value82);
/* 512 */       }
/* 513 */
/* 514 */       if (agg_isNull79) {
/* 515 */         agg_rowWriter1.setNullAt(6);
/* 516 */       } else {
/* 517 */         agg_rowWriter1.write(6, agg_value83);
/* 518 */       }
/* 519 */
/* 520 */       if (agg_isNull80) {
/* 521 */         agg_rowWriter1.setNullAt(7);
/* 522 */       } else {
/* 523 */         agg_rowWriter1.write(7, agg_value84);
/* 524 */       }
/* 525 */
/* 526 */       if (agg_isNull81) {
/* 527 */         agg_rowWriter1.setNullAt(8);
/* 528 */       } else {
/* 529 */         agg_rowWriter1.write(8, agg_value85);
/* 530 */       }
/* 531 */
/* 532 */       if (agg_isNull82) {
/* 533 */         agg_rowWriter1.setNullAt(9);
/* 534 */       } else {
/* 535 */         agg_rowWriter1.write(9, agg_value86);
/* 536 */       }
/* 537 */
/* 538 */       if (agg_isNull83) {
/* 539 */         agg_rowWriter1.setNullAt(10);
/* 540 */       } else {
/* 541 */         agg_rowWriter1.write(10, agg_value87);
/* 542 */       }
/* 543 */
/* 544 */       if (agg_isNull84) {
/* 545 */         agg_rowWriter1.setNullAt(11);
/* 546 */       } else {
/* 547 */         agg_rowWriter1.write(11, agg_value88);
/* 548 */       }
/* 549 */
/* 550 */       if (agg_isNull85) {
/* 551 */         agg_rowWriter1.setNullAt(12);
/* 552 */       } else {
/* 553 */         agg_rowWriter1.write(12, agg_value89);
/* 554 */       }
/* 555 */
/* 556 */       agg_rowWriter1.write(13, agg_value92);
/* 557 */
/* 558 */       if (agg_isNull89) {
/* 559 */         agg_rowWriter1.setNullAt(14);
/* 560 */       } else {
/* 561 */         agg_rowWriter1.write(14, agg_value93);
/* 562 */       }
/* 563 */
/* 564 */       if (agg_isNull90) {
/* 565 */         agg_rowWriter1.setNullAt(15);
/* 566 */       } else {
/* 567 */         agg_rowWriter1.write(15, agg_value94);
/* 568 */       }
/* 569 */
/* 570 */       if (agg_isNull91) {
/* 571 */         agg_rowWriter1.setNullAt(16);
/* 572 */       } else {
/* 573 */         agg_rowWriter1.write(16, agg_value95);
/* 574 */       }
/* 575 */       agg_result1.setTotalSize(agg_holder1.totalSize());
/* 576 */       append(agg_result1);
/* 577 */
/* 578 */       if (shouldStop()) return;
/* 579 */     }
/* 580 */
/* 581 */     agg_mapIter.close();
/* 582 */     if (agg_sorter == null) {
/* 583 */       agg_hashMap.free();
/* 584 */     }
/* 585 */   }
/* 586 */ }
