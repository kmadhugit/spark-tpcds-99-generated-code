...
/* 099 */
/* 100 */         if (!(!(scan_isNull2))) continue;
/* 101 */
/* 102 */         boolean scan_isNull3 = scan_colInstance3.isNullAt(scan_rowIdx);
/* 103 */         int scan_value3 = scan_isNull3 ? -1 : (scan_colInstance3.getInt(scan_rowIdx));
/* 104 */
/* 105 */         if (!(!(scan_isNull3))) continue;
/* 106 */
...
/* 115 */
/* 116 */         project_rowWriter.write(1, scan_value1);
/* 117 */
/* 118 */         project_rowWriter.write(2, scan_value2);
/* 119 */
/* 120 */         project_rowWriter.write(3, scan_value3);
/* 121 */         append(project_result);
/* 122 */         if (shouldStop()) return;
/* 123 */       }
/* 124 */       scan_batch = null;
/* 125 */       scan_nextBatch();
/* 126 */     }
/* 127 */     scan_scanTime.add(scan_scanTime1 / (1000 * 1000));
