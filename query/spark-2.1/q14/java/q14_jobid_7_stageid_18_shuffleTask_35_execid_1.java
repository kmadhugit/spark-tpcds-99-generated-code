...
/* 207 */       boolean inputadapter_isNull14 = inputadapter_row.isNullAt(14);
/* 208 */       int inputadapter_value14 = inputadapter_isNull14 ? -1 : (inputadapter_row.getInt(14));
/* 209 */
/* 210 */       // generate join key for stream side
/* 211 */
/* 212 */       boolean bhj_isNull = inputadapter_isNull14;
/* 213 */       long bhj_value = -1L;
/* 214 */       if (!inputadapter_isNull14) {
/* 215 */         bhj_value = (long) inputadapter_value14;
/* 216 */       }
...
/* 222 */
/* 223 */       boolean inputadapter_isNull33 = inputadapter_row.isNullAt(33);
/* 224 */       int inputadapter_value33 = inputadapter_isNull33 ? -1 : (inputadapter_row.getInt(33));
/* 225 */
/* 226 */       // generate join key for stream side
/* 227 */
/* 228 */       boolean bhj_isNull14 = inputadapter_isNull33;
/* 229 */       long bhj_value14 = -1L;
/* 230 */       if (!inputadapter_isNull33) {
/* 231 */         bhj_value14 = (long) inputadapter_value33;
/* 232 */       }
...
/* 238 */
/* 239 */       boolean inputadapter_isNull17 = inputadapter_row.isNullAt(17);
/* 240 */       int inputadapter_value17 = inputadapter_isNull17 ? -1 : (inputadapter_row.getInt(17));
/* 241 */       boolean inputadapter_isNull19 = inputadapter_row.isNullAt(19);
/* 242 */       double inputadapter_value19 = inputadapter_isNull19 ? -1.0 : (inputadapter_row.getDouble(19));
...
/* 329 */
/* 330 */         boolean agg_isNull37 = inputadapter_isNull17;
/* 331 */         double agg_value40 = -1.0;
/* 332 */         if (!inputadapter_isNull17) {
/* 333 */           agg_value40 = (double) inputadapter_value17;
/* 334 */         }
/* 335 */         if (!agg_isNull37) {
/* 336 */           if (!inputadapter_isNull19) {
/* 337 */             agg_isNull36 = false; // resultCode could change nullability.
/* 338 */             agg_value39 = agg_value40 * inputadapter_value19;
/* 339 */
/* 340 */           }
/* 341 */
/* 342 */         }
...
/* 439 */
/* 440 */         boolean agg_isNull17 = inputadapter_isNull17;
/* 441 */         double agg_value20 = -1.0;
/* 442 */         if (!inputadapter_isNull17) {
/* 443 */           agg_value20 = (double) inputadapter_value17;
/* 444 */         }
/* 445 */         if (!agg_isNull17) {
/* 446 */           if (!inputadapter_isNull19) {
/* 447 */             agg_isNull16 = false; // resultCode could change nullability.
/* 448 */             agg_value19 = agg_value20 * inputadapter_value19;
/* 449 */
/* 450 */           }
/* 451 */
/* 452 */         }
