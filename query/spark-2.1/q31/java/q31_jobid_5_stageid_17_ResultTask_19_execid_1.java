...
/* 136 */       smj_value8 = smj_isNull6 ? -1.0 : (smj_leftRow.getDouble(4));
/* 137 */       smj_isNull9 = smj_leftRow.isNullAt(7);
/* 138 */       smj_value11 = smj_isNull9 ? -1.0 : (smj_leftRow.getDouble(7));
/* 139 */       for (int smj_i = 0; smj_i < smj_size; smj_i ++) {
/* 140 */         InternalRow smj_rightRow1 = (InternalRow) smj_matches.get(smj_i);
