...
/* 048 */
/* 049 */     smj_matches = new java.util.ArrayList();
/* 050 */
...
/* 055 */     project_result = new UnsafeRow(8);
/* 056 */     this.project_holder = new org.apache.spark.sql.catalyst.expressions.codegen.BufferHolder(project_result, 64);
/* 057 */     this.project_rowWriter = new org.apache.spark.sql.catalyst.expressions.codegen.UnsafeRowWriter(project_holder, 8);
/* 058 */
/* 059 */   }
/* 060 */
...
/* 069 */
/* 070 */       boolean smj_isNull = smj_leftRow.isNullAt(5);
/* 071 */       UTF8String smj_value = smj_isNull ? null : (smj_leftRow.getUTF8String(5));
/* 072 */       if (smj_isNull) {
...
/* 118 */         } else {
/* 119 */           smj_matches.add(smj_rightRow.copy());
...
/* 129 */       int smj_size = smj_matches.size();
/* 130 */       boolean smj_loaded = false;
/* 131 */       smj_isNull4 = smj_leftRow.isNullAt(2);
/* 132 */       smj_value6 = smj_isNull4 ? -1.0 : (smj_leftRow.getDouble(2));
/* 133 */       smj_isNull5 = smj_leftRow.isNullAt(3);
/* 134 */       smj_value7 = smj_isNull5 ? -1.0 : (smj_leftRow.getDouble(3));
/* 135 */       smj_isNull8 = smj_leftRow.isNullAt(6);
/* 136 */       smj_value10 = smj_isNull8 ? -1.0 : (smj_leftRow.getDouble(6));
...
/* 186 */             smj_value23 = org.apache.spark.util.Utils.nanSafeCompareDoubles(smj_value6, 0.0D) > 0;
/* 187 */
/* 188 */           }
/* 189 */           if (!smj_isNull21 && smj_value23) {
/* 190 */             boolean smj_isNull24 = false;
/* 191 */             double smj_value26 = -1.0;
/* 192 */             if (smj_isNull4 || smj_value6 == 0) {
/* 193 */               smj_isNull24 = true;
/* 194 */             } else {
/* 195 */               if (smj_isNull5) {
/* 196 */                 smj_isNull24 = true;
/* 197 */               } else {
/* 198 */                 smj_value26 = (double)(smj_value7 / smj_value6);
/* 199 */               }
/* 200 */             }
...
/* 222 */           smj_isNull3 = smj_leftRow.isNullAt(1);
/* 223 */           smj_value5 = smj_isNull3 ? -1 : (smj_leftRow.getInt(1));
/* 224 */           smj_isNull6 = smj_leftRow.isNullAt(4);
/* 225 */           smj_value8 = smj_isNull6 ? -1.0 : (smj_leftRow.getDouble(4));
/* 226 */           smj_isNull7 = smj_leftRow.isNullAt(5);
/* 227 */           smj_value9 = smj_isNull7 ? null : (smj_leftRow.getUTF8String(5));
/* 228 */         }
...
/* 239 */         } else {
/* 240 */           project_rowWriter.write(0, smj_value4);
/* 241 */         }
/* 242 */
/* 243 */         if (smj_isNull3) {
/* 244 */           project_rowWriter.setNullAt(1);
/* 245 */         } else {
/* 246 */           project_rowWriter.write(1, smj_value5);
/* 247 */         }
/* 248 */
/* 249 */         if (smj_isNull4) {
/* 250 */           project_rowWriter.setNullAt(2);
/* 251 */         } else {
/* 252 */           project_rowWriter.write(2, smj_value6);
/* 253 */         }
/* 254 */
/* 255 */         if (smj_isNull5) {
/* 256 */           project_rowWriter.setNullAt(3);
/* 257 */         } else {
/* 258 */           project_rowWriter.write(3, smj_value7);
/* 259 */         }
/* 260 */
/* 261 */         if (smj_isNull6) {
/* 262 */           project_rowWriter.setNullAt(4);
/* 263 */         } else {
/* 264 */           project_rowWriter.write(4, smj_value8);
/* 265 */         }
/* 266 */
/* 267 */         if (smj_isNull7) {
/* 268 */           project_rowWriter.setNullAt(5);
/* 269 */         } else {
/* 270 */           project_rowWriter.write(5, smj_value9);
/* 271 */         }
/* 272 */
/* 273 */         if (smj_isNull8) {
/* 274 */           project_rowWriter.setNullAt(6);
/* 275 */         } else {
/* 276 */           project_rowWriter.write(6, smj_value10);
/* 277 */         }
/* 278 */
/* 279 */         if (smj_isNull10) {
/* 280 */           project_rowWriter.setNullAt(7);
/* 281 */         } else {
/* 282 */           project_rowWriter.write(7, smj_value12);
/* 283 */         }
/* 284 */         project_result.setTotalSize(project_holder.totalSize());
/* 285 */         append(project_result.copy());
/* 286 */
/* 287 */       }
