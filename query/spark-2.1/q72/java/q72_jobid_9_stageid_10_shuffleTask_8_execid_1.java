...
/* 064 */     this.wholestagecodegen_numOutputRows = (org.apache.spark.sql.execution.metric.SQLMetric) references[3];
/* 065 */
/* 066 */   }
/* 067 */
...
/* 076 */     private org.apache.spark.sql.types.StructType keySchema = new org.apache.spark.sql.types.StructType().add("i_item_desc", org.apache.spark.sql.types.DataTypes.StringType)
/* 077 */     .add("w_warehouse_name", org.apache.spark.sql.types.DataTypes.StringType)
/* 078 */     .add("d_week_seq", org.apache.spark.sql.types.DataTypes.IntegerType);
/* 079 */     private org.apache.spark.sql.types.StructType valueSchema = new org.apache.spark.sql.types.StructType().add("count", org.apache.spark.sql.types.DataTypes.LongType)
/* 080 */     .add("count", org.apache.spark.sql.types.DataTypes.LongType)
/* 081 */     .add("count", org.apache.spark.sql.types.DataTypes.LongType);
...
/* 346 */     this.wholestagecodegen_aggTime = (org.apache.spark.sql.execution.metric.SQLMetric) references[4];
/* 347 */
/* 348 */   }
/* 349 */
