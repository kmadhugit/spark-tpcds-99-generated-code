...
/* 043 */
/* 044 */     smj_matches = new java.util.ArrayList();
/* 045 */
...
/* 125 */         } else {
/* 126 */           smj_matches.add(smj_rightRow.copy());
...
/* 136 */       int smj_size = smj_matches.size();
/* 137 */       smj_isNull4 = smj_leftRow.isNullAt(0);
/* 138 */       smj_value8 = smj_isNull4 ? -1 : (smj_leftRow.getInt(0));
/* 139 */       smj_isNull5 = smj_leftRow.isNullAt(1);
/* 140 */       smj_value9 = smj_isNull5 ? -1 : (smj_leftRow.getInt(1));
/* 141 */       smj_isNull6 = smj_leftRow.isNullAt(2);
/* 142 */       smj_value10 = smj_isNull6 ? -1 : (smj_leftRow.getInt(2));
/* 143 */       smj_isNull7 = smj_leftRow.isNullAt(3);
/* 144 */       smj_value11 = smj_isNull7 ? -1.0 : (smj_leftRow.getDouble(3));
/* 145 */       smj_isNull8 = smj_leftRow.isNullAt(4);
/* 146 */       smj_value12 = smj_isNull8 ? -1.0 : (smj_leftRow.getDouble(4));
/* 147 */       for (int smj_i = 0; smj_i < smj_size; smj_i ++) {
/* 148 */         InternalRow smj_rightRow1 = (InternalRow) smj_matches.get(smj_i);
/* 149 */
