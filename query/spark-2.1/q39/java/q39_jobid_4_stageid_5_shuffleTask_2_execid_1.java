...
/* 495 */
/* 496 */       filter_numOutputRows.add(1);
/* 497 */
/* 498 */       boolean project_isNull4 = true;
/* 499 */       double project_value4 = -1.0;
/* 500 */
/* 501 */       boolean project_isNull5 = true;
/* 502 */       boolean project_value5 = false;
/* 503 */
/* 504 */       if (!agg_isNull83) {
/* 505 */         project_isNull5 = false; // resultCode could change nullability.
/* 506 */         project_value5 = (java.lang.Double.isNaN(agg_value88) && java.lang.Double.isNaN(0.0D)) || agg_value88 == 0.0D;
/* 507 */
/* 508 */       }
/* 509 */       if (!project_isNull5 && project_value5) {
/* 510 */         final double project_value8 = -1.0;
/* 511 */         project_isNull4 = true;
/* 512 */         project_value4 = project_value8;
/* 513 */       }
/* 514 */
/* 515 */       else {
/* 516 */         boolean project_isNull9 = false;
/* 517 */         double project_value9 = -1.0;
/* 518 */         if (agg_isNull83 || agg_value88 == 0) {
/* 519 */           project_isNull9 = true;
/* 520 */         } else {
/* 521 */           if (agg_isNull67) {
/* 522 */             project_isNull9 = true;
/* 523 */           } else {
/* 524 */             project_value9 = (double)(agg_value72 / agg_value88);
/* 525 */           }
/* 526 */         }
/* 527 */         project_isNull4 = project_isNull9;
/* 528 */         project_value4 = project_value9;
/* 529 */       }
/* 530 */       project_rowWriter.zeroOutNullBytes();
/* 531 */
/* 532 */       if (agg_isNull59) {
/* 533 */         project_rowWriter.setNullAt(0);
/* 534 */       } else {
/* 535 */         project_rowWriter.write(0, agg_value64);
/* 536 */       }
/* 537 */
/* 538 */       if (agg_isNull60) {
/* 539 */         project_rowWriter.setNullAt(1);
/* 540 */       } else {
/* 541 */         project_rowWriter.write(1, agg_value65);
/* 542 */       }
/* 543 */
/* 544 */       if (agg_isNull61) {
/* 545 */         project_rowWriter.setNullAt(2);
/* 546 */       } else {
/* 547 */         project_rowWriter.write(2, agg_value66);
/* 548 */       }
/* 549 */
/* 550 */       if (agg_isNull83) {
/* 551 */         project_rowWriter.setNullAt(3);
/* 552 */       } else {
/* 553 */         project_rowWriter.write(3, agg_value88);
/* 554 */       }
/* 555 */
/* 556 */       if (project_isNull4) {
/* 557 */         project_rowWriter.setNullAt(4);
/* 558 */       } else {
/* 559 */         project_rowWriter.write(4, project_value4);
/* 560 */       }
/* 561 */       append(project_result);
/* 562 */
/* 563 */       if (shouldStop()) return;
/* 564 */     }
/* 565 */
/* 566 */     agg_mapIter.close();
/* 567 */     if (agg_sorter == null) {
/* 568 */       agg_hashMap.free();
/* 569 */     }
/* 570 */   }
/* 571 */ }
