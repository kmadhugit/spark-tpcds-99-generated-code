...
/* 117 */         int scan_value2 = scan_isNull2 ? -1 : (scan_colInstance2.getInt(scan_rowIdx));
/* 118 */
/* 119 */         if (!(!(scan_isNull2))) continue;
/* 120 */
...
/* 128 */
/* 129 */         if (!(!(scan_isNull3))) continue;
/* 130 */
/* 131 */         boolean scan_isNull5 = scan_colInstance5.isNullAt(scan_rowIdx);
/* 132 */         int scan_value5 = scan_isNull5 ? -1 : (scan_colInstance5.getInt(scan_rowIdx));
/* 133 */
/* 134 */         if (!(!(scan_isNull5))) continue;
/* 135 */
