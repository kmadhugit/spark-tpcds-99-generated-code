...
/* 052 */     int value = isNull ? -1 : (i.getInt(0));
/* 053 */     if (isNull) {
...
/* 061 */     int value1 = isNull1 ? -1 : (i.getInt(1));
/* 062 */     if (isNull1) {
...
/* 070 */     int value2 = isNull2 ? -1 : (i.getInt(2));
/* 071 */     if (isNull2) {
...
/* 085 */
/* 086 */
/* 087 */     boolean isNull4 = i.isNullAt(4);
/* 088 */     int value4 = isNull4 ? -1 : (i.getInt(4));
/* 089 */     if (isNull4) {
/* 090 */       rowWriter.setNullAt(4);
/* 091 */     } else {
/* 092 */       rowWriter.write(4, value4);
/* 093 */     }
/* 094 */
/* 095 */   }
/* 096 */
...
/* 104 */     rowWriter.zeroOutNullBytes();
/* 105 */     apply_0(i);
/* 106 */     apply_1(i);
/* 107 */     return result;
/* 108 */   }
