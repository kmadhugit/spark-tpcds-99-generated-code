...
/* 168 */       int numRows = scan_batch.numRows();
/* 169 */       while (scan_batchIdx < numRows) {
/* 170 */         int scan_rowIdx = scan_batchIdx++;
/* 171 */         boolean scan_isNull4 = scan_colInstance4.isNullAt(scan_rowIdx);
/* 172 */         int scan_value4 = scan_isNull4 ? -1 : (scan_colInstance4.getInt(scan_rowIdx));
/* 173 */
/* 174 */         // generate join key for stream side
/* 175 */
/* 176 */         boolean bhj_isNull = scan_isNull4;
/* 177 */         long bhj_value = -1L;
/* 178 */         if (!scan_isNull4) {
/* 179 */           bhj_value = (long) scan_value4;
/* 180 */         }
...
/* 184 */
/* 185 */         bhj_numOutputRows.add(1);
/* 186 */
/* 187 */         boolean scan_isNull2 = scan_colInstance2.isNullAt(scan_rowIdx);
/* 188 */         UTF8String scan_value2 = scan_isNull2 ? null : (scan_colInstance2.getUTF8String(scan_rowIdx));
...
/* 195 */         } else {
/* 196 */           project_rowWriter.write(0, scan_value2);
/* 197 */         }
