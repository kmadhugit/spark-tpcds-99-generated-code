...
/* 131 */           agg_value12 = org.apache.spark.unsafe.hash.Murmur3_x86_32.hashUnsafeBytes(inputadapter_value4.getBaseObject(), inputadapter_value4.getBaseOffset(), inputadapter_value4.numBytes(), agg_value12);
/* 132 */         }
/* 133 */         if (true) {
...
/* 237 */       UTF8String agg_value30 = agg_isNull29 ? null : (agg_aggKey.getUTF8String(4));
...
/* 265 */       } else {
/* 266 */         agg_rowWriter1.write(3, agg_value31);
/* 267 */       }
