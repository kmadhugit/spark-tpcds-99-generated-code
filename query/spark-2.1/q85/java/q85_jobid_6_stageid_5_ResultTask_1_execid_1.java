...
/* 077 */
/* 078 */         filter_numOutputRows.add(1);
/* 079 */
/* 080 */         project_rowWriter.write(0, scan_value);
/* 081 */         append(project_result);
/* 082 */         if (shouldStop()) return;
/* 083 */       }
/* 084 */       scan_batch = null;
/* 085 */       scan_nextBatch();
/* 086 */     }
/* 087 */     scan_scanTime.add(scan_scanTime1 / (1000 * 1000));
