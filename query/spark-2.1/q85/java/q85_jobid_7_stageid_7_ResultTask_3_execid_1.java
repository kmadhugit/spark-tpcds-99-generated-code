...
/* 338 */       boolean agg_isNull52 = agg_isNull42;
/* 339 */       double agg_value60 = -1.0;
/* 340 */       if (!agg_isNull42) {
/* 341 */         agg_value60 = (double) agg_value50;
/* 342 */       }
/* 343 */       boolean agg_isNull49 = false;
/* 344 */       double agg_value57 = -1.0;
/* 345 */       if (agg_isNull52 || agg_value60 == 0) {
/* 346 */         agg_isNull49 = true;
/* 347 */       } else {
/* 348 */         boolean agg_isNull50 = agg_isNull41;
/* 349 */         double agg_value58 = -1.0;
/* 350 */         if (!agg_isNull41) {
/* 351 */           agg_value58 = agg_value49;
/* 352 */         }
/* 353 */         if (agg_isNull50) {
/* 354 */           agg_isNull49 = true;
/* 355 */         } else {
/* 356 */           agg_value57 = (double)(agg_value58 / agg_value60);
/* 357 */         }
/* 358 */       }
/* 359 */       boolean agg_isNull57 = agg_isNull44;
/* 360 */       double agg_value65 = -1.0;
/* 361 */       if (!agg_isNull44) {
/* 362 */         agg_value65 = (double) agg_value52;
/* 363 */       }
/* 364 */       boolean agg_isNull54 = false;
/* 365 */       double agg_value62 = -1.0;
/* 366 */       if (agg_isNull57 || agg_value65 == 0) {
/* 367 */         agg_isNull54 = true;
/* 368 */       } else {
/* 369 */         boolean agg_isNull55 = agg_isNull43;
/* 370 */         double agg_value63 = -1.0;
/* 371 */         if (!agg_isNull43) {
/* 372 */           agg_value63 = agg_value51;
/* 373 */         }
/* 374 */         if (agg_isNull55) {
/* 375 */           agg_isNull54 = true;
/* 376 */         } else {
/* 377 */           agg_value62 = (double)(agg_value63 / agg_value65);
/* 378 */         }
/* 379 */       }
/* 380 */       boolean agg_isNull62 = agg_isNull46;
/* 381 */       double agg_value70 = -1.0;
/* 382 */       if (!agg_isNull46) {
/* 383 */         agg_value70 = (double) agg_value54;
/* 384 */       }
/* 385 */       boolean agg_isNull59 = false;
/* 386 */       double agg_value67 = -1.0;
/* 387 */       if (agg_isNull62 || agg_value70 == 0) {
/* 388 */         agg_isNull59 = true;
/* 389 */       } else {
/* 390 */         boolean agg_isNull60 = agg_isNull45;
/* 391 */         double agg_value68 = -1.0;
/* 392 */         if (!agg_isNull45) {
/* 393 */           agg_value68 = agg_value53;
/* 394 */         }
/* 395 */         if (agg_isNull60) {
/* 396 */           agg_isNull59 = true;
/* 397 */         } else {
/* 398 */           agg_value67 = (double)(agg_value68 / agg_value70);
/* 399 */         }
/* 400 */       }
/* 401 */       boolean agg_isNull67 = agg_isNull48;
/* 402 */       double agg_value75 = -1.0;
/* 403 */       if (!agg_isNull48) {
/* 404 */         agg_value75 = (double) agg_value56;
/* 405 */       }
/* 406 */       boolean agg_isNull64 = false;
/* 407 */       double agg_value72 = -1.0;
/* 408 */       if (agg_isNull67 || agg_value75 == 0) {
/* 409 */         agg_isNull64 = true;
/* 410 */       } else {
/* 411 */         boolean agg_isNull65 = agg_isNull47;
/* 412 */         double agg_value73 = -1.0;
/* 413 */         if (!agg_isNull47) {
/* 414 */           agg_value73 = agg_value55;
/* 415 */         }
/* 416 */         if (agg_isNull65) {
/* 417 */           agg_isNull64 = true;
/* 418 */         } else {
/* 419 */           agg_value72 = (double)(agg_value73 / agg_value75);
/* 420 */         }
/* 421 */       }
/* 422 */
/* 423 */       boolean agg_isNull69 = true;
/* 424 */       UTF8String agg_value77 = null;
/* 425 */
/* 426 */       if (!agg_isNull40) {
/* 427 */         agg_isNull69 = false; // resultCode could change nullability.
/* 428 */         agg_value77 = agg_value48.substringSQL(1, 20);
/* 429 */
/* 430 */       }
/* 431 */       agg_holder1.reset();
/* 432 */
/* 433 */       agg_rowWriter1.zeroOutNullBytes();
/* 434 */
/* 435 */       if (agg_isNull69) {
/* 436 */         agg_rowWriter1.setNullAt(0);
/* 437 */       } else {
/* 438 */         agg_rowWriter1.write(0, agg_value77);
/* 439 */       }
/* 440 */
/* 441 */       if (agg_isNull49) {
/* 442 */         agg_rowWriter1.setNullAt(1);
/* 443 */       } else {
/* 444 */         agg_rowWriter1.write(1, agg_value57);
/* 445 */       }
/* 446 */
/* 447 */       if (agg_isNull54) {
/* 448 */         agg_rowWriter1.setNullAt(2);
/* 449 */       } else {
/* 450 */         agg_rowWriter1.write(2, agg_value62);
/* 451 */       }
/* 452 */
/* 453 */       if (agg_isNull59) {
/* 454 */         agg_rowWriter1.setNullAt(3);
/* 455 */       } else {
/* 456 */         agg_rowWriter1.write(3, agg_value67);
/* 457 */       }
/* 458 */
/* 459 */       if (agg_isNull64) {
/* 460 */         agg_rowWriter1.setNullAt(4);
/* 461 */       } else {
/* 462 */         agg_rowWriter1.write(4, agg_value72);
/* 463 */       }
/* 464 */       agg_result1.setTotalSize(agg_holder1.totalSize());
/* 465 */       append(agg_result1);
/* 466 */
/* 467 */       if (shouldStop()) return;
/* 468 */     }
/* 469 */
/* 470 */     agg_mapIter.close();
/* 471 */     if (agg_sorter == null) {
/* 472 */       agg_hashMap.free();
/* 473 */     }
/* 474 */   }
/* 475 */ }
