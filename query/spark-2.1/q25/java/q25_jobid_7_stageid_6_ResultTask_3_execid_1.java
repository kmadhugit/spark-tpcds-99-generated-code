...
/* 161 */         if (!false) {
/* 162 */           agg_value19 = (double) 0;
/* 163 */         }
/* 164 */         // evaluate aggregate function
/* 165 */         boolean agg_isNull19 = true;
/* 166 */         double agg_value22 = -1.0;
/* 167 */
/* 168 */         boolean agg_isNull21 = agg_unsafeRowAggBuffer.isNullAt(0);
/* 169 */         double agg_value24 = agg_isNull21 ? -1.0 : (agg_unsafeRowAggBuffer.getDouble(0));
/* 170 */         boolean agg_isNull20 = agg_isNull21;
/* 171 */         double agg_value23 = agg_value24;
/* 172 */         if (agg_isNull20) {
/* 173 */           if (!agg_isNull16) {
...
/* 185 */         double agg_value21 = agg_value22;
/* 186 */         if (agg_isNull18) {
/* 187 */           boolean agg_isNull23 = agg_unsafeRowAggBuffer.isNullAt(0);
/* 188 */           double agg_value26 = agg_isNull23 ? -1.0 : (agg_unsafeRowAggBuffer.getDouble(0));
/* 189 */           if (!agg_isNull23) {
...
/* 195 */         double agg_value28 = -1.0;
/* 196 */
/* 197 */         boolean agg_isNull27 = agg_unsafeRowAggBuffer.isNullAt(1);
/* 198 */         double agg_value30 = agg_isNull27 ? -1.0 : (agg_unsafeRowAggBuffer.getDouble(1));
/* 199 */         boolean agg_isNull26 = agg_isNull27;
/* 200 */         double agg_value29 = agg_value30;
/* 201 */         if (agg_isNull26) {
/* 202 */           if (!agg_isNull16) {
...
/* 214 */         double agg_value27 = agg_value28;
/* 215 */         if (agg_isNull24) {
/* 216 */           boolean agg_isNull29 = agg_unsafeRowAggBuffer.isNullAt(1);
/* 217 */           double agg_value32 = agg_isNull29 ? -1.0 : (agg_unsafeRowAggBuffer.getDouble(1));
/* 218 */           if (!agg_isNull29) {
...
/* 224 */         double agg_value34 = -1.0;
/* 225 */
/* 226 */         boolean agg_isNull33 = agg_unsafeRowAggBuffer.isNullAt(2);
/* 227 */         double agg_value36 = agg_isNull33 ? -1.0 : (agg_unsafeRowAggBuffer.getDouble(2));
/* 228 */         boolean agg_isNull32 = agg_isNull33;
/* 229 */         double agg_value35 = agg_value36;
/* 230 */         if (agg_isNull32) {
/* 231 */           if (!agg_isNull16) {
...
/* 243 */         double agg_value33 = agg_value34;
/* 244 */         if (agg_isNull30) {
/* 245 */           boolean agg_isNull35 = agg_unsafeRowAggBuffer.isNullAt(2);
/* 246 */           double agg_value38 = agg_isNull35 ? -1.0 : (agg_unsafeRowAggBuffer.getDouble(2));
/* 247 */           if (!agg_isNull35) {
...
/* 253 */         if (!agg_isNull18) {
/* 254 */           agg_unsafeRowAggBuffer.setDouble(0, agg_value21);
/* 255 */         } else {
/* 256 */           agg_unsafeRowAggBuffer.setNullAt(0);
/* 257 */         }
/* 258 */
/* 259 */         if (!agg_isNull24) {
/* 260 */           agg_unsafeRowAggBuffer.setDouble(1, agg_value27);
/* 261 */         } else {
/* 262 */           agg_unsafeRowAggBuffer.setNullAt(1);
/* 263 */         }
/* 264 */
/* 265 */         if (!agg_isNull30) {
/* 266 */           agg_unsafeRowAggBuffer.setDouble(2, agg_value33);
/* 267 */         } else {
...
/* 302 */       double agg_value43 = agg_isNull40 ? -1.0 : (agg_aggBuffer.getDouble(0));
/* 303 */       boolean agg_isNull41 = agg_aggBuffer.isNullAt(1);
/* 304 */       double agg_value44 = agg_isNull41 ? -1.0 : (agg_aggBuffer.getDouble(1));
/* 305 */       boolean agg_isNull42 = agg_aggBuffer.isNullAt(2);
/* 306 */       double agg_value45 = agg_isNull42 ? -1.0 : (agg_aggBuffer.getDouble(2));
/* 307 */
