...
/* 127 */           agg_value12 = org.apache.spark.unsafe.hash.Murmur3_x86_32.hashUnsafeBytes(inputadapter_value3.getBaseObject(), inputadapter_value3.getBaseOffset(), inputadapter_value3.numBytes(), agg_value12);
/* 128 */         }
/* 129 */
/* 130 */         if (!inputadapter_isNull4) {
/* 131 */           agg_value12 = org.apache.spark.unsafe.hash.Murmur3_x86_32.hashLong(Double.doubleToLongBits(inputadapter_value4), agg_value12);
/* 132 */         }
/* 133 */         if (true) {
...
/* 235 */       UTF8String agg_value29 = agg_isNull28 ? null : (agg_aggKey.getUTF8String(3));
/* 236 */       boolean agg_isNull29 = agg_aggKey.isNullAt(4);
/* 237 */       double agg_value30 = agg_isNull29 ? -1.0 : (agg_aggKey.getDouble(4));
...
/* 247 */       } else {
/* 248 */         agg_rowWriter1.write(0, agg_value27);
/* 249 */       }
/* 250 */
/* 251 */       if (agg_isNull27) {
/* 252 */         agg_rowWriter1.setNullAt(1);
/* 253 */       } else {
/* 254 */         agg_rowWriter1.write(1, agg_value28);
/* 255 */       }
/* 256 */
/* 257 */       if (agg_isNull28) {
/* 258 */         agg_rowWriter1.setNullAt(2);
/* 259 */       } else {
/* 260 */         agg_rowWriter1.write(2, agg_value29);
/* 261 */       }
/* 262 */
/* 263 */       if (agg_isNull29) {
/* 264 */         agg_rowWriter1.setNullAt(3);
/* 265 */       } else {
/* 266 */         agg_rowWriter1.write(3, agg_value30);
/* 267 */       }
/* 268 */
/* 269 */       if (agg_isNull30) {
/* 270 */         agg_rowWriter1.setNullAt(4);
/* 271 */       } else {
/* 272 */         agg_rowWriter1.write(4, agg_value31);
/* 273 */       }
/* 274 */
/* 275 */       if (agg_isNull25) {
/* 276 */         agg_rowWriter1.setNullAt(5);
/* 277 */       } else {
/* 278 */         agg_rowWriter1.write(5, agg_value26);
/* 279 */       }
