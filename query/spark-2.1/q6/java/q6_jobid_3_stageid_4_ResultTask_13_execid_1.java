...
/* 226 */       }
/* 227 */
/* 228 */       if (!(!(agg_isNull16))) continue;
/* 229 */
/* 230 */       filter_numOutputRows.add(1);
/* 231 */
/* 232 */       filter_holder.reset();
/* 233 */
/* 234 */       filter_rowWriter.zeroOutNullBytes();
/* 235 */
/* 236 */       filter_rowWriter.write(0, agg_value18);
/* 237 */
/* 238 */       if (agg_isNull13) {
/* 239 */         filter_rowWriter.setNullAt(1);
/* 240 */       } else {
/* 241 */         filter_rowWriter.write(1, agg_value15);
/* 242 */       }
/* 243 */       filter_result.setTotalSize(filter_holder.totalSize());
/* 244 */       append(filter_result);
/* 245 */
