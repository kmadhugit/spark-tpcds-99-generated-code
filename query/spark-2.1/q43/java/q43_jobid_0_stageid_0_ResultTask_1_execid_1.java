...
/* 097 */         filter_value2 = scan_value1 >= 1998;
/* 098 */         if (!filter_value2) continue;
/* 099 */         boolean filter_isNull5 = false;
/* 100 */
/* 101 */         boolean filter_value5 = false;
/* 102 */         filter_value5 = scan_value1 <= 2000;
/* 103 */         if (!filter_value5) continue;
/* 104 */         boolean scan_isNull = scan_colInstance0.isNullAt(scan_rowIdx);
/* 105 */         int scan_value = scan_isNull ? -1 : (scan_colInstance0.getInt(scan_rowIdx));
/* 106 */
/* 107 */         if (!(!(scan_isNull))) continue;
/* 108 */
/* 109 */         boolean filter_isNull10 = false;
/* 110 */
/* 111 */         boolean filter_value10 = false;
/* 112 */         filter_value10 = scan_value >= 2450816;
/* 113 */         if (!filter_value10) continue;
/* 114 */         boolean filter_isNull13 = false;
/* 115 */
/* 116 */         boolean filter_value13 = false;
/* 117 */         filter_value13 = scan_value <= 2451726;
/* 118 */         if (!filter_value13) continue;
/* 119 */
/* 120 */         filter_numOutputRows.add(1);
/* 121 */
/* 122 */         boolean scan_isNull2 = scan_colInstance2.isNullAt(scan_rowIdx);
/* 123 */         UTF8String scan_value2 = scan_isNull2 ? null : (scan_colInstance2.getUTF8String(scan_rowIdx));
...
/* 132 */         } else {
/* 133 */           project_rowWriter.write(1, scan_value2);
/* 134 */         }
/* 135 */         project_result.setTotalSize(project_holder.totalSize());
/* 136 */         append(project_result);
/* 137 */         if (shouldStop()) return;
/* 138 */       }
/* 139 */       scan_batch = null;
/* 140 */       scan_nextBatch();
/* 141 */     }
/* 142 */     scan_scanTime.add(scan_scanTime1 / (1000 * 1000));
/* 143 */     scan_scanTime1 = 0;
/* 144 */   }
/* 145 */ }
