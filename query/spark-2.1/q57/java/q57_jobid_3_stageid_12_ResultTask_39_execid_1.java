...
/* 175 */         } else {
/* 176 */           smj_matches.add(smj_rightRow.copy());
...
/* 186 */       int smj_size = smj_matches.size();
/* 187 */       smj_isNull10 = smj_leftRow.isNullAt(0);
/* 188 */       smj_value18 = smj_isNull10 ? null : (smj_leftRow.getUTF8String(0));
/* 189 */       smj_isNull11 = smj_leftRow.isNullAt(1);
/* 190 */       smj_value19 = smj_isNull11 ? null : (smj_leftRow.getUTF8String(1));
/* 191 */       smj_isNull12 = smj_leftRow.isNullAt(2);
/* 192 */       smj_value20 = smj_isNull12 ? null : (smj_leftRow.getUTF8String(2));
/* 193 */       smj_value21 = smj_leftRow.getInt(3);
/* 194 */       smj_isNull13 = smj_leftRow.isNullAt(4);
/* 195 */       smj_value22 = smj_isNull13 ? -1 : (smj_leftRow.getInt(4));
/* 196 */       smj_isNull14 = smj_leftRow.isNullAt(5);
/* 197 */       smj_value23 = smj_isNull14 ? -1.0 : (smj_leftRow.getDouble(5));
/* 198 */       smj_value24 = smj_leftRow.getDouble(6);
/* 199 */       smj_value25 = smj_leftRow.getInt(7);
/* 200 */       for (int smj_i = 0; smj_i < smj_size; smj_i ++) {
/* 201 */         InternalRow smj_rightRow1 = (InternalRow) smj_matches.get(smj_i);
/* 202 */
