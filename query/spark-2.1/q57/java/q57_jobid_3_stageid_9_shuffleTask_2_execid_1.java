...
/* 300 */
/* 301 */         boolean scan_isNull2 = scan_colInstance2.isNullAt(scan_rowIdx);
/* 302 */         UTF8String scan_value2 = scan_isNull2 ? null : (scan_colInstance2.getUTF8String(scan_rowIdx));
/* 303 */
/* 304 */         if (!(!(scan_isNull2))) continue;
/* 305 */
/* 306 */         boolean scan_isNull1 = scan_colInstance1.isNullAt(scan_rowIdx);
/* 307 */         UTF8String scan_value1 = scan_isNull1 ? null : (scan_colInstance1.getUTF8String(scan_rowIdx));
/* 308 */
/* 309 */         if (!(!(scan_isNull1))) continue;
/* 310 */
