...
/* 054 */     }
/* 055 */
/* 056 */     int value5 = i.getInt(7);
/* 057 */     value1 = org.apache.spark.unsafe.hash.Murmur3_x86_32.hashInt(value5, value1);
/* 058 */
/* 059 */     int value = -1;
/* 060 */
/* 061 */     int remainder = value1 % 64;
/* 062 */     if (remainder < 0) {
/* 063 */       value = (remainder + 64) % 64;
/* 064 */     } else {
/* 065 */       value = remainder;
/* 066 */     }
/* 067 */     rowWriter.write(0, value);
/* 068 */     return result;
/* 069 */   }
/* 070 */ }
