...
/* 181 */         } else {
/* 182 */           smj_matches.add(smj_rightRow.copy());
...
/* 192 */       int smj_size = smj_matches.size();
/* 193 */       smj_isNull10 = smj_leftRow.isNullAt(0);
/* 194 */       smj_value18 = smj_isNull10 ? null : (smj_leftRow.getUTF8String(0));
/* 195 */       smj_isNull11 = smj_leftRow.isNullAt(1);
/* 196 */       smj_value19 = smj_isNull11 ? null : (smj_leftRow.getUTF8String(1));
/* 197 */       smj_isNull12 = smj_leftRow.isNullAt(2);
/* 198 */       smj_value20 = smj_isNull12 ? null : (smj_leftRow.getUTF8String(2));
/* 199 */       smj_isNull13 = smj_leftRow.isNullAt(3);
/* 200 */       smj_value21 = smj_isNull13 ? -1 : (smj_leftRow.getInt(3));
/* 201 */       smj_isNull14 = smj_leftRow.isNullAt(4);
/* 202 */       smj_value22 = smj_isNull14 ? -1 : (smj_leftRow.getInt(4));
/* 203 */       smj_isNull15 = smj_leftRow.isNullAt(5);
/* 204 */       smj_value23 = smj_isNull15 ? -1.0 : (smj_leftRow.getDouble(5));
/* 205 */       smj_isNull16 = smj_leftRow.isNullAt(6);
/* 206 */       smj_value24 = smj_isNull16 ? -1.0 : (smj_leftRow.getDouble(6));
/* 207 */       smj_isNull17 = smj_leftRow.isNullAt(7);
/* 208 */       smj_value25 = smj_isNull17 ? -1 : (smj_leftRow.getInt(7));
/* 209 */       smj_isNull18 = smj_leftRow.isNullAt(8);
/* 210 */       smj_value26 = smj_isNull18 ? -1.0 : (smj_leftRow.getDouble(8));
/* 211 */       for (int smj_i = 0; smj_i < smj_size; smj_i ++) {
/* 212 */         InternalRow smj_rightRow1 = (InternalRow) smj_matches.get(smj_i);
/* 213 */
