...
/* 051 */     this.agg_holder = new org.apache.spark.sql.catalyst.expressions.codegen.BufferHolder(agg_result, 32);
...
/* 055 */     this.agg_holder1 = new org.apache.spark.sql.catalyst.expressions.codegen.BufferHolder(agg_result1, 32);
...
/* 068 */       int inputadapter_value = inputadapter_isNull ? -1 : (inputadapter_row.getInt(0));
...
/* 072 */       int inputadapter_value2 = inputadapter_isNull2 ? -1 : (inputadapter_row.getInt(2));
/* 073 */       boolean inputadapter_isNull3 = inputadapter_row.isNullAt(3);
/* 074 */       double inputadapter_value3 = inputadapter_isNull3 ? -1.0 : (inputadapter_row.getDouble(3));
/* 075 */       boolean inputadapter_isNull4 = inputadapter_row.isNullAt(4);
/* 076 */       double inputadapter_value4 = inputadapter_isNull4 ? -1.0 : (inputadapter_row.getDouble(4));
/* 077 */       boolean inputadapter_isNull5 = inputadapter_row.isNullAt(5);
/* 078 */       double inputadapter_value5 = inputadapter_isNull5 ? -1.0 : (inputadapter_row.getDouble(5));
/* 079 */       boolean inputadapter_isNull6 = inputadapter_row.isNullAt(6);
/* 080 */       double inputadapter_value6 = inputadapter_isNull6 ? -1.0 : (inputadapter_row.getDouble(6));
/* 081 */       boolean inputadapter_isNull7 = inputadapter_row.isNullAt(7);
/* 082 */       double inputadapter_value7 = inputadapter_isNull7 ? -1.0 : (inputadapter_row.getDouble(7));
/* 083 */
...
/* 115 */           agg_value16 = org.apache.spark.unsafe.hash.Murmur3_x86_32.hashInt(inputadapter_value, agg_value16);
/* 116 */         }
/* 117 */
...
/* 123 */           agg_value16 = org.apache.spark.unsafe.hash.Murmur3_x86_32.hashInt(inputadapter_value2, agg_value16);
/* 124 */         }
/* 125 */         if (true) {
...
/* 156 */         double agg_value20 = -1.0;
/* 157 */         if (!false) {
/* 158 */           agg_value20 = (double) 0;
/* 159 */         }
/* 160 */         // evaluate aggregate function
/* 161 */         boolean agg_isNull18 = true;
/* 162 */         double agg_value23 = -1.0;
/* 163 */
/* 164 */         boolean agg_isNull20 = agg_unsafeRowAggBuffer.isNullAt(0);
/* 165 */         double agg_value25 = agg_isNull20 ? -1.0 : (agg_unsafeRowAggBuffer.getDouble(0));
/* 166 */         boolean agg_isNull19 = agg_isNull20;
/* 167 */         double agg_value24 = agg_value25;
/* 168 */         if (agg_isNull19) {
/* 169 */           if (!agg_isNull15) {
...
/* 181 */         double agg_value22 = agg_value23;
/* 182 */         if (agg_isNull17) {
/* 183 */           boolean agg_isNull22 = agg_unsafeRowAggBuffer.isNullAt(0);
/* 184 */           double agg_value27 = agg_isNull22 ? -1.0 : (agg_unsafeRowAggBuffer.getDouble(0));
/* 185 */           if (!agg_isNull22) {
...
/* 191 */         double agg_value29 = -1.0;
/* 192 */
/* 193 */         boolean agg_isNull26 = agg_unsafeRowAggBuffer.isNullAt(1);
/* 194 */         double agg_value31 = agg_isNull26 ? -1.0 : (agg_unsafeRowAggBuffer.getDouble(1));
/* 195 */         boolean agg_isNull25 = agg_isNull26;
/* 196 */         double agg_value30 = agg_value31;
/* 197 */         if (agg_isNull25) {
/* 198 */           if (!agg_isNull15) {
...
/* 210 */         double agg_value28 = agg_value29;
/* 211 */         if (agg_isNull23) {
/* 212 */           boolean agg_isNull28 = agg_unsafeRowAggBuffer.isNullAt(1);
/* 213 */           double agg_value33 = agg_isNull28 ? -1.0 : (agg_unsafeRowAggBuffer.getDouble(1));
/* 214 */           if (!agg_isNull28) {
...
/* 220 */         double agg_value35 = -1.0;
/* 221 */
/* 222 */         boolean agg_isNull32 = agg_unsafeRowAggBuffer.isNullAt(2);
/* 223 */         double agg_value37 = agg_isNull32 ? -1.0 : (agg_unsafeRowAggBuffer.getDouble(2));
/* 224 */         boolean agg_isNull31 = agg_isNull32;
/* 225 */         double agg_value36 = agg_value37;
/* 226 */         if (agg_isNull31) {
/* 227 */           if (!agg_isNull15) {
...
/* 242 */           double agg_value39 = agg_isNull34 ? -1.0 : (agg_unsafeRowAggBuffer.getDouble(2));
/* 243 */           if (!agg_isNull34) {
...
/* 249 */         double agg_value41 = -1.0;
/* 250 */
/* 251 */         boolean agg_isNull38 = agg_unsafeRowAggBuffer.isNullAt(3);
/* 252 */         double agg_value43 = agg_isNull38 ? -1.0 : (agg_unsafeRowAggBuffer.getDouble(3));
/* 253 */         boolean agg_isNull37 = agg_isNull38;
/* 254 */         double agg_value42 = agg_value43;
/* 255 */         if (agg_isNull37) {
/* 256 */           if (!agg_isNull15) {
...
/* 268 */         double agg_value40 = agg_value41;
/* 269 */         if (agg_isNull35) {
/* 270 */           boolean agg_isNull40 = agg_unsafeRowAggBuffer.isNullAt(3);
/* 271 */           double agg_value45 = agg_isNull40 ? -1.0 : (agg_unsafeRowAggBuffer.getDouble(3));
/* 272 */           if (!agg_isNull40) {
...
/* 278 */         double agg_value47 = -1.0;
/* 279 */
/* 280 */         boolean agg_isNull44 = agg_unsafeRowAggBuffer.isNullAt(4);
/* 281 */         double agg_value49 = agg_isNull44 ? -1.0 : (agg_unsafeRowAggBuffer.getDouble(4));
/* 282 */         boolean agg_isNull43 = agg_isNull44;
/* 283 */         double agg_value48 = agg_value49;
/* 284 */         if (agg_isNull43) {
/* 285 */           if (!agg_isNull15) {
...
/* 297 */         double agg_value46 = agg_value47;
/* 298 */         if (agg_isNull41) {
/* 299 */           boolean agg_isNull46 = agg_unsafeRowAggBuffer.isNullAt(4);
/* 300 */           double agg_value51 = agg_isNull46 ? -1.0 : (agg_unsafeRowAggBuffer.getDouble(4));
/* 301 */           if (!agg_isNull46) {
...
/* 307 */         if (!agg_isNull17) {
/* 308 */           agg_unsafeRowAggBuffer.setDouble(0, agg_value22);
/* 309 */         } else {
/* 310 */           agg_unsafeRowAggBuffer.setNullAt(0);
/* 311 */         }
/* 312 */
/* 313 */         if (!agg_isNull23) {
/* 314 */           agg_unsafeRowAggBuffer.setDouble(1, agg_value28);
/* 315 */         } else {
/* 316 */           agg_unsafeRowAggBuffer.setNullAt(1);
/* 317 */         }
/* 318 */
/* 319 */         if (!agg_isNull29) {
/* 320 */           agg_unsafeRowAggBuffer.setDouble(2, agg_value34);
/* 321 */         } else {
/* 322 */           agg_unsafeRowAggBuffer.setNullAt(2);
/* 323 */         }
/* 324 */
/* 325 */         if (!agg_isNull35) {
/* 326 */           agg_unsafeRowAggBuffer.setDouble(3, agg_value40);
/* 327 */         } else {
/* 328 */           agg_unsafeRowAggBuffer.setNullAt(3);
/* 329 */         }
/* 330 */
/* 331 */         if (!agg_isNull41) {
/* 332 */           agg_unsafeRowAggBuffer.setDouble(4, agg_value46);
/* 333 */         } else {
...
/* 360 */       int agg_value52 = agg_isNull47 ? -1 : (agg_aggKey.getInt(0));
...
/* 364 */       int agg_value54 = agg_isNull49 ? -1 : (agg_aggKey.getInt(2));
/* 365 */       boolean agg_isNull50 = agg_aggBuffer.isNullAt(0);
/* 366 */       double agg_value55 = agg_isNull50 ? -1.0 : (agg_aggBuffer.getDouble(0));
/* 367 */       boolean agg_isNull51 = agg_aggBuffer.isNullAt(1);
/* 368 */       double agg_value56 = agg_isNull51 ? -1.0 : (agg_aggBuffer.getDouble(1));
/* 369 */       boolean agg_isNull52 = agg_aggBuffer.isNullAt(2);
/* 370 */       double agg_value57 = agg_isNull52 ? -1.0 : (agg_aggBuffer.getDouble(2));
/* 371 */       boolean agg_isNull53 = agg_aggBuffer.isNullAt(3);
/* 372 */       double agg_value58 = agg_isNull53 ? -1.0 : (agg_aggBuffer.getDouble(3));
/* 373 */       boolean agg_isNull54 = agg_aggBuffer.isNullAt(4);
/* 374 */       double agg_value59 = agg_isNull54 ? -1.0 : (agg_aggBuffer.getDouble(4));
/* 375 */
...
/* 388 */       } else {
/* 389 */         agg_rowWriter1.write(1, agg_value54);
/* 390 */       }
/* 391 */
/* 392 */       if (agg_isNull48) {
/* 393 */         agg_rowWriter1.setNullAt(2);
/* 394 */       } else {
/* 395 */         agg_rowWriter1.write(2, agg_value53);
/* 396 */       }
/* 397 */
/* 398 */       if (agg_isNull50) {
