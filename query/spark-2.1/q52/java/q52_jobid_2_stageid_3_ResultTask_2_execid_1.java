...
/* 057 */     {
/* 058 */
/* 059 */       boolean isNull1 = i.isNullAt(3);
/* 060 */       double value1 = isNull1 ? -1.0 : (i.getDouble(3));
...
/* 067 */     {
/* 068 */
/* 069 */       boolean isNull1 = i.isNullAt(3);
/* 070 */       double value1 = isNull1 ? -1.0 : (i.getDouble(3));
...
/* 094 */       int value2 = isNull2 ? -1 : (i.getInt(1));
...
/* 104 */       int value2 = isNull2 ? -1 : (i.getInt(1));
