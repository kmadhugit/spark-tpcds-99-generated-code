...
/* 092 */     private org.apache.spark.sql.types.StructType keySchema = new org.apache.spark.sql.types.StructType().add("ctr_store_sk", org.apache.spark.sql.types.DataTypes.LongType);
...
/* 419 */       long inputadapter_value = inputadapter_isNull ? -1L : (inputadapter_row.getLong(0));
/* 420 */       boolean inputadapter_isNull1 = inputadapter_row.isNullAt(1);
/* 421 */       long inputadapter_value1 = inputadapter_isNull1 ? -1L : (inputadapter_row.getLong(1));
...
/* 447 */           agg_value11 = org.apache.spark.unsafe.hash.Murmur3_x86_32.hashLong(inputadapter_value, agg_value11);
/* 448 */         }
/* 449 */
/* 450 */         if (!inputadapter_isNull1) {
/* 451 */           agg_value11 = org.apache.spark.unsafe.hash.Murmur3_x86_32.hashLong(inputadapter_value1, agg_value11);
/* 452 */         }
/* 453 */         if (true) {
