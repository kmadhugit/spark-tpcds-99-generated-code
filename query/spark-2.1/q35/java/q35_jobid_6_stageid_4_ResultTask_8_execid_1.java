...
/* 125 */     {
/* 126 */
/* 127 */       boolean isNull3 = i.isNullAt(17);
/* 128 */       int value3 = isNull3 ? -1 : (i.getInt(17));
...
/* 135 */     {
/* 136 */
/* 137 */       boolean isNull3 = i.isNullAt(17);
/* 138 */       int value3 = isNull3 ? -1 : (i.getInt(17));
...
/* 159 */     {
/* 160 */
/* 161 */       boolean isNull4 = i.isNullAt(7);
/* 162 */       int value4 = isNull4 ? -1 : (i.getInt(7));
...
/* 169 */     {
/* 170 */
/* 171 */       boolean isNull4 = i.isNullAt(7);
/* 172 */       int value4 = isNull4 ? -1 : (i.getInt(7));
...
/* 193 */     {
/* 194 */
/* 195 */       boolean isNull5 = i.isNullAt(12);
/* 196 */       int value5 = isNull5 ? -1 : (i.getInt(12));
...
/* 203 */     {
/* 204 */
/* 205 */       boolean isNull5 = i.isNullAt(12);
/* 206 */       int value5 = isNull5 ? -1 : (i.getInt(12));
