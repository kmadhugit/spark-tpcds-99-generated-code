...
/* 084 */
/* 085 */     while (inputadapter_input.hasNext()) {
...
/* 526 */       boolean agg_isNull109 = agg_isNull92;
/* 527 */       double agg_value124 = -1.0;
/* 528 */       if (!agg_isNull92) {
/* 529 */         agg_value124 = (double) agg_value107;
/* 530 */       }
/* 531 */       boolean agg_isNull106 = false;
/* 532 */       double agg_value121 = -1.0;
/* 533 */       if (agg_isNull109 || agg_value124 == 0) {
/* 534 */         agg_isNull106 = true;
/* 535 */       } else {
/* 536 */         boolean agg_isNull107 = agg_isNull91;
/* 537 */         double agg_value122 = -1.0;
/* 538 */         if (!agg_isNull91) {
/* 539 */           agg_value122 = agg_value106;
/* 540 */         }
/* 541 */         if (agg_isNull107) {
/* 542 */           agg_isNull106 = true;
/* 543 */         } else {
/* 544 */           agg_value121 = (double)(agg_value122 / agg_value124);
/* 545 */         }
/* 546 */       }
/* 547 */       boolean agg_isNull117 = agg_isNull97;
/* 548 */       double agg_value132 = -1.0;
/* 549 */       if (!agg_isNull97) {
/* 550 */         agg_value132 = (double) agg_value112;
/* 551 */       }
/* 552 */       boolean agg_isNull114 = false;
/* 553 */       double agg_value129 = -1.0;
/* 554 */       if (agg_isNull117 || agg_value132 == 0) {
/* 555 */         agg_isNull114 = true;
/* 556 */       } else {
/* 557 */         boolean agg_isNull115 = agg_isNull96;
/* 558 */         double agg_value130 = -1.0;
/* 559 */         if (!agg_isNull96) {
/* 560 */           agg_value130 = agg_value111;
/* 561 */         }
/* 562 */         if (agg_isNull115) {
/* 563 */           agg_isNull114 = true;
/* 564 */         } else {
/* 565 */           agg_value129 = (double)(agg_value130 / agg_value132);
/* 566 */         }
/* 567 */       }
/* 568 */       boolean agg_isNull125 = agg_isNull102;
/* 569 */       double agg_value140 = -1.0;
/* 570 */       if (!agg_isNull102) {
/* 571 */         agg_value140 = (double) agg_value117;
/* 572 */       }
/* 573 */       boolean agg_isNull122 = false;
/* 574 */       double agg_value137 = -1.0;
/* 575 */       if (agg_isNull125 || agg_value140 == 0) {
/* 576 */         agg_isNull122 = true;
/* 577 */       } else {
/* 578 */         boolean agg_isNull123 = agg_isNull101;
/* 579 */         double agg_value138 = -1.0;
/* 580 */         if (!agg_isNull101) {
/* 581 */           agg_value138 = agg_value116;
/* 582 */         }
/* 583 */         if (agg_isNull123) {
/* 584 */           agg_isNull122 = true;
/* 585 */         } else {
/* 586 */           agg_value137 = (double)(agg_value138 / agg_value140);
/* 587 */         }
/* 588 */       }
/* 589 */
/* 590 */       agg_holder1.reset();
/* 591 */
/* 592 */       agg_rowWriter1.zeroOutNullBytes();
/* 593 */
/* 594 */       if (agg_isNull82) {
/* 595 */         agg_rowWriter1.setNullAt(0);
/* 596 */       } else {
/* 597 */         agg_rowWriter1.write(0, agg_value97);
/* 598 */       }
/* 599 */
/* 600 */       if (agg_isNull83) {
/* 601 */         agg_rowWriter1.setNullAt(1);
/* 602 */       } else {
/* 603 */         agg_rowWriter1.write(1, agg_value98);
/* 604 */       }
/* 605 */
/* 606 */       if (agg_isNull84) {
/* 607 */         agg_rowWriter1.setNullAt(2);
/* 608 */       } else {
/* 609 */         agg_rowWriter1.write(2, agg_value99);
/* 610 */       }
/* 611 */
/* 612 */       agg_rowWriter1.write(3, agg_value103);
/* 613 */
/* 614 */       if (agg_isNull89) {
/* 615 */         agg_rowWriter1.setNullAt(4);
/* 616 */       } else {
/* 617 */         agg_rowWriter1.write(4, agg_value104);
/* 618 */       }
/* 619 */
/* 620 */       if (agg_isNull90) {
/* 621 */         agg_rowWriter1.setNullAt(5);
/* 622 */       } else {
/* 623 */         agg_rowWriter1.write(5, agg_value105);
/* 624 */       }
/* 625 */
/* 626 */       if (agg_isNull106) {
/* 627 */         agg_rowWriter1.setNullAt(6);
/* 628 */       } else {
/* 629 */         agg_rowWriter1.write(6, agg_value121);
/* 630 */       }
/* 631 */
/* 632 */       if (agg_isNull86) {
/* 633 */         agg_rowWriter1.setNullAt(7);
/* 634 */       } else {
/* 635 */         agg_rowWriter1.write(7, agg_value101);
/* 636 */       }
/* 637 */
/* 638 */       agg_rowWriter1.write(8, agg_value108);
/* 639 */
/* 640 */       if (agg_isNull94) {
/* 641 */         agg_rowWriter1.setNullAt(9);
/* 642 */       } else {
/* 643 */         agg_rowWriter1.write(9, agg_value109);
/* 644 */       }
/* 645 */
/* 646 */       if (agg_isNull95) {
/* 647 */         agg_rowWriter1.setNullAt(10);
/* 648 */       } else {
/* 649 */         agg_rowWriter1.write(10, agg_value110);
/* 650 */       }
/* 651 */
/* 652 */       if (agg_isNull114) {
/* 653 */         agg_rowWriter1.setNullAt(11);
/* 654 */       } else {
/* 655 */         agg_rowWriter1.write(11, agg_value129);
/* 656 */       }
/* 657 */
/* 658 */       if (agg_isNull87) {
/* 659 */         agg_rowWriter1.setNullAt(12);
/* 660 */       } else {
/* 661 */         agg_rowWriter1.write(12, agg_value102);
/* 662 */       }
/* 663 */
/* 664 */       agg_rowWriter1.write(13, agg_value113);
/* 665 */
/* 666 */       if (agg_isNull99) {
/* 667 */         agg_rowWriter1.setNullAt(14);
/* 668 */       } else {
/* 669 */         agg_rowWriter1.write(14, agg_value114);
/* 670 */       }
/* 671 */
/* 672 */       if (agg_isNull100) {
/* 673 */         agg_rowWriter1.setNullAt(15);
/* 674 */       } else {
/* 675 */         agg_rowWriter1.write(15, agg_value115);
/* 676 */       }
/* 677 */
/* 678 */       if (agg_isNull122) {
/* 679 */         agg_rowWriter1.setNullAt(16);
/* 680 */       } else {
/* 681 */         agg_rowWriter1.write(16, agg_value137);
/* 682 */       }
/* 683 */
/* 684 */       if (agg_isNull85) {
/* 685 */         agg_rowWriter1.setNullAt(17);
/* 686 */       } else {
/* 687 */         agg_rowWriter1.write(17, agg_value100);
/* 688 */       }
/* 689 */       agg_result1.setTotalSize(agg_holder1.totalSize());
/* 690 */       append(agg_result1);
/* 691 */
/* 692 */       if (shouldStop()) return;
/* 693 */     }
/* 694 */
/* 695 */     agg_mapIter.close();
/* 696 */     if (agg_sorter == null) {
/* 697 */       agg_hashMap.free();
/* 698 */     }
/* 699 */   }
/* 700 */ }
