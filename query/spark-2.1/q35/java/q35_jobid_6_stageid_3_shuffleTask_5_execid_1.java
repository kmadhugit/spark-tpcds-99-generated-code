...
/* 022 */
/* 023 */     Platform.putLong(buf, 24, Platform.getLong(obj1, offset1 + 0) | (Platform.getLong(obj2, offset2) << 6));
/* 024 */
...
/* 051 */       buf, 200 + numBytesVariableRow1,
/* 052 */       numBytesVariableRow2);
/* 053 */
/* 054 */
/* 055 */     Platform.putLong(buf, 32, Platform.getLong(buf, 32) + (120L << 32));
/* 056 */
/* 057 */
/* 058 */     Platform.putLong(buf, 40, Platform.getLong(buf, 40) + (120L << 32));
/* 059 */
/* 060 */
/* 061 */     Platform.putLong(buf, 48, Platform.getLong(buf, 48) + (120L << 32));
/* 062 */
/* 063 */
/* 064 */
/* 065 */
