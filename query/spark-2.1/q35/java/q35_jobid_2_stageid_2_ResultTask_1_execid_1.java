...
/* 172 */         filter_value2 = scan_value6 == 2002;
/* 173 */         if (!filter_value2) continue;
/* 174 */         boolean scan_isNull10 = scan_colInstance10.isNullAt(scan_rowIdx);
/* 175 */         int scan_value10 = scan_isNull10 ? -1 : (scan_colInstance10.getInt(scan_rowIdx));
/* 176 */
/* 177 */         if (!(!(scan_isNull10))) continue;
/* 178 */
/* 179 */         boolean filter_isNull7 = false;
/* 180 */
/* 181 */         boolean filter_value7 = false;
/* 182 */         filter_value7 = scan_value10 < 4;
/* 183 */         if (!filter_value7) continue;
/* 184 */
/* 185 */         boolean scan_isNull = scan_colInstance0.isNullAt(scan_rowIdx);
/* 186 */         int scan_value = scan_isNull ? -1 : (scan_colInstance0.getInt(scan_rowIdx));
/* 187 */
/* 188 */         if (!(!(scan_isNull))) continue;
/* 189 */
/* 190 */         filter_numOutputRows.add(1);
/* 191 */
/* 192 */         boolean scan_isNull1 = scan_colInstance1.isNullAt(scan_rowIdx);
/* 193 */         UTF8String scan_value1 = scan_isNull1 ? null : (scan_colInstance1.getUTF8String(scan_rowIdx));
/* 194 */         boolean scan_isNull2 = scan_colInstance2.isNullAt(scan_rowIdx);
/* 195 */         UTF8String scan_value2 = scan_isNull2 ? null : (scan_colInstance2.getUTF8String(scan_rowIdx));
...
/* 198 */         boolean scan_isNull4 = scan_colInstance4.isNullAt(scan_rowIdx);
/* 199 */         int scan_value4 = scan_isNull4 ? -1 : (scan_colInstance4.getInt(scan_rowIdx));
/* 200 */         boolean scan_isNull5 = scan_colInstance5.isNullAt(scan_rowIdx);
/* 201 */         int scan_value5 = scan_isNull5 ? -1 : (scan_colInstance5.getInt(scan_rowIdx));
...
/* 208 */         boolean scan_isNull11 = scan_colInstance11.isNullAt(scan_rowIdx);
/* 209 */         int scan_value11 = scan_isNull11 ? -1 : (scan_colInstance11.getInt(scan_rowIdx));
/* 210 */         boolean scan_isNull12 = scan_colInstance12.isNullAt(scan_rowIdx);
/* 211 */         int scan_value12 = scan_isNull12 ? -1 : (scan_colInstance12.getInt(scan_rowIdx));
/* 212 */         boolean scan_isNull13 = scan_colInstance13.isNullAt(scan_rowIdx);
/* 213 */         int scan_value13 = scan_isNull13 ? -1 : (scan_colInstance13.getInt(scan_rowIdx));
/* 214 */         boolean scan_isNull14 = scan_colInstance14.isNullAt(scan_rowIdx);
/* 215 */         UTF8String scan_value14 = scan_isNull14 ? null : (scan_colInstance14.getUTF8String(scan_rowIdx));
/* 216 */         boolean scan_isNull15 = scan_colInstance15.isNullAt(scan_rowIdx);
/* 217 */         UTF8String scan_value15 = scan_isNull15 ? null : (scan_colInstance15.getUTF8String(scan_rowIdx));
/* 218 */         boolean scan_isNull16 = scan_colInstance16.isNullAt(scan_rowIdx);
/* 219 */         UTF8String scan_value16 = scan_isNull16 ? null : (scan_colInstance16.getUTF8String(scan_rowIdx));
/* 220 */         boolean scan_isNull17 = scan_colInstance17.isNullAt(scan_rowIdx);
/* 221 */         UTF8String scan_value17 = scan_isNull17 ? null : (scan_colInstance17.getUTF8String(scan_rowIdx));
/* 222 */         boolean scan_isNull18 = scan_colInstance18.isNullAt(scan_rowIdx);
/* 223 */         UTF8String scan_value18 = scan_isNull18 ? null : (scan_colInstance18.getUTF8String(scan_rowIdx));
/* 224 */         boolean scan_isNull19 = scan_colInstance19.isNullAt(scan_rowIdx);
/* 225 */         int scan_value19 = scan_isNull19 ? -1 : (scan_colInstance19.getInt(scan_rowIdx));
/* 226 */         boolean scan_isNull20 = scan_colInstance20.isNullAt(scan_rowIdx);
/* 227 */         int scan_value20 = scan_isNull20 ? -1 : (scan_colInstance20.getInt(scan_rowIdx));
/* 228 */         boolean scan_isNull21 = scan_colInstance21.isNullAt(scan_rowIdx);
/* 229 */         int scan_value21 = scan_isNull21 ? -1 : (scan_colInstance21.getInt(scan_rowIdx));
/* 230 */         boolean scan_isNull22 = scan_colInstance22.isNullAt(scan_rowIdx);
/* 231 */         int scan_value22 = scan_isNull22 ? -1 : (scan_colInstance22.getInt(scan_rowIdx));
/* 232 */         boolean scan_isNull23 = scan_colInstance23.isNullAt(scan_rowIdx);
/* 233 */         UTF8String scan_value23 = scan_isNull23 ? null : (scan_colInstance23.getUTF8String(scan_rowIdx));
/* 234 */         boolean scan_isNull24 = scan_colInstance24.isNullAt(scan_rowIdx);
/* 235 */         UTF8String scan_value24 = scan_isNull24 ? null : (scan_colInstance24.getUTF8String(scan_rowIdx));
/* 236 */         boolean scan_isNull25 = scan_colInstance25.isNullAt(scan_rowIdx);
/* 237 */         UTF8String scan_value25 = scan_isNull25 ? null : (scan_colInstance25.getUTF8String(scan_rowIdx));
/* 238 */         boolean scan_isNull26 = scan_colInstance26.isNullAt(scan_rowIdx);
/* 239 */         UTF8String scan_value26 = scan_isNull26 ? null : (scan_colInstance26.getUTF8String(scan_rowIdx));
/* 240 */         boolean scan_isNull27 = scan_colInstance27.isNullAt(scan_rowIdx);
/* 241 */         UTF8String scan_value27 = scan_isNull27 ? null : (scan_colInstance27.getUTF8String(scan_rowIdx));
/* 242 */         project_holder.reset();
/* 243 */
/* 244 */         project_rowWriter.zeroOutNullBytes();
/* 245 */
/* 246 */         project_rowWriter.write(0, scan_value);
/* 247 */
/* 248 */         if (scan_isNull1) {
/* 249 */           project_rowWriter.setNullAt(1);
/* 250 */         } else {
/* 251 */           project_rowWriter.write(1, scan_value1);
/* 252 */         }
/* 253 */
/* 254 */         if (scan_isNull2) {
/* 255 */           project_rowWriter.setNullAt(2);
/* 256 */         } else {
/* 257 */           project_rowWriter.write(2, scan_value2);
/* 258 */         }
/* 259 */
/* 260 */         if (scan_isNull3) {
/* 261 */           project_rowWriter.setNullAt(3);
/* 262 */         } else {
/* 263 */           project_rowWriter.write(3, scan_value3);
/* 264 */         }
/* 265 */
/* 266 */         if (scan_isNull4) {
/* 267 */           project_rowWriter.setNullAt(4);
/* 268 */         } else {
/* 269 */           project_rowWriter.write(4, scan_value4);
/* 270 */         }
/* 271 */
/* 272 */         if (scan_isNull5) {
/* 273 */           project_rowWriter.setNullAt(5);
/* 274 */         } else {
/* 275 */           project_rowWriter.write(5, scan_value5);
/* 276 */         }
/* 277 */
/* 278 */         project_rowWriter.write(6, scan_value6);
/* 279 */
/* 280 */         if (scan_isNull7) {
/* 281 */           project_rowWriter.setNullAt(7);
/* 282 */         } else {
/* 283 */           project_rowWriter.write(7, scan_value7);
/* 284 */         }
/* 285 */
/* 286 */         if (scan_isNull8) {
/* 287 */           project_rowWriter.setNullAt(8);
/* 288 */         } else {
/* 289 */           project_rowWriter.write(8, scan_value8);
/* 290 */         }
/* 291 */
/* 292 */         if (scan_isNull9) {
/* 293 */           project_rowWriter.setNullAt(9);
/* 294 */         } else {
/* 295 */           project_rowWriter.write(9, scan_value9);
/* 296 */         }
/* 297 */
/* 298 */         project_rowWriter.write(10, scan_value10);
/* 299 */
/* 300 */         if (scan_isNull11) {
/* 301 */           project_rowWriter.setNullAt(11);
/* 302 */         } else {
/* 303 */           project_rowWriter.write(11, scan_value11);
/* 304 */         }
/* 305 */
/* 306 */         if (scan_isNull12) {
/* 307 */           project_rowWriter.setNullAt(12);
/* 308 */         } else {
/* 309 */           project_rowWriter.write(12, scan_value12);
/* 310 */         }
/* 311 */
/* 312 */         if (scan_isNull13) {
/* 313 */           project_rowWriter.setNullAt(13);
/* 314 */         } else {
/* 315 */           project_rowWriter.write(13, scan_value13);
/* 316 */         }
/* 317 */
/* 318 */         if (scan_isNull14) {
/* 319 */           project_rowWriter.setNullAt(14);
/* 320 */         } else {
/* 321 */           project_rowWriter.write(14, scan_value14);
/* 322 */         }
/* 323 */
/* 324 */         if (scan_isNull15) {
/* 325 */           project_rowWriter.setNullAt(15);
/* 326 */         } else {
/* 327 */           project_rowWriter.write(15, scan_value15);
/* 328 */         }
/* 329 */
/* 330 */         if (scan_isNull16) {
/* 331 */           project_rowWriter.setNullAt(16);
/* 332 */         } else {
/* 333 */           project_rowWriter.write(16, scan_value16);
/* 334 */         }
/* 335 */
/* 336 */         if (scan_isNull17) {
/* 337 */           project_rowWriter.setNullAt(17);
/* 338 */         } else {
/* 339 */           project_rowWriter.write(17, scan_value17);
/* 340 */         }
/* 341 */
/* 342 */         if (scan_isNull18) {
/* 343 */           project_rowWriter.setNullAt(18);
/* 344 */         } else {
/* 345 */           project_rowWriter.write(18, scan_value18);
/* 346 */         }
/* 347 */
/* 348 */         if (scan_isNull19) {
/* 349 */           project_rowWriter.setNullAt(19);
/* 350 */         } else {
/* 351 */           project_rowWriter.write(19, scan_value19);
/* 352 */         }
/* 353 */
/* 354 */         if (scan_isNull20) {
/* 355 */           project_rowWriter.setNullAt(20);
/* 356 */         } else {
/* 357 */           project_rowWriter.write(20, scan_value20);
/* 358 */         }
/* 359 */
/* 360 */         if (scan_isNull21) {
/* 361 */           project_rowWriter.setNullAt(21);
/* 362 */         } else {
/* 363 */           project_rowWriter.write(21, scan_value21);
/* 364 */         }
/* 365 */
/* 366 */         if (scan_isNull22) {
/* 367 */           project_rowWriter.setNullAt(22);
/* 368 */         } else {
/* 369 */           project_rowWriter.write(22, scan_value22);
/* 370 */         }
/* 371 */
/* 372 */         if (scan_isNull23) {
/* 373 */           project_rowWriter.setNullAt(23);
/* 374 */         } else {
/* 375 */           project_rowWriter.write(23, scan_value23);
/* 376 */         }
/* 377 */
/* 378 */         if (scan_isNull24) {
/* 379 */           project_rowWriter.setNullAt(24);
/* 380 */         } else {
/* 381 */           project_rowWriter.write(24, scan_value24);
/* 382 */         }
/* 383 */
/* 384 */         if (scan_isNull25) {
/* 385 */           project_rowWriter.setNullAt(25);
/* 386 */         } else {
/* 387 */           project_rowWriter.write(25, scan_value25);
/* 388 */         }
/* 389 */
/* 390 */         if (scan_isNull26) {
/* 391 */           project_rowWriter.setNullAt(26);
/* 392 */         } else {
/* 393 */           project_rowWriter.write(26, scan_value26);
/* 394 */         }
/* 395 */
/* 396 */         if (scan_isNull27) {
/* 397 */           project_rowWriter.setNullAt(27);
/* 398 */         } else {
/* 399 */           project_rowWriter.write(27, scan_value27);
/* 400 */         }
/* 401 */         project_result.setTotalSize(project_holder.totalSize());
/* 402 */         append(project_result);
