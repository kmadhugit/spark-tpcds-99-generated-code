...
/* 102 */         filter_value5 = scan_value2 <= 12;
...
/* 112 */         filter_value10 = scan_value1 == 1999;
...
/* 118 */
/* 119 */         boolean filter_isNull15 = false;
/* 120 */
/* 121 */         boolean filter_value15 = false;
/* 122 */         filter_value15 = scan_value <= 2451544;
/* 123 */         if (!filter_value15) continue;
/* 124 */         boolean filter_isNull18 = false;
/* 125 */
/* 126 */         boolean filter_value18 = false;
/* 127 */         filter_value18 = scan_value >= 2451453;
/* 128 */         if (!filter_value18) continue;
/* 129 */
/* 130 */         filter_numOutputRows.add(1);
/* 131 */
/* 132 */         project_rowWriter.write(0, scan_value);
/* 133 */         append(project_result);
/* 134 */         if (shouldStop()) return;
/* 135 */       }
/* 136 */       scan_batch = null;
/* 137 */       scan_nextBatch();
/* 138 */     }
