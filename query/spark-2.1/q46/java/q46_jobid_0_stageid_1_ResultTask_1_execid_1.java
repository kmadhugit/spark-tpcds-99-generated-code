...
/* 112 */
/* 113 */         }
/* 114 */         if (filter_isNull || !filter_value) continue;
...
/* 117 */
/* 118 */         boolean filter_value4 = false;
/* 119 */         boolean filter_isNull4 = scan_isNull1;
/* 120 */         if (!filter_isNull4) {
/* 121 */           if (!filter_value4) {
/* 122 */             if (false) {
/* 123 */               filter_isNull4 = true;
/* 124 */             } else if (scan_value1 == 1999) {
/* 125 */               filter_isNull4 = false;
/* 126 */               filter_value4 = true;
/* 127 */             }
/* 128 */           }
/* 129 */
/* 130 */           if (!filter_value4) {
/* 131 */             if (false) {
/* 132 */               filter_isNull4 = true;
/* 133 */             } else if (scan_value1 == 2000) {
/* 134 */               filter_isNull4 = false;
/* 135 */               filter_value4 = true;
/* 136 */             }
/* 137 */           }
/* 138 */
/* 139 */           if (!filter_value4) {
/* 140 */             if (false) {
/* 141 */               filter_isNull4 = true;
/* 142 */             } else if (scan_value1 == 2001) {
/* 143 */               filter_isNull4 = false;
/* 144 */               filter_value4 = true;
/* 145 */             }
/* 146 */           }
/* 147 */
/* 148 */         }
/* 149 */         if (filter_isNull4 || !filter_value4) continue;
/* 150 */
/* 151 */         boolean scan_isNull = scan_colInstance0.isNullAt(scan_rowIdx);
/* 152 */         int scan_value = scan_isNull ? -1 : (scan_colInstance0.getInt(scan_rowIdx));
/* 153 */
/* 154 */         if (!(!(scan_isNull))) continue;
/* 155 */
/* 156 */         filter_numOutputRows.add(1);
/* 157 */
/* 158 */         project_rowWriter.write(0, scan_value);
