...
/* 206 */       boolean agg_isNull19 = agg_isNull15;
/* 207 */       double agg_value21 = -1.0;
/* 208 */       if (!agg_isNull15) {
/* 209 */         agg_value21 = (double) agg_value17;
/* 210 */       }
/* 211 */       boolean agg_isNull16 = false;
/* 212 */       double agg_value18 = -1.0;
/* 213 */       if (agg_isNull19 || agg_value21 == 0) {
/* 214 */         agg_isNull16 = true;
/* 215 */       } else {
/* 216 */         boolean agg_isNull17 = agg_isNull14;
/* 217 */         double agg_value19 = -1.0;
/* 218 */         if (!agg_isNull14) {
/* 219 */           agg_value19 = agg_value16;
/* 220 */         }
/* 221 */         if (agg_isNull17) {
/* 222 */           agg_isNull16 = true;
/* 223 */         } else {
/* 224 */           agg_value18 = (double)(agg_value19 / agg_value21);
/* 225 */         }
/* 226 */       }
/* 227 */
/* 228 */       boolean agg_isNull21 = true;
/* 229 */       double agg_value23 = -1.0;
/* 230 */
/* 231 */       if (!agg_isNull16) {
/* 232 */         agg_isNull21 = false; // resultCode could change nullability.
/* 233 */         agg_value23 = agg_value18 * 1.2D;
/* 234 */
/* 235 */       }
/* 236 */
/* 237 */       if (!(!(agg_isNull21))) continue;
/* 238 */
/* 239 */       filter_numOutputRows.add(1);
/* 240 */
/* 241 */       filter_holder.reset();
/* 242 */
/* 243 */       filter_rowWriter.zeroOutNullBytes();
/* 244 */
/* 245 */       filter_rowWriter.write(0, agg_value23);
/* 246 */
/* 247 */       if (agg_isNull13) {
/* 248 */         filter_rowWriter.setNullAt(1);
/* 249 */       } else {
/* 250 */         filter_rowWriter.write(1, agg_value15);
/* 251 */       }
/* 252 */       filter_result.setTotalSize(filter_holder.totalSize());
/* 253 */       append(filter_result);
/* 254 */
/* 255 */       if (shouldStop()) return;
/* 256 */     }
/* 257 */
/* 258 */     agg_mapIter.close();
/* 259 */     if (agg_sorter == null) {
/* 260 */       agg_hashMap.free();
/* 261 */     }
/* 262 */   }
/* 263 */ }
