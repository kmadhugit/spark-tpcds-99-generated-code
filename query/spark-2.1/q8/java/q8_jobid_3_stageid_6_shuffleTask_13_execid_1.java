...
/* 036 */     UTF8String value2 = isNull2 ? null : (i.getUTF8String(0));
/* 037 */     boolean isNull1 = isNull2;
/* 038 */     UTF8String value1 = value2;
/* 039 */     if (isNull1) {
/* 040 */
/* 041 */       Object obj = ((Expression) references[0]).eval(null);
/* 042 */       UTF8String value3 = (UTF8String) obj;
/* 043 */       if (!false) {
/* 044 */         isNull1 = false;
/* 045 */         value1 = value3;
/* 046 */       }
/* 047 */     }
/* 048 */     long value = 0L;
/* 049 */     boolean isNull = isNull1;
/* 050 */     if (!isNull1) {
/* 051 */       value = org.apache.spark.util.collection.unsafe.sort.PrefixComparators$StringPrefixComparator.computePrefix(value1);
/* 052 */     }
/* 053 */     if (isNull) {
