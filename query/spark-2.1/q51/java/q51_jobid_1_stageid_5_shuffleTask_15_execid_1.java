...
/* 028 */     while (inputadapter_input.hasNext()) {
...
/* 034 */       boolean inputadapter_isNull4 = inputadapter_row.isNullAt(4);
/* 035 */       double inputadapter_value4 = inputadapter_isNull4 ? -1.0 : (inputadapter_row.getDouble(4));
...
/* 044 */       }
/* 045 */
/* 046 */       if (inputadapter_isNull1) {
/* 047 */         project_rowWriter.setNullAt(1);
/* 048 */       } else {
/* 049 */         project_rowWriter.write(1, inputadapter_value1);
/* 050 */       }
/* 051 */
/* 052 */       if (inputadapter_isNull4) {
/* 053 */         project_rowWriter.setNullAt(2);
/* 054 */       } else {
/* 055 */         project_rowWriter.write(2, inputadapter_value4);
/* 056 */       }
