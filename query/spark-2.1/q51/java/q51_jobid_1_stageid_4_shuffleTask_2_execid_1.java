...
/* 193 */       int agg_value17 = agg_isNull16 ? -1 : (agg_aggKey.getInt(0));
...
/* 220 */
/* 221 */       if (agg_isNull16) {
/* 222 */         agg_rowWriter1.setNullAt(3);
/* 223 */       } else {
/* 224 */         agg_rowWriter1.write(3, agg_value17);
/* 225 */       }
/* 226 */       agg_result1.setTotalSize(agg_holder1.totalSize());
