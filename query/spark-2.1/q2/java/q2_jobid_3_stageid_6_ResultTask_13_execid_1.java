...
/* 128 */         } else {
/* 129 */           smj_matches.add(smj_rightRow.copy());
...
/* 139 */       int smj_size = smj_matches.size();
/* 140 */       smj_isNull4 = smj_leftRow.isNullAt(0);
/* 141 */       smj_value6 = smj_isNull4 ? -1 : (smj_leftRow.getInt(0));
/* 142 */       smj_isNull5 = smj_leftRow.isNullAt(1);
/* 143 */       smj_value7 = smj_isNull5 ? -1.0 : (smj_leftRow.getDouble(1));
/* 144 */       smj_isNull6 = smj_leftRow.isNullAt(2);
/* 145 */       smj_value8 = smj_isNull6 ? -1.0 : (smj_leftRow.getDouble(2));
/* 146 */       smj_isNull7 = smj_leftRow.isNullAt(3);
/* 147 */       smj_value9 = smj_isNull7 ? -1.0 : (smj_leftRow.getDouble(3));
/* 148 */       smj_isNull8 = smj_leftRow.isNullAt(4);
/* 149 */       smj_value10 = smj_isNull8 ? -1.0 : (smj_leftRow.getDouble(4));
/* 150 */       smj_isNull9 = smj_leftRow.isNullAt(5);
/* 151 */       smj_value11 = smj_isNull9 ? -1.0 : (smj_leftRow.getDouble(5));
/* 152 */       smj_isNull10 = smj_leftRow.isNullAt(6);
/* 153 */       smj_value12 = smj_isNull10 ? -1.0 : (smj_leftRow.getDouble(6));
/* 154 */       smj_isNull11 = smj_leftRow.isNullAt(7);
/* 155 */       smj_value13 = smj_isNull11 ? -1.0 : (smj_leftRow.getDouble(7));
