...
/* 117 */         UTF8String scan_value3 = scan_isNull3 ? null : (scan_colInstance3.getUTF8String(scan_rowIdx));
/* 118 */
/* 119 */         if (!(!(scan_isNull3))) continue;
/* 120 */
/* 121 */         boolean filter_isNull12 = false;
/* 122 */
/* 123 */         Object filter_obj2 = ((Expression) references[5]).eval(null);
/* 124 */         UTF8String filter_value14 = (UTF8String) filter_obj2;
/* 125 */         boolean filter_value12 = false;
/* 126 */         filter_value12 = scan_value3.equals(filter_value14);
/* 127 */         if (!filter_value12) continue;
/* 128 */
...
/* 135 */
/* 136 */         project_rowWriter.write(0, scan_value);
