...
/* 095 */         project_holder.reset();
/* 096 */
/* 097 */         project_rowWriter.zeroOutNullBytes();
/* 098 */
/* 099 */         project_rowWriter.write(0, scan_value);
/* 100 */
/* 101 */         if (scan_isNull1) {
/* 102 */           project_rowWriter.setNullAt(1);
/* 103 */         } else {
/* 104 */           project_rowWriter.write(1, scan_value1);
/* 105 */         }
/* 106 */         project_result.setTotalSize(project_holder.totalSize());
/* 107 */         append(project_result);
