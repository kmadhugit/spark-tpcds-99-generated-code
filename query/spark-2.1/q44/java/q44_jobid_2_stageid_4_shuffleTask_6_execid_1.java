...
/* 076 */
/* 077 */     while (inputadapter_input.hasNext()) {
...
/* 259 */       boolean agg_isNull30 = agg_isNull24;
/* 260 */       double agg_value34 = -1.0;
/* 261 */       if (!agg_isNull24) {
/* 262 */         agg_value34 = (double) agg_value28;
/* 263 */       }
/* 264 */       boolean agg_isNull27 = false;
/* 265 */       double agg_value31 = -1.0;
/* 266 */       if (agg_isNull30 || agg_value34 == 0) {
/* 267 */         agg_isNull27 = true;
/* 268 */       } else {
/* 269 */         boolean agg_isNull28 = agg_isNull23;
/* 270 */         double agg_value32 = -1.0;
/* 271 */         if (!agg_isNull23) {
/* 272 */           agg_value32 = agg_value27;
/* 273 */         }
/* 274 */         if (agg_isNull28) {
/* 275 */           agg_isNull27 = true;
/* 276 */         } else {
/* 277 */           agg_value31 = (double)(agg_value32 / agg_value34);
/* 278 */         }
/* 279 */       }
/* 280 */       boolean agg_isNull35 = agg_isNull26;
/* 281 */       double agg_value39 = -1.0;
/* 282 */       if (!agg_isNull26) {
/* 283 */         agg_value39 = (double) agg_value30;
/* 284 */       }
/* 285 */       boolean agg_isNull32 = false;
/* 286 */       double agg_value36 = -1.0;
/* 287 */       if (agg_isNull35 || agg_value39 == 0) {
/* 288 */         agg_isNull32 = true;
/* 289 */       } else {
/* 290 */         boolean agg_isNull33 = agg_isNull25;
/* 291 */         double agg_value37 = -1.0;
/* 292 */         if (!agg_isNull25) {
/* 293 */           agg_value37 = agg_value29;
/* 294 */         }
/* 295 */         if (agg_isNull33) {
/* 296 */           agg_isNull32 = true;
/* 297 */         } else {
/* 298 */           agg_value36 = (double)(agg_value37 / agg_value39);
/* 299 */         }
/* 300 */       }
/* 301 */
/* 302 */       if (!(!(agg_isNull32))) continue;
/* 303 */
/* 304 */       boolean filter_isNull2 = true;
/* 305 */       boolean filter_value2 = false;
/* 306 */
/* 307 */       boolean filter_isNull4 = true;
/* 308 */       double filter_value4 = -1.0;
/* 309 */
/* 310 */       final double filter_value6 = -1.0;
/* 311 */       if (!true) {
/* 312 */         filter_isNull4 = false; // resultCode could change nullability.
/* 313 */         filter_value4 = 0.9D * filter_value6;
/* 314 */
/* 315 */       }
/* 316 */       if (!filter_isNull4) {
/* 317 */         filter_isNull2 = false; // resultCode could change nullability.
/* 318 */         filter_value2 = org.apache.spark.util.Utils.nanSafeCompareDoubles(agg_value36, filter_value4) > 0;
/* 319 */
/* 320 */       }
/* 321 */       if (filter_isNull2 || !filter_value2) continue;
/* 322 */
/* 323 */       filter_numOutputRows.add(1);
/* 324 */
/* 325 */       project_rowWriter.zeroOutNullBytes();
/* 326 */
/* 327 */       if (agg_isNull22) {
/* 328 */         project_rowWriter.setNullAt(0);
/* 329 */       } else {
/* 330 */         project_rowWriter.write(0, agg_value26);
/* 331 */       }
/* 332 */
/* 333 */       if (agg_isNull27) {
/* 334 */         project_rowWriter.setNullAt(1);
/* 335 */       } else {
/* 336 */         project_rowWriter.write(1, agg_value31);
/* 337 */       }
