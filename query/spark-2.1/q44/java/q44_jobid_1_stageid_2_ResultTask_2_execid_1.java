...
/* 185 */       boolean agg_isNull19 = agg_isNull15;
/* 186 */       double agg_value21 = -1.0;
/* 187 */       if (!agg_isNull15) {
/* 188 */         agg_value21 = (double) agg_value17;
/* 189 */       }
/* 190 */       boolean agg_isNull16 = false;
/* 191 */       double agg_value18 = -1.0;
/* 192 */       if (agg_isNull19 || agg_value21 == 0) {
/* 193 */         agg_isNull16 = true;
/* 194 */       } else {
/* 195 */         boolean agg_isNull17 = agg_isNull14;
/* 196 */         double agg_value19 = -1.0;
/* 197 */         if (!agg_isNull14) {
/* 198 */           agg_value19 = agg_value16;
/* 199 */         }
/* 200 */         if (agg_isNull17) {
/* 201 */           agg_isNull16 = true;
/* 202 */         } else {
/* 203 */           agg_value18 = (double)(agg_value19 / agg_value21);
/* 204 */         }
/* 205 */       }
/* 206 */
/* 207 */       agg_rowWriter1.zeroOutNullBytes();
/* 208 */
/* 209 */       if (agg_isNull16) {
/* 210 */         agg_rowWriter1.setNullAt(0);
/* 211 */       } else {
/* 212 */         agg_rowWriter1.write(0, agg_value18);
/* 213 */       }
/* 214 */       append(agg_result1);
/* 215 */
