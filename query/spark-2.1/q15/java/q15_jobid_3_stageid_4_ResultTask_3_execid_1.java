...
/* 118 */         double agg_value7 = -1.0;
/* 119 */
/* 120 */         boolean agg_isNull8 = agg_unsafeRowAggBuffer.isNullAt(0);
/* 121 */         double agg_value9 = agg_isNull8 ? -1.0 : (agg_unsafeRowAggBuffer.getDouble(0));
/* 122 */         boolean agg_isNull7 = agg_isNull8;
/* 123 */         double agg_value8 = agg_value9;
/* 124 */         if (agg_isNull7) {
/* 125 */           boolean agg_isNull9 = false;
/* 126 */           double agg_value10 = -1.0;
/* 127 */           if (!false) {
/* 128 */             agg_value10 = (double) 0;
/* 129 */           }
/* 130 */           if (!agg_isNull9) {
...
/* 142 */         double agg_value6 = agg_value7;
/* 143 */         if (agg_isNull5) {
/* 144 */           boolean agg_isNull12 = agg_unsafeRowAggBuffer.isNullAt(0);
/* 145 */           double agg_value13 = agg_isNull12 ? -1.0 : (agg_unsafeRowAggBuffer.getDouble(0));
/* 146 */           if (!agg_isNull12) {
...
/* 152 */         if (!agg_isNull5) {
/* 153 */           agg_unsafeRowAggBuffer.setDouble(0, agg_value6);
/* 154 */         } else {
...
/* 183 */       double agg_value15 = agg_isNull14 ? -1.0 : (agg_aggBuffer.getDouble(0));
/* 184 */
