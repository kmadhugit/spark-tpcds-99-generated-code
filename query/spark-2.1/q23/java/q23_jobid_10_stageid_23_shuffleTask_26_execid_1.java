...
/* 081 */
/* 082 */     while (inputadapter_input.hasNext()) {
...
/* 229 */
/* 230 */       final double filter_value6 = -1.0;
/* 231 */       if (!true) {
/* 232 */         filter_isNull4 = false; // resultCode could change nullability.
/* 233 */         filter_value4 = 0.5D * filter_value6;
/* 234 */
/* 235 */       }
/* 236 */       if (!filter_isNull4) {
/* 237 */         filter_isNull2 = false; // resultCode could change nullability.
/* 238 */         filter_value2 = org.apache.spark.util.Utils.nanSafeCompareDoubles(agg_value15, filter_value4) > 0;
/* 239 */
/* 240 */       }
/* 241 */       if (filter_isNull2 || !filter_value2) continue;
/* 242 */
/* 243 */       filter_numOutputRows.add(1);
/* 244 */
/* 245 */       project_rowWriter.zeroOutNullBytes();
/* 246 */
/* 247 */       if (agg_isNull13) {
/* 248 */         project_rowWriter.setNullAt(0);
/* 249 */       } else {
/* 250 */         project_rowWriter.write(0, agg_value14);
/* 251 */       }
/* 252 */       sort_sorter.insertRow((UnsafeRow)project_result);
/* 253 */
/* 254 */       if (shouldStop()) return;
/* 255 */     }
/* 256 */
/* 257 */     agg_mapIter.close();
/* 258 */     if (agg_sorter == null) {
/* 259 */       agg_hashMap.free();
/* 260 */     }
/* 261 */
/* 262 */   }
/* 263 */
/* 264 */   protected void processNext() throws java.io.IOException {
/* 265 */     if (sort_needToSort) {
/* 266 */       long sort_spillSizeBefore = sort_metrics.memoryBytesSpilled();
/* 267 */       sort_addToSorter();
/* 268 */       sort_sortedIter = sort_sorter.sort();
/* 269 */       sort_sortTime.add(sort_sorter.getSortTimeNanos() / 1000000);
/* 270 */       sort_peakMemory.add(sort_sorter.getPeakMemoryUsage());
/* 271 */       sort_spillSize.add(sort_metrics.memoryBytesSpilled() - sort_spillSizeBefore);
/* 272 */       sort_metrics.incPeakExecutionMemory(sort_sorter.getPeakMemoryUsage());
/* 273 */       sort_needToSort = false;
/* 274 */     }
/* 275 */
/* 276 */     while (sort_sortedIter.hasNext()) {
/* 277 */       UnsafeRow sort_outputRow = (UnsafeRow)sort_sortedIter.next();
/* 278 */
/* 279 */       append(sort_outputRow);
/* 280 */
