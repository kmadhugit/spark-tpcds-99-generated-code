...
/* 208 */       boolean inputadapter_isNull2 = inputadapter_row.isNullAt(2);
/* 209 */       int inputadapter_value2 = inputadapter_isNull2 ? -1 : (inputadapter_row.getInt(2));
/* 210 */
/* 211 */       // generate join key for stream side
/* 212 */
/* 213 */       boolean bhj_isNull = inputadapter_isNull2;
/* 214 */       long bhj_value = -1L;
/* 215 */       if (!inputadapter_isNull2) {
/* 216 */         bhj_value = (long) inputadapter_value2;
/* 217 */       }
