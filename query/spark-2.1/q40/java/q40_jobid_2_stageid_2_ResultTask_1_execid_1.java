...
/* 090 */         double scan_value2 = scan_isNull2 ? -1.0 : (scan_colInstance2.getDouble(scan_rowIdx));
/* 091 */
...
/* 097 */         filter_value2 = org.apache.spark.util.Utils.nanSafeCompareDoubles(scan_value2, 0.99D) >= 0;
/* 098 */         if (!filter_value2) continue;
/* 099 */         boolean filter_isNull5 = false;
/* 100 */
/* 101 */         boolean filter_value5 = false;
/* 102 */         filter_value5 = org.apache.spark.util.Utils.nanSafeCompareDoubles(scan_value2, 1.49D) <= 0;
...
/* 113 */         UTF8String scan_value1 = scan_isNull1 ? null : (scan_colInstance1.getUTF8String(scan_rowIdx));
