...
/* 087 */         UTF8String scan_value = scan_isNull ? null : (scan_colInstance0.getUTF8String(scan_rowIdx));
/* 088 */
/* 089 */         if (!(!(scan_isNull))) continue;
/* 090 */
...
/* 096 */         filter_value2 = scan_value.equals(filter_value4);
...
/* 107 */         } else {
/* 108 */           project_rowWriter.write(0, scan_value1);
/* 109 */         }
/* 110 */         append(project_result);
/* 111 */         if (shouldStop()) return;
/* 112 */       }
/* 113 */       scan_batch = null;
/* 114 */       scan_nextBatch();
/* 115 */     }
/* 116 */     scan_scanTime.add(scan_scanTime1 / (1000 * 1000));
/* 117 */     scan_scanTime1 = 0;
/* 118 */   }
/* 119 */ }
