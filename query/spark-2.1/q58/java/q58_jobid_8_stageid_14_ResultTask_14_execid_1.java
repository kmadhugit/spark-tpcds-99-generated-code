...
/* 122 */       boolean smj_loaded = false;
/* 123 */       smj_isNull3 = smj_leftRow.isNullAt(1);
/* 124 */       smj_value5 = smj_isNull3 ? -1.0 : (smj_leftRow.getDouble(1));
/* 125 */       smj_isNull4 = smj_leftRow.isNullAt(2);
/* 126 */       smj_value6 = smj_isNull4 ? -1.0 : (smj_leftRow.getDouble(2));
/* 127 */       for (int smj_i = 0; smj_i < smj_size; smj_i ++) {
/* 128 */         InternalRow smj_rightRow1 = (InternalRow) smj_matches.get(smj_i);
