...
/* 050 */     if (!isNull1) {
/* 051 */
/* 052 */       boolean isNull4 = i.isNullAt(4);
/* 053 */       double value4 = isNull4 ? -1.0 : (i.getDouble(4));
...
/* 080 */
/* 081 */
/* 082 */     boolean isNull9 = i.isNullAt(4);
/* 083 */     double value9 = isNull9 ? -1.0 : (i.getDouble(4));
