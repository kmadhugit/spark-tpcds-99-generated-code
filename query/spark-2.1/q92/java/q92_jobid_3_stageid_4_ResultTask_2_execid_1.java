...
/* 073 */       int inputadapter_value = inputadapter_isNull ? -1 : (inputadapter_row.getInt(0));
...
/* 095 */           agg_value7 = org.apache.spark.unsafe.hash.Murmur3_x86_32.hashInt(inputadapter_value, agg_value7);
/* 096 */         }
/* 097 */         if (true) {
...
/* 198 */       int agg_value15 = agg_isNull13 ? -1 : (agg_aggKey.getInt(0));
...
/* 203 */       boolean agg_isNull19 = agg_isNull15;
/* 204 */       double agg_value21 = -1.0;
/* 205 */       if (!agg_isNull15) {
/* 206 */         agg_value21 = (double) agg_value17;
/* 207 */       }
/* 208 */       boolean agg_isNull16 = false;
/* 209 */       double agg_value18 = -1.0;
/* 210 */       if (agg_isNull19 || agg_value21 == 0) {
/* 211 */         agg_isNull16 = true;
/* 212 */       } else {
/* 213 */         boolean agg_isNull17 = agg_isNull14;
/* 214 */         double agg_value19 = -1.0;
/* 215 */         if (!agg_isNull14) {
/* 216 */           agg_value19 = agg_value16;
/* 217 */         }
/* 218 */         if (agg_isNull17) {
/* 219 */           agg_isNull16 = true;
/* 220 */         } else {
/* 221 */           agg_value18 = (double)(agg_value19 / agg_value21);
/* 222 */         }
/* 223 */       }
/* 224 */
/* 225 */       boolean agg_isNull21 = true;
/* 226 */       double agg_value23 = -1.0;
/* 227 */
/* 228 */       if (!agg_isNull16) {
/* 229 */         agg_isNull21 = false; // resultCode could change nullability.
/* 230 */         agg_value23 = 1.3D * agg_value18;
/* 231 */
/* 232 */       }
/* 233 */
/* 234 */       if (!(!(agg_isNull21))) continue;
/* 235 */
/* 236 */       filter_numOutputRows.add(1);
/* 237 */
/* 238 */       filter_rowWriter.zeroOutNullBytes();
/* 239 */
/* 240 */       filter_rowWriter.write(0, agg_value23);
/* 241 */
/* 242 */       if (agg_isNull13) {
/* 243 */         filter_rowWriter.setNullAt(1);
/* 244 */       } else {
/* 245 */         filter_rowWriter.write(1, agg_value15);
/* 246 */       }
/* 247 */       append(filter_result);
/* 248 */
/* 249 */       if (shouldStop()) return;
/* 250 */     }
/* 251 */
/* 252 */     agg_mapIter.close();
/* 253 */     if (agg_sorter == null) {
/* 254 */       agg_hashMap.free();
/* 255 */     }
/* 256 */   }
/* 257 */ }
