...
/* 100 */         int scan_value1 = scan_isNull1 ? -1 : (scan_colInstance1.getInt(scan_rowIdx));
/* 101 */
/* 102 */         boolean filter_value5 = false;
/* 103 */         boolean filter_isNull5 = scan_isNull1;
/* 104 */         if (!filter_isNull5) {
/* 105 */           if (!filter_value5) {
/* 106 */             if (false) {
/* 107 */               filter_isNull5 = true;
/* 108 */             } else if (scan_value1 == 1999) {
/* 109 */               filter_isNull5 = false;
/* 110 */               filter_value5 = true;
/* 111 */             }
/* 112 */           }
/* 113 */
/* 114 */           if (!filter_value5) {
/* 115 */             if (false) {
/* 116 */               filter_isNull5 = true;
/* 117 */             } else if (scan_value1 == 2000) {
/* 118 */               filter_isNull5 = false;
/* 119 */               filter_value5 = true;
/* 120 */             }
/* 121 */           }
/* 122 */
/* 123 */           if (!filter_value5) {
/* 124 */             if (false) {
/* 125 */               filter_isNull5 = true;
/* 126 */             } else if (scan_value1 == 2001) {
/* 127 */               filter_isNull5 = false;
/* 128 */               filter_value5 = true;
/* 129 */             }
/* 130 */           }
/* 131 */
/* 132 */         }
/* 133 */         if (filter_isNull5 || !filter_value5) continue;
/* 134 */
...
/* 141 */
/* 142 */         project_rowWriter.write(0, scan_value);
