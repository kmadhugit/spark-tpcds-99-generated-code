...
/* 095 */         boolean scan_isNull2 = scan_colInstance2.isNullAt(scan_rowIdx);
/* 096 */         int scan_value2 = scan_isNull2 ? -1 : (scan_colInstance2.getInt(scan_rowIdx));
/* 097 */
/* 098 */         if (!(!(scan_isNull2))) continue;
/* 099 */
/* 100 */         boolean filter_isNull2 = false;
/* 101 */
/* 102 */         boolean filter_value2 = false;
/* 103 */         filter_value2 = scan_value2 == 8;
...
/* 112 */         UTF8String scan_value4 = scan_isNull4 ? null : (scan_colInstance4.getUTF8String(scan_rowIdx));
/* 113 */
/* 114 */         if (!(!(scan_isNull4))) continue;
/* 115 */
/* 116 */         filter_numOutputRows.add(1);
/* 117 */
/* 118 */         boolean scan_isNull1 = scan_colInstance1.isNullAt(scan_rowIdx);
/* 119 */         UTF8String scan_value1 = scan_isNull1 ? null : (scan_colInstance1.getUTF8String(scan_rowIdx));
/* 120 */         boolean scan_isNull3 = scan_colInstance3.isNullAt(scan_rowIdx);
/* 121 */         UTF8String scan_value3 = scan_isNull3 ? null : (scan_colInstance3.getUTF8String(scan_rowIdx));
...
/* 138 */         }
/* 139 */
/* 140 */         project_rowWriter.write(3, scan_value4);
