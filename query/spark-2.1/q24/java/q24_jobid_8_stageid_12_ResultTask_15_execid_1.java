...
/* 061 */       boolean agg_isNull11 = true;
/* 062 */       double agg_value11 = -1.0;
/* 063 */
/* 064 */       if (!agg_bufIsNull) {
/* 065 */         if (!inputadapter_isNull) {
/* 066 */           agg_isNull11 = false; // resultCode could change nullability.
/* 067 */           agg_value11 = agg_bufValue + inputadapter_value;
/* 068 */
/* 069 */         }
/* 070 */
/* 071 */       }
/* 072 */       boolean agg_isNull14 = true;
/* 073 */       long agg_value14 = -1L;
/* 074 */
/* 075 */       if (!agg_bufIsNull1) {
/* 076 */         if (!inputadapter_isNull1) {
/* 077 */           agg_isNull14 = false; // resultCode could change nullability.
/* 078 */           agg_value14 = agg_bufValue1 + inputadapter_value1;
/* 079 */
/* 080 */         }
/* 081 */
/* 082 */       }
/* 083 */       // update aggregation buffer
/* 084 */       agg_bufIsNull = agg_isNull11;
/* 085 */       agg_bufValue = agg_value11;
/* 086 */
/* 087 */       agg_bufIsNull1 = agg_isNull14;
/* 088 */       agg_bufValue1 = agg_value14;
...
/* 121 */         }
/* 122 */       }
/* 123 */       boolean agg_isNull8 = true;
/* 124 */       double agg_value8 = -1.0;
/* 125 */
/* 126 */       if (!agg_isNull3) {
/* 127 */         agg_isNull8 = false; // resultCode could change nullability.
/* 128 */         agg_value8 = 0.05D * agg_value3;
/* 129 */
/* 130 */       }
/* 131 */
/* 132 */       agg_numOutputRows.add(1);
/* 133 */       agg_rowWriter.zeroOutNullBytes();
/* 134 */
/* 135 */       if (agg_isNull8) {
/* 136 */         agg_rowWriter.setNullAt(0);
/* 137 */       } else {
/* 138 */         agg_rowWriter.write(0, agg_value8);
/* 139 */       }
/* 140 */       append(agg_result);
/* 141 */     }
/* 142 */   }
/* 143 */ }
