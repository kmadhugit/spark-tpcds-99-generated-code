...
/* 098 */         boolean scan_isNull3 = scan_colInstance3.isNullAt(scan_rowIdx);
/* 099 */         UTF8String scan_value3 = scan_isNull3 ? null : (scan_colInstance3.getUTF8String(scan_rowIdx));
/* 100 */
/* 101 */         if (!(!(scan_isNull3))) continue;
/* 102 */
...
/* 108 */         filter_value2 = scan_value3.equals(filter_value4);
...
/* 119 */         double scan_value1 = scan_isNull1 ? -1.0 : (scan_colInstance1.getDouble(scan_rowIdx));
/* 120 */         boolean scan_isNull2 = scan_colInstance2.isNullAt(scan_rowIdx);
/* 121 */         UTF8String scan_value2 = scan_isNull2 ? null : (scan_colInstance2.getUTF8String(scan_rowIdx));
...
/* 124 */         boolean scan_isNull5 = scan_colInstance5.isNullAt(scan_rowIdx);
/* 125 */         int scan_value5 = scan_isNull5 ? -1 : (scan_colInstance5.getInt(scan_rowIdx));
/* 126 */         project_holder.reset();
/* 127 */
/* 128 */         project_rowWriter.zeroOutNullBytes();
/* 129 */
...
/* 145 */
/* 146 */         if (scan_isNull4) {
/* 147 */           project_rowWriter.setNullAt(4);
/* 148 */         } else {
/* 149 */           project_rowWriter.write(4, scan_value4);
/* 150 */         }
/* 151 */
/* 152 */         if (scan_isNull5) {
/* 153 */           project_rowWriter.setNullAt(5);
/* 154 */         } else {
/* 155 */           project_rowWriter.write(5, scan_value5);
/* 156 */         }
/* 157 */         project_result.setTotalSize(project_holder.totalSize());
