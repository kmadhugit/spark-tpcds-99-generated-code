...
/* 093 */
/* 094 */         filter_numOutputRows.add(1);
/* 095 */
/* 096 */         boolean scan_isNull = scan_colInstance0.isNullAt(scan_rowIdx);
/* 097 */         UTF8String scan_value = scan_isNull ? null : (scan_colInstance0.getUTF8String(scan_rowIdx));
...
/* 106 */         } else {
/* 107 */           project_rowWriter.write(0, scan_value);
/* 108 */         }
/* 109 */
/* 110 */         project_rowWriter.write(1, scan_value1);
/* 111 */
/* 112 */         if (scan_isNull2) {
/* 113 */           project_rowWriter.setNullAt(2);
/* 114 */         } else {
/* 115 */           project_rowWriter.write(2, scan_value2);
/* 116 */         }
/* 117 */         project_result.setTotalSize(project_holder.totalSize());
/* 118 */         append(project_result);
/* 119 */         if (shouldStop()) return;
/* 120 */       }
/* 121 */       scan_batch = null;
/* 122 */       scan_nextBatch();
/* 123 */     }
/* 124 */     scan_scanTime.add(scan_scanTime1 / (1000 * 1000));
/* 125 */     scan_scanTime1 = 0;
/* 126 */   }
/* 127 */ }
