...
/* 062 */
/* 063 */     smj_matches = new java.util.ArrayList();
/* 064 */
...
/* 200 */         } else {
/* 201 */           smj_matches.add(smj_rightRow.copy());
...
/* 211 */       int smj_size = smj_matches.size();
/* 212 */       smj_isNull12 = smj_leftRow.isNullAt(0);
/* 213 */       smj_value22 = smj_isNull12 ? null : (smj_leftRow.getUTF8String(0));
/* 214 */       smj_isNull13 = smj_leftRow.isNullAt(1);
/* 215 */       smj_value23 = smj_isNull13 ? null : (smj_leftRow.getUTF8String(1));
/* 216 */       smj_isNull14 = smj_leftRow.isNullAt(2);
/* 217 */       smj_value24 = smj_isNull14 ? null : (smj_leftRow.getUTF8String(2));
/* 218 */       smj_isNull15 = smj_leftRow.isNullAt(3);
/* 219 */       smj_value25 = smj_isNull15 ? null : (smj_leftRow.getUTF8String(3));
/* 220 */       smj_isNull16 = smj_leftRow.isNullAt(4);
/* 221 */       smj_value26 = smj_isNull16 ? -1 : (smj_leftRow.getInt(4));
/* 222 */       smj_isNull17 = smj_leftRow.isNullAt(5);
/* 223 */       smj_value27 = smj_isNull17 ? -1 : (smj_leftRow.getInt(5));
/* 224 */       smj_isNull18 = smj_leftRow.isNullAt(6);
/* 225 */       smj_value28 = smj_isNull18 ? -1.0 : (smj_leftRow.getDouble(6));
/* 226 */       smj_isNull19 = smj_leftRow.isNullAt(7);
/* 227 */       smj_value29 = smj_isNull19 ? -1.0 : (smj_leftRow.getDouble(7));
/* 228 */       smj_isNull20 = smj_leftRow.isNullAt(8);
/* 229 */       smj_value30 = smj_isNull20 ? -1 : (smj_leftRow.getInt(8));
/* 230 */       smj_isNull21 = smj_leftRow.isNullAt(9);
/* 231 */       smj_value31 = smj_isNull21 ? -1.0 : (smj_leftRow.getDouble(9));
/* 232 */       for (int smj_i = 0; smj_i < smj_size; smj_i ++) {
/* 233 */         InternalRow smj_rightRow1 = (InternalRow) smj_matches.get(smj_i);
/* 234 */
