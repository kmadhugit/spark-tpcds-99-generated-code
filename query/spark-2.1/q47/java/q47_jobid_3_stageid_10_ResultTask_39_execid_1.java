...
/* 159 */     {
/* 160 */
/* 161 */       boolean isNull4 = true;
/* 162 */       int value4 = -1;
/* 163 */
/* 164 */       boolean isNull5 = i.isNullAt(5);
/* 165 */       int value5 = isNull5 ? -1 : (i.getInt(5));
/* 166 */       if (!isNull5) {
/* 167 */
/* 168 */
/* 169 */         isNull4 = false; // resultCode could change nullability.
/* 170 */         value4 = value5 - 1;
/* 171 */
/* 172 */       }
/* 173 */       isNullA4 = isNull4;
/* 174 */       primitiveA4 = value4;
/* 175 */     }
/* 176 */     i = b;
/* 177 */     boolean isNullB4;
/* 178 */     int primitiveB4;
/* 179 */     {
/* 180 */
/* 181 */       boolean isNull4 = true;
/* 182 */       int value4 = -1;
/* 183 */
/* 184 */       boolean isNull5 = i.isNullAt(5);
/* 185 */       int value5 = isNull5 ? -1 : (i.getInt(5));
/* 186 */       if (!isNull5) {
/* 187 */
/* 188 */
/* 189 */         isNull4 = false; // resultCode could change nullability.
/* 190 */         value4 = value5 - 1;
/* 191 */
/* 192 */       }
/* 193 */       isNullB4 = isNull4;
/* 194 */       primitiveB4 = value4;
/* 195 */     }
/* 196 */     if (isNullA4 && isNullB4) {
/* 197 */       // Nothing
/* 198 */     } else if (isNullA4) {
/* 199 */       return -1;
/* 200 */     } else if (isNullB4) {
/* 201 */       return 1;
/* 202 */     } else {
/* 203 */       int comp = (primitiveA4 > primitiveB4 ? 1 : primitiveA4 < primitiveB4 ? -1 : 0);
/* 204 */       if (comp != 0) {
/* 205 */         return comp;
/* 206 */       }
/* 207 */     }
