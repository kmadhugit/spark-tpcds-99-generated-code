...
/* 050 */     if (!isNull1) {
/* 051 */
/* 052 */       boolean isNull4 = i.isNullAt(9);
/* 053 */       double value4 = isNull4 ? -1.0 : (i.getDouble(9));
...
/* 080 */
/* 081 */
/* 082 */     boolean isNull9 = i.isNullAt(9);
/* 083 */     double value9 = isNull9 ? -1.0 : (i.getDouble(9));
