...
/* 175 */       int numRows = scan_batch.numRows();
/* 176 */       while (scan_batchIdx < numRows) {
/* 177 */         int scan_rowIdx = scan_batchIdx++;
/* 178 */         boolean scan_isNull = scan_colInstance0.isNullAt(scan_rowIdx);
/* 179 */         int scan_value = scan_isNull ? -1 : (scan_colInstance0.getInt(scan_rowIdx));
/* 180 */
/* 181 */         if (!(!(scan_isNull))) continue;
/* 182 */
/* 183 */         filter_numOutputRows.add(1);
/* 184 */
/* 185 */         boolean scan_isNull1 = scan_colInstance1.isNullAt(scan_rowIdx);
/* 186 */         UTF8String scan_value1 = scan_isNull1 ? null : (scan_colInstance1.getUTF8String(scan_rowIdx));
/* 187 */
/* 188 */         // generate join key for stream side
/* 189 */
/* 190 */         bhj_holder.reset();
/* 191 */
/* 192 */         bhj_rowWriter.zeroOutNullBytes();
/* 193 */
/* 194 */         if (scan_isNull1) {
/* 195 */           bhj_rowWriter.setNullAt(0);
/* 196 */         } else {
/* 197 */           bhj_rowWriter.write(0, scan_value1);
/* 198 */         }
/* 199 */         bhj_result.setTotalSize(bhj_holder.totalSize());
/* 200 */
/* 201 */         // find matches from HashRelation
/* 202 */         scala.collection.Iterator bhj_matches = bhj_result.anyNull() ? null : (scala.collection.Iterator)bhj_relation.get(bhj_result);
/* 203 */         if (bhj_matches == null) continue;
/* 204 */         boolean bhj_found = false;
/* 205 */         while (!bhj_found && bhj_matches.hasNext()) {
/* 206 */           UnsafeRow bhj_matched = (UnsafeRow) bhj_matches.next();
/* 207 */
/* 208 */           bhj_found = true;
/* 209 */         }
/* 210 */         if (!bhj_found) continue;
...
/* 216 */
/* 217 */         project_rowWriter1.write(0, scan_value);
/* 218 */
/* 219 */         if (scan_isNull1) {
/* 220 */           project_rowWriter1.setNullAt(1);
/* 221 */         } else {
/* 222 */           project_rowWriter1.write(1, scan_value1);
/* 223 */         }
/* 224 */         project_result1.setTotalSize(project_holder1.totalSize());
/* 225 */         append(project_result1);
