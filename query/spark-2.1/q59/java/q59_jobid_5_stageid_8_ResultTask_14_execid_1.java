...
/* 149 */         } else {
/* 150 */           smj_matches.add(smj_rightRow.copy());
...
/* 160 */       int smj_size = smj_matches.size();
/* 161 */       smj_isNull6 = smj_leftRow.isNullAt(0);
/* 162 */       smj_value10 = smj_isNull6 ? null : (smj_leftRow.getUTF8String(0));
/* 163 */       smj_isNull7 = smj_leftRow.isNullAt(1);
/* 164 */       smj_value11 = smj_isNull7 ? -1 : (smj_leftRow.getInt(1));
/* 165 */       smj_isNull8 = smj_leftRow.isNullAt(2);
/* 166 */       smj_value12 = smj_isNull8 ? null : (smj_leftRow.getUTF8String(2));
/* 167 */       smj_isNull9 = smj_leftRow.isNullAt(3);
/* 168 */       smj_value13 = smj_isNull9 ? -1.0 : (smj_leftRow.getDouble(3));
/* 169 */       smj_isNull10 = smj_leftRow.isNullAt(4);
/* 170 */       smj_value14 = smj_isNull10 ? -1.0 : (smj_leftRow.getDouble(4));
/* 171 */       smj_isNull11 = smj_leftRow.isNullAt(5);
/* 172 */       smj_value15 = smj_isNull11 ? -1.0 : (smj_leftRow.getDouble(5));
/* 173 */       smj_isNull12 = smj_leftRow.isNullAt(6);
/* 174 */       smj_value16 = smj_isNull12 ? -1.0 : (smj_leftRow.getDouble(6));
/* 175 */       smj_isNull13 = smj_leftRow.isNullAt(7);
/* 176 */       smj_value17 = smj_isNull13 ? -1.0 : (smj_leftRow.getDouble(7));
/* 177 */       smj_isNull14 = smj_leftRow.isNullAt(8);
/* 178 */       smj_value18 = smj_isNull14 ? -1.0 : (smj_leftRow.getDouble(8));
/* 179 */       smj_isNull15 = smj_leftRow.isNullAt(9);
/* 180 */       smj_value19 = smj_isNull15 ? -1.0 : (smj_leftRow.getDouble(9));
