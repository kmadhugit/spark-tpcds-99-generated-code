...
/* 236 */       boolean agg_isNull35 = agg_isNull31;
/* 237 */       double agg_value37 = -1.0;
/* 238 */       if (!agg_isNull31) {
/* 239 */         agg_value37 = (double) agg_value33;
/* 240 */       }
/* 241 */       boolean agg_isNull32 = false;
/* 242 */       double agg_value34 = -1.0;
/* 243 */       if (agg_isNull35 || agg_value37 == 0) {
/* 244 */         agg_isNull32 = true;
/* 245 */       } else {
/* 246 */         boolean agg_isNull33 = agg_isNull30;
/* 247 */         double agg_value35 = -1.0;
/* 248 */         if (!agg_isNull30) {
/* 249 */           agg_value35 = agg_value32;
/* 250 */         }
/* 251 */         if (agg_isNull33) {
/* 252 */           agg_isNull32 = true;
/* 253 */         } else {
/* 254 */           agg_value34 = (double)(agg_value35 / agg_value37);
/* 255 */         }
/* 256 */       }
/* 257 */
/* 258 */       agg_holder1.reset();
/* 259 */
/* 260 */       agg_rowWriter1.zeroOutNullBytes();
/* 261 */
/* 262 */       if (agg_isNull25) {
/* 263 */         agg_rowWriter1.setNullAt(0);
/* 264 */       } else {
/* 265 */         agg_rowWriter1.write(0, agg_value27);
/* 266 */       }
/* 267 */
/* 268 */       if (agg_isNull26) {
/* 269 */         agg_rowWriter1.setNullAt(1);
/* 270 */       } else {
/* 271 */         agg_rowWriter1.write(1, agg_value28);
/* 272 */       }
/* 273 */
/* 274 */       if (agg_isNull27) {
/* 275 */         agg_rowWriter1.setNullAt(2);
/* 276 */       } else {
/* 277 */         agg_rowWriter1.write(2, agg_value29);
/* 278 */       }
/* 279 */
/* 280 */       if (agg_isNull28) {
/* 281 */         agg_rowWriter1.setNullAt(3);
/* 282 */       } else {
/* 283 */         agg_rowWriter1.write(3, agg_value30);
/* 284 */       }
/* 285 */
/* 286 */       if (agg_isNull32) {
/* 287 */         agg_rowWriter1.setNullAt(4);
/* 288 */       } else {
/* 289 */         agg_rowWriter1.write(4, agg_value34);
/* 290 */       }
/* 291 */       agg_result1.setTotalSize(agg_holder1.totalSize());
/* 292 */       append(agg_result1);
/* 293 */
/* 294 */       if (shouldStop()) return;
/* 295 */     }
/* 296 */
/* 297 */     agg_mapIter.close();
/* 298 */     if (agg_sorter == null) {
/* 299 */       agg_hashMap.free();
/* 300 */     }
/* 301 */   }
/* 302 */ }
