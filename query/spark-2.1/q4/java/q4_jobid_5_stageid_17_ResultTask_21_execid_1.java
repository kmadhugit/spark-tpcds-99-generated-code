...
/* 056 */
/* 057 */     smj_matches = new java.util.ArrayList();
/* 058 */
...
/* 063 */     project_result = new UnsafeRow(7);
/* 064 */     this.project_holder = new org.apache.spark.sql.catalyst.expressions.codegen.BufferHolder(project_result, 224);
/* 065 */     this.project_rowWriter = new org.apache.spark.sql.catalyst.expressions.codegen.UnsafeRowWriter(project_holder, 7);
/* 066 */
/* 067 */   }
/* 068 */
...
/* 126 */         } else {
/* 127 */           smj_matches.add(smj_rightRow.copy());
...
/* 137 */       int smj_size = smj_matches.size();
/* 138 */       boolean smj_loaded = false;
/* 139 */       smj_isNull10 = smj_leftRow.isNullAt(8);
/* 140 */       smj_value12 = smj_isNull10 ? -1.0 : (smj_leftRow.getDouble(8));
/* 141 */       smj_isNull11 = smj_leftRow.isNullAt(9);
/* 142 */       smj_value13 = smj_isNull11 ? -1.0 : (smj_leftRow.getDouble(9));
/* 143 */       smj_isNull12 = smj_leftRow.isNullAt(10);
/* 144 */       smj_value14 = smj_isNull12 ? -1.0 : (smj_leftRow.getDouble(10));
/* 145 */       for (int smj_i = 0; smj_i < smj_size; smj_i ++) {
/* 146 */         InternalRow smj_rightRow1 = (InternalRow) smj_matches.get(smj_i);
...
/* 161 */           smj_value19 = org.apache.spark.util.Utils.nanSafeCompareDoubles(smj_value12, 0.0D) > 0;
/* 162 */
/* 163 */         }
/* 164 */         if (!smj_isNull17 && smj_value19) {
/* 165 */           boolean smj_isNull20 = false;
/* 166 */           double smj_value22 = -1.0;
/* 167 */           if (smj_isNull10 || smj_value12 == 0) {
/* 168 */             smj_isNull20 = true;
/* 169 */           } else {
/* 170 */             if (smj_isNull11) {
/* 171 */               smj_isNull20 = true;
/* 172 */             } else {
/* 173 */               smj_value22 = (double)(smj_value13 / smj_value12);
/* 174 */             }
/* 175 */           }
...
/* 194 */             smj_value27 = org.apache.spark.util.Utils.nanSafeCompareDoubles(smj_value14, 0.0D) > 0;
/* 195 */
/* 196 */           }
/* 197 */           if (!smj_isNull25 && smj_value27) {
/* 198 */             boolean smj_isNull28 = false;
/* 199 */             double smj_value30 = -1.0;
/* 200 */             if (smj_isNull12 || smj_value14 == 0) {
/* 201 */               smj_isNull28 = true;
/* 202 */             } else {
/* 203 */               if (smj_isNull14) {
/* 204 */                 smj_isNull28 = true;
/* 205 */               } else {
/* 206 */                 smj_value30 = (double)(smj_value16 / smj_value14);
/* 207 */               }
/* 208 */             }
...
/* 230 */           smj_isNull3 = smj_leftRow.isNullAt(1);
/* 231 */           smj_value5 = smj_isNull3 ? null : (smj_leftRow.getUTF8String(1));
/* 232 */           smj_isNull4 = smj_leftRow.isNullAt(2);
/* 233 */           smj_value6 = smj_isNull4 ? null : (smj_leftRow.getUTF8String(2));
/* 234 */           smj_isNull5 = smj_leftRow.isNullAt(3);
/* 235 */           smj_value7 = smj_isNull5 ? null : (smj_leftRow.getUTF8String(3));
/* 236 */           smj_isNull6 = smj_leftRow.isNullAt(4);
/* 237 */           smj_value8 = smj_isNull6 ? null : (smj_leftRow.getUTF8String(4));
/* 238 */           smj_isNull7 = smj_leftRow.isNullAt(5);
/* 239 */           smj_value9 = smj_isNull7 ? null : (smj_leftRow.getUTF8String(5));
/* 240 */           smj_isNull8 = smj_leftRow.isNullAt(6);
/* 241 */           smj_value10 = smj_isNull8 ? null : (smj_leftRow.getUTF8String(6));
/* 242 */           smj_isNull9 = smj_leftRow.isNullAt(7);
/* 243 */           smj_value11 = smj_isNull9 ? null : (smj_leftRow.getUTF8String(7));
/* 244 */         }
...
/* 255 */         } else {
/* 256 */           project_rowWriter.write(0, smj_value5);
/* 257 */         }
/* 258 */
/* 259 */         if (smj_isNull4) {
...
/* 293 */         }
/* 294 */         project_result.setTotalSize(project_holder.totalSize());
/* 295 */         append(project_result.copy());
/* 296 */
/* 297 */       }
