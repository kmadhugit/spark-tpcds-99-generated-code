...
/* 045 */
/* 046 */     agg_result1 = new UnsafeRow(8);
/* 047 */     this.agg_holder1 = new org.apache.spark.sql.catalyst.expressions.codegen.BufferHolder(agg_result1, 224);
/* 048 */     this.agg_rowWriter1 = new org.apache.spark.sql.catalyst.expressions.codegen.UnsafeRowWriter(agg_holder1, 8);
...
/* 056 */
/* 057 */     while (inputadapter_input.hasNext()) {
...
/* 295 */       } else {
/* 296 */         agg_rowWriter1.write(1, agg_value36);
/* 297 */       }
/* 298 */
/* 299 */       if (agg_isNull36) {
/* 300 */         agg_rowWriter1.setNullAt(2);
/* 301 */       } else {
/* 302 */         agg_rowWriter1.write(2, agg_value37);
/* 303 */       }
/* 304 */
/* 305 */       if (agg_isNull37) {
/* 306 */         agg_rowWriter1.setNullAt(3);
/* 307 */       } else {
/* 308 */         agg_rowWriter1.write(3, agg_value38);
/* 309 */       }
/* 310 */
/* 311 */       if (agg_isNull38) {
/* 312 */         agg_rowWriter1.setNullAt(4);
/* 313 */       } else {
/* 314 */         agg_rowWriter1.write(4, agg_value39);
/* 315 */       }
/* 316 */
/* 317 */       if (agg_isNull39) {
/* 318 */         agg_rowWriter1.setNullAt(5);
/* 319 */       } else {
/* 320 */         agg_rowWriter1.write(5, agg_value40);
/* 321 */       }
/* 322 */
/* 323 */       if (agg_isNull40) {
/* 324 */         agg_rowWriter1.setNullAt(6);
/* 325 */       } else {
/* 326 */         agg_rowWriter1.write(6, agg_value41);
/* 327 */       }
/* 328 */
/* 329 */       if (agg_isNull42) {
/* 330 */         agg_rowWriter1.setNullAt(7);
/* 331 */       } else {
/* 332 */         agg_rowWriter1.write(7, agg_value43);
/* 333 */       }
/* 334 */       agg_result1.setTotalSize(agg_holder1.totalSize());
/* 335 */       append(agg_result1);
/* 336 */
