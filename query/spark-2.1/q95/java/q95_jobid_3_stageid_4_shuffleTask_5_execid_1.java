...
/* 122 */       smj_value4 = smj_isNull2 ? -1 : (smj_leftRow.getInt(0));
/* 123 */       for (int smj_i = 0; smj_i < smj_size; smj_i ++) {
/* 124 */         InternalRow smj_rightRow1 = (InternalRow) smj_matches.get(smj_i);
