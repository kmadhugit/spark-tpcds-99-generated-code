...
/* 063 */
/* 064 */
/* 065 */     Platform.putLong(buf, 64, Platform.getLong(buf, 64) + (8L << 32));
/* 066 */
/* 067 */
/* 068 */     Platform.putLong(buf, 72, Platform.getLong(buf, 72) + (8L << 32));
/* 069 */
/* 070 */
/* 071 */     Platform.putLong(buf, 80, Platform.getLong(buf, 80) + (8L << 32));
/* 072 */
/* 073 */
/* 074 */     Platform.putLong(buf, 88, Platform.getLong(buf, 88) + (8L << 32));
/* 075 */
/* 076 */
/* 077 */
