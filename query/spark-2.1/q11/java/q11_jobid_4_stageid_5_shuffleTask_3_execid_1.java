...
/* 065 */     .add("c_preferred_cust_flag", org.apache.spark.sql.types.DataTypes.StringType)
/* 066 */     .add("c_birth_country", org.apache.spark.sql.types.DataTypes.StringType)
/* 067 */     .add("c_login", org.apache.spark.sql.types.DataTypes.StringType)
/* 068 */     .add("c_email_address", org.apache.spark.sql.types.DataTypes.StringType);
...
/* 090 */     }
/* 091 */
/* 092 */     public org.apache.spark.sql.catalyst.expressions.UnsafeRow findOrInsert(UTF8String agg_key, UTF8String agg_key1, UTF8String agg_key2, int agg_key3, UTF8String agg_key4, UTF8String agg_key5, UTF8String agg_key6, UTF8String agg_key7) {
...
/* 144 */     }
/* 145 */
/* 146 */     private boolean equals(int idx, UTF8String agg_key, UTF8String agg_key1, UTF8String agg_key2, int agg_key3, UTF8String agg_key4, UTF8String agg_key5, UTF8String agg_key6, UTF8String agg_key7) {
/* 147 */       UnsafeRow row = batch.getKeyRow(buckets[idx]);
/* 148 */       return (row.getUTF8String(0).equals(agg_key)) && (row.getUTF8String(1).equals(agg_key1)) && (row.getUTF8String(2).equals(agg_key2)) && (row.getInt(3) == agg_key3) && (row.getUTF8String(4).equals(agg_key4)) && (row.getUTF8String(5).equals(agg_key5)) && (row.getUTF8String(6).equals(agg_key6)) && (row.getUTF8String(7).equals(agg_key7));
/* 149 */     }
/* 150 */
/* 151 */     private long hash(UTF8String agg_key, UTF8String agg_key1, UTF8String agg_key2, int agg_key3, UTF8String agg_key4, UTF8String agg_key5, UTF8String agg_key6, UTF8String agg_key7) {
/* 152 */       long agg_hash = 0;
/* 153 */
...
/* 180 */
/* 181 */       int agg_result3 = agg_key3;
/* 182 */       agg_hash = (agg_hash ^ (0x9e3779b9)) + agg_result3 + (agg_hash << 6) + (agg_hash >>> 2);
/* 183 */
/* 184 */       int agg_result4 = 0;
/* 185 */       byte[] agg_bytes3 = agg_key4.getBytes();
/* 186 */       for (int i = 0; i < agg_bytes3.length; i++) {
/* 187 */         int agg_hash4 = agg_bytes3[i];
/* 188 */         agg_result4 = (agg_result4 ^ (0x9e3779b9)) + agg_hash4 + (agg_result4 << 6) + (agg_result4 >>> 2);
/* 189 */       }
/* 190 */
/* 191 */       agg_hash = (agg_hash ^ (0x9e3779b9)) + agg_result4 + (agg_hash << 6) + (agg_hash >>> 2);
/* 192 */
/* 193 */       int agg_result5 = 0;
/* 194 */       byte[] agg_bytes4 = agg_key5.getBytes();
/* 195 */       for (int i = 0; i < agg_bytes4.length; i++) {
/* 196 */         int agg_hash5 = agg_bytes4[i];
/* 197 */         agg_result5 = (agg_result5 ^ (0x9e3779b9)) + agg_hash5 + (agg_result5 << 6) + (agg_result5 >>> 2);
/* 198 */       }
/* 199 */
/* 200 */       agg_hash = (agg_hash ^ (0x9e3779b9)) + agg_result5 + (agg_hash << 6) + (agg_hash >>> 2);
/* 201 */
/* 202 */       int agg_result6 = 0;
/* 203 */       byte[] agg_bytes5 = agg_key6.getBytes();
/* 204 */       for (int i = 0; i < agg_bytes5.length; i++) {
/* 205 */         int agg_hash6 = agg_bytes5[i];
/* 206 */         agg_result6 = (agg_result6 ^ (0x9e3779b9)) + agg_hash6 + (agg_result6 << 6) + (agg_result6 >>> 2);
/* 207 */       }
/* 208 */
/* 209 */       agg_hash = (agg_hash ^ (0x9e3779b9)) + agg_result6 + (agg_hash << 6) + (agg_hash >>> 2);
/* 210 */
/* 211 */       int agg_result7 = 0;
/* 212 */       byte[] agg_bytes6 = agg_key7.getBytes();
/* 213 */       for (int i = 0; i < agg_bytes6.length; i++) {
/* 214 */         int agg_hash7 = agg_bytes6[i];
/* 215 */         agg_result7 = (agg_result7 ^ (0x9e3779b9)) + agg_hash7 + (agg_result7 << 6) + (agg_result7 >>> 2);
/* 216 */       }
/* 217 */
...
/* 262 */
/* 263 */       if (true) {
/* 264 */         if (!inputadapter_isNull && !inputadapter_isNull1 && !inputadapter_isNull2 && !inputadapter_isNull9 && !inputadapter_isNull3 && !inputadapter_isNull4 && !inputadapter_isNull5 && !inputadapter_isNull6) {
/* 265 */           agg_fastAggBuffer = agg_fastHashMap.findOrInsert(
/* 266 */             inputadapter_value, inputadapter_value1, inputadapter_value2, inputadapter_value9, inputadapter_value3, inputadapter_value4, inputadapter_value5, inputadapter_value6);
/* 267 */         }
/* 268 */       }
/* 269 */
...
/* 292 */         }
/* 293 */
/* 294 */         if (inputadapter_isNull9) {
/* 295 */           agg_rowWriter.setNullAt(3);
/* 296 */         } else {
/* 297 */           agg_rowWriter.write(3, inputadapter_value9);
/* 298 */         }
/* 299 */
/* 300 */         if (inputadapter_isNull3) {
/* 301 */           agg_rowWriter.setNullAt(4);
/* 302 */         } else {
/* 303 */           agg_rowWriter.write(4, inputadapter_value3);
/* 304 */         }
/* 305 */
/* 306 */         if (inputadapter_isNull4) {
/* 307 */           agg_rowWriter.setNullAt(5);
/* 308 */         } else {
/* 309 */           agg_rowWriter.write(5, inputadapter_value4);
/* 310 */         }
/* 311 */
/* 312 */         if (inputadapter_isNull5) {
/* 313 */           agg_rowWriter.setNullAt(6);
/* 314 */         } else {
/* 315 */           agg_rowWriter.write(6, inputadapter_value5);
/* 316 */         }
/* 317 */
/* 318 */         if (inputadapter_isNull6) {
/* 319 */           agg_rowWriter.setNullAt(7);
/* 320 */         } else {
/* 321 */           agg_rowWriter.write(7, inputadapter_value6);
/* 322 */         }
...
/* 336 */         }
/* 337 */
/* 338 */         if (!inputadapter_isNull9) {
/* 339 */           agg_value18 = org.apache.spark.unsafe.hash.Murmur3_x86_32.hashInt(inputadapter_value9, agg_value18);
/* 340 */         }
/* 341 */
