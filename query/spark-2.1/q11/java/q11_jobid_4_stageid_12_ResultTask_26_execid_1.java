...
/* 114 */         } else {
/* 115 */           smj_matches.add(smj_rightRow.copy());
...
/* 125 */       int smj_size = smj_matches.size();
/* 126 */       boolean smj_loaded = false;
/* 127 */       smj_isNull3 = smj_leftRow.isNullAt(1);
/* 128 */       smj_value5 = smj_isNull3 ? -1.0 : (smj_leftRow.getDouble(1));
/* 129 */       smj_isNull5 = smj_leftRow.isNullAt(3);
/* 130 */       smj_value7 = smj_isNull5 ? -1.0 : (smj_leftRow.getDouble(3));
/* 131 */       smj_isNull6 = smj_leftRow.isNullAt(4);
/* 132 */       smj_value8 = smj_isNull6 ? -1.0 : (smj_leftRow.getDouble(4));
/* 133 */       for (int smj_i = 0; smj_i < smj_size; smj_i ++) {
/* 134 */         InternalRow smj_rightRow1 = (InternalRow) smj_matches.get(smj_i);
