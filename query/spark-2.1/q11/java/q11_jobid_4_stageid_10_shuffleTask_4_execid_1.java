...
/* 395 */
/* 396 */         if (true) {
/* 397 */           if (!false && !scan_isNull2 && !scan_isNull3 && !scan_isNull4 && !scan_isNull5 && !scan_isNull6 && !scan_isNull7 && !bhj_isNull21) {
/* 398 */             agg_fastAggBuffer = agg_fastHashMap.findOrInsert(
/* 399 */               scan_value1, scan_value2, scan_value3, scan_value4, scan_value5, scan_value6, scan_value7, bhj_value21);
/* 400 */           }
/* 401 */         }
/* 402 */
...
/* 425 */           } else {
/* 426 */             agg_rowWriter.write(3, scan_value4);
/* 427 */           }
/* 428 */
/* 429 */           if (scan_isNull5) {
/* 430 */             agg_rowWriter.setNullAt(4);
/* 431 */           } else {
/* 432 */             agg_rowWriter.write(4, scan_value5);
/* 433 */           }
/* 434 */
/* 435 */           if (scan_isNull6) {
/* 436 */             agg_rowWriter.setNullAt(5);
/* 437 */           } else {
/* 438 */             agg_rowWriter.write(5, scan_value6);
/* 439 */           }
/* 440 */
/* 441 */           if (scan_isNull7) {
/* 442 */             agg_rowWriter.setNullAt(6);
/* 443 */           } else {
/* 444 */             agg_rowWriter.write(6, scan_value7);
/* 445 */           }
/* 446 */
/* 447 */           if (bhj_isNull21) {
/* 448 */             agg_rowWriter.setNullAt(7);
/* 449 */           } else {
/* 450 */             agg_rowWriter.write(7, bhj_value21);
/* 451 */           }
...
/* 466 */
/* 467 */           if (!scan_isNull4) {
/* 468 */             agg_value18 = org.apache.spark.unsafe.hash.Murmur3_x86_32.hashUnsafeBytes(scan_value4.getBaseObject(), scan_value4.getBaseOffset(), scan_value4.numBytes(), agg_value18);
/* 469 */           }
/* 470 */
/* 471 */           if (!scan_isNull5) {
/* 472 */             agg_value18 = org.apache.spark.unsafe.hash.Murmur3_x86_32.hashUnsafeBytes(scan_value5.getBaseObject(), scan_value5.getBaseOffset(), scan_value5.numBytes(), agg_value18);
/* 473 */           }
/* 474 */
/* 475 */           if (!scan_isNull6) {
/* 476 */             agg_value18 = org.apache.spark.unsafe.hash.Murmur3_x86_32.hashUnsafeBytes(scan_value6.getBaseObject(), scan_value6.getBaseOffset(), scan_value6.numBytes(), agg_value18);
/* 477 */           }
/* 478 */
/* 479 */           if (!scan_isNull7) {
/* 480 */             agg_value18 = org.apache.spark.unsafe.hash.Murmur3_x86_32.hashUnsafeBytes(scan_value7.getBaseObject(), scan_value7.getBaseOffset(), scan_value7.numBytes(), agg_value18);
/* 481 */           }
/* 482 */
/* 483 */           if (!bhj_isNull21) {
/* 484 */             agg_value18 = org.apache.spark.unsafe.hash.Murmur3_x86_32.hashInt(bhj_value21, agg_value18);
/* 485 */           }
/* 486 */           if (true) {
