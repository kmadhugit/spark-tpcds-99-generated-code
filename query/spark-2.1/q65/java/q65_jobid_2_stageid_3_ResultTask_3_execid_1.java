...
/* 099 */           agg_value6 = org.apache.spark.unsafe.hash.Murmur3_x86_32.hashInt(inputadapter_value, agg_value6);
/* 100 */         }
/* 101 */
/* 102 */         if (!inputadapter_isNull1) {
/* 103 */           agg_value6 = org.apache.spark.unsafe.hash.Murmur3_x86_32.hashInt(inputadapter_value1, agg_value6);
/* 104 */         }
/* 105 */         if (true) {
...
/* 208 */       int agg_value17 = agg_isNull16 ? -1 : (agg_aggKey.getInt(0));
/* 209 */       boolean agg_isNull17 = agg_aggKey.isNullAt(1);
/* 210 */       int agg_value18 = agg_isNull17 ? -1 : (agg_aggKey.getInt(1));
