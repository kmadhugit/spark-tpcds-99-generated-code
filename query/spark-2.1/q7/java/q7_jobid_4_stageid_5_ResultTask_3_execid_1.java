...
/* 421 */       }
/* 422 */
/* 423 */       agg_holder1.reset();
/* 424 */
/* 425 */       agg_rowWriter1.zeroOutNullBytes();
/* 426 */
/* 427 */       if (agg_isNull40) {
/* 428 */         agg_rowWriter1.setNullAt(0);
/* 429 */       } else {
/* 430 */         agg_rowWriter1.write(0, agg_value48);
/* 431 */       }
/* 432 */
/* 433 */       if (agg_isNull49) {
/* 434 */         agg_rowWriter1.setNullAt(1);
/* 435 */       } else {
/* 436 */         agg_rowWriter1.write(1, agg_value57);
/* 437 */       }
/* 438 */
/* 439 */       if (agg_isNull54) {
/* 440 */         agg_rowWriter1.setNullAt(2);
/* 441 */       } else {
/* 442 */         agg_rowWriter1.write(2, agg_value62);
/* 443 */       }
/* 444 */
/* 445 */       if (agg_isNull59) {
/* 446 */         agg_rowWriter1.setNullAt(3);
/* 447 */       } else {
/* 448 */         agg_rowWriter1.write(3, agg_value67);
/* 449 */       }
/* 450 */
/* 451 */       if (agg_isNull64) {
/* 452 */         agg_rowWriter1.setNullAt(4);
/* 453 */       } else {
/* 454 */         agg_rowWriter1.write(4, agg_value72);
/* 455 */       }
/* 456 */       agg_result1.setTotalSize(agg_holder1.totalSize());
/* 457 */       append(agg_result1);
/* 458 */
/* 459 */       if (shouldStop()) return;
/* 460 */     }
/* 461 */
/* 462 */     agg_mapIter.close();
/* 463 */     if (agg_sorter == null) {
/* 464 */       agg_hashMap.free();
/* 465 */     }
/* 466 */   }
/* 467 */ }
