...
/* 099 */         int scan_value2 = scan_isNull2 ? -1 : (scan_colInstance2.getInt(scan_rowIdx));
/* 100 */         project_rowWriter.zeroOutNullBytes();
/* 101 */
/* 102 */         project_rowWriter.write(0, scan_value);
/* 103 */
/* 104 */         if (scan_isNull1) {
/* 105 */           project_rowWriter.setNullAt(1);
/* 106 */         } else {
/* 107 */           project_rowWriter.write(1, scan_value1);
/* 108 */         }
/* 109 */
/* 110 */         if (scan_isNull2) {
/* 111 */           project_rowWriter.setNullAt(2);
/* 112 */         } else {
