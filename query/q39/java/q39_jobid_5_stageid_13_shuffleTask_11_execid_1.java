...
/* 060 */       int value1 = isNull1 ? -1 : (i.getInt(1));
...
/* 158 */     double primitiveA4;
/* 159 */     {
/* 160 */
/* 161 */       boolean isNull4 = i.isNullAt(4);
/* 162 */       double value4 = isNull4 ? -1.0 : (i.getDouble(4));
/* 163 */       isNullA4 = isNull4;
/* 164 */       primitiveA4 = value4;
/* 165 */     }
/* 166 */     i = b;
/* 167 */     boolean isNullB4;
/* 168 */     double primitiveB4;
/* 169 */     {
/* 170 */
/* 171 */       boolean isNull4 = i.isNullAt(4);
/* 172 */       double value4 = isNull4 ? -1.0 : (i.getDouble(4));
...
/* 181 */       return 1;
/* 182 */     } else {
/* 183 */       int comp = org.apache.spark.util.Utils.nanSafeCompareDoubles(primitiveA4, primitiveB4);
/* 184 */       if (comp != 0) {
/* 185 */         return comp;
/* 186 */       }
/* 187 */     }
...
/* 193 */     {
/* 194 */
/* 195 */       boolean isNull5 = i.isNullAt(7);
/* 196 */       int value5 = isNull5 ? -1 : (i.getInt(7));
...
/* 203 */     {
/* 204 */
/* 205 */       boolean isNull5 = i.isNullAt(7);
/* 206 */       int value5 = isNull5 ? -1 : (i.getInt(7));
...
/* 226 */     double primitiveA6;
/* 227 */     {
/* 228 */
/* 229 */       boolean isNull6 = i.isNullAt(8);
/* 230 */       double value6 = isNull6 ? -1.0 : (i.getDouble(8));
/* 231 */       isNullA6 = isNull6;
/* 232 */       primitiveA6 = value6;
/* 233 */     }
/* 234 */     i = b;
/* 235 */     boolean isNullB6;
/* 236 */     double primitiveB6;
/* 237 */     {
/* 238 */
/* 239 */       boolean isNull6 = i.isNullAt(8);
/* 240 */       double value6 = isNull6 ? -1.0 : (i.getDouble(8));
...
/* 249 */       return 1;
/* 250 */     } else {
/* 251 */       int comp = org.apache.spark.util.Utils.nanSafeCompareDoubles(primitiveA6, primitiveB6);
/* 252 */       if (comp != 0) {
/* 253 */         return comp;
/* 254 */       }
/* 255 */     }
...
/* 260 */     double primitiveA7;
/* 261 */     {
/* 262 */
/* 263 */       boolean isNull7 = i.isNullAt(9);
/* 264 */       double value7 = isNull7 ? -1.0 : (i.getDouble(9));
/* 265 */       isNullA7 = isNull7;
/* 266 */       primitiveA7 = value7;
/* 267 */     }
/* 268 */     i = b;
/* 269 */     boolean isNullB7;
/* 270 */     double primitiveB7;
/* 271 */     {
/* 272 */
/* 273 */       boolean isNull7 = i.isNullAt(9);
/* 274 */       double value7 = isNull7 ? -1.0 : (i.getDouble(9));
...
/* 283 */       return 1;
/* 284 */     } else {
/* 285 */       int comp = org.apache.spark.util.Utils.nanSafeCompareDoubles(primitiveA7, primitiveB7);
/* 286 */       if (comp != 0) {
/* 287 */         return comp;
/* 288 */       }
/* 289 */     }
