...
/* 142 */         } else {
/* 143 */           smj_matches.add(smj_rightRow.copy());
...
/* 153 */       int smj_size = smj_matches.size();
/* 154 */       smj_value12 = smj_leftRow.getUTF8String(0);
/* 155 */       smj_isNull6 = smj_leftRow.isNullAt(1);
/* 156 */       smj_value13 = smj_isNull6 ? -1 : (smj_leftRow.getInt(1));
/* 157 */       smj_isNull7 = smj_leftRow.isNullAt(2);
/* 158 */       smj_value14 = smj_isNull7 ? -1 : (smj_leftRow.getInt(2));
/* 159 */       smj_isNull8 = smj_leftRow.isNullAt(3);
/* 160 */       smj_value15 = smj_isNull8 ? -1 : (smj_leftRow.getInt(3));
/* 161 */       smj_isNull9 = smj_leftRow.isNullAt(4);
/* 162 */       smj_value16 = smj_isNull9 ? -1.0 : (smj_leftRow.getDouble(4));
/* 163 */       smj_value17 = smj_leftRow.getLong(5);
/* 164 */       for (int smj_i = 0; smj_i < smj_size; smj_i ++) {
/* 165 */         InternalRow smj_rightRow1 = (InternalRow) smj_matches.get(smj_i);
/* 166 */
