...
/* 060 */     }
/* 061 */
/* 062 */     int value6 = i.getInt(4);
/* 063 */     value1 = org.apache.spark.unsafe.hash.Murmur3_x86_32.hashInt(value6, value1);
/* 064 */
/* 065 */     int value = -1;
/* 066 */
/* 067 */     int remainder = value1 % 64;
/* 068 */     if (remainder < 0) {
/* 069 */       value = (remainder + 64) % 64;
/* 070 */     } else {
/* 071 */       value = remainder;
/* 072 */     }
/* 073 */     rowWriter.write(0, value);
/* 074 */     return result;
/* 075 */   }
/* 076 */ }
