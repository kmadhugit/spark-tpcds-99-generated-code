...
/* 099 */
/* 100 */         boolean scan_isNull = scan_colInstance0.isNullAt(scan_rowIdx);
/* 101 */         int scan_value = scan_isNull ? -1 : (scan_colInstance0.getInt(scan_rowIdx));
/* 102 */
/* 103 */         if (!(!(scan_isNull))) continue;
/* 104 */
