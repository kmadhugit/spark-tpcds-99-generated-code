...
/* 026 */       int value2 = isNull2 ? -1 : (i.getInt(2));
...
/* 036 */       int value2 = isNull2 ? -1 : (i.getInt(2));
...
/* 098 */     {
/* 099 */
/* 100 */       UTF8String value = i.getUTF8String(0);
/* 101 */       isNullA = false;
/* 102 */       primitiveA = value;
/* 103 */     }
/* 104 */     i = b;
/* 105 */     boolean isNullB;
/* 106 */     UTF8String primitiveB;
/* 107 */     {
/* 108 */
/* 109 */       UTF8String value = i.getUTF8String(0);
/* 110 */       isNullB = false;
...
/* 132 */       int value1 = isNull1 ? -1 : (i.getInt(1));
...
/* 142 */       int value1 = isNull1 ? -1 : (i.getInt(1));
...
/* 151 */       return 1;
/* 152 */     } else {
/* 153 */       int comp = (primitiveA1 > primitiveB1 ? 1 : primitiveA1 < primitiveB1 ? -1 : 0);
/* 154 */       if (comp != 0) {
/* 155 */         return comp;
/* 156 */       }
/* 157 */     }
