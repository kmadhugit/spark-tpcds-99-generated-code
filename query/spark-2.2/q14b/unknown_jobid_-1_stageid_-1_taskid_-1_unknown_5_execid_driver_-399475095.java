...
/* 101 */         filter_value2 = scan_value1 == 1999;
...
/* 111 */         filter_value7 = scan_value2 == 12;
/* 112 */         if (!filter_value7) continue;
/* 113 */         boolean scan_isNull3 = scan_colInstance3.isNullAt(scan_rowIdx);
/* 114 */         int scan_value3 = scan_isNull3 ? -1 : (scan_colInstance3.getInt(scan_rowIdx));
/* 115 */
...
/* 121 */         filter_value12 = scan_value3 == 11;
...
/* 129 */
/* 130 */         if (scan_isNull) {
/* 131 */           project_rowWriter.setNullAt(0);
/* 132 */         } else {
