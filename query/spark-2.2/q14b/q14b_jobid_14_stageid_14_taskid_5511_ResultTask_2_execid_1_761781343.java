...
/* 097 */           filter_value2 = scan_value1 == 5215;
/* 098 */
/* 099 */         }
...
/* 111 */         if (shouldStop()) { scan_batchIdx = scan_rowIdx + 1; return; }
/* 112 */       }
/* 113 */       scan_batchIdx = scan_numRows;
/* 114 */       scan_batch = null;
/* 115 */       scan_nextBatch();
/* 116 */     }
/* 117 */     scan_scanTime.add(scan_scanTime1 / (1000 * 1000));
/* 118 */     scan_scanTime1 = 0;
/* 119 */   }
/* 120 */ }
