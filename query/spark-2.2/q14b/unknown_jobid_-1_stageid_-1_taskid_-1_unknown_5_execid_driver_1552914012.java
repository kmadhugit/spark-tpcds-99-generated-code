...
/* 061 */       boolean agg_isNull8 = true;
/* 062 */       double agg_value8 = -1.0;
/* 063 */
/* 064 */       if (!agg_bufIsNull) {
/* 065 */         if (!inputadapter_isNull) {
/* 066 */           agg_isNull8 = false; // resultCode could change nullability.
/* 067 */           agg_value8 = agg_bufValue + inputadapter_value;
/* 068 */
/* 069 */         }
/* 070 */
/* 071 */       }
/* 072 */       boolean agg_isNull11 = true;
/* 073 */       long agg_value11 = -1L;
/* 074 */
/* 075 */       if (!agg_bufIsNull1) {
/* 076 */         if (!inputadapter_isNull1) {
/* 077 */           agg_isNull11 = false; // resultCode could change nullability.
/* 078 */           agg_value11 = agg_bufValue1 + inputadapter_value1;
/* 079 */
/* 080 */         }
/* 081 */
/* 082 */       }
/* 083 */       // update aggregation buffer
/* 084 */       agg_bufIsNull = agg_isNull8;
/* 085 */       agg_bufValue = agg_value8;
/* 086 */
/* 087 */       agg_bufIsNull1 = agg_isNull11;
/* 088 */       agg_bufValue1 = agg_value11;
...
/* 124 */       } else {
/* 125 */         agg_rowWriter.write(0, agg_value3);
/* 126 */       }
