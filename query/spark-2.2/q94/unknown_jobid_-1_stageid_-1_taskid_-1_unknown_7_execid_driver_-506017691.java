...
/* 187 */
/* 188 */         boolean scan_isNull10 = scan_colInstance10.isNullAt(scan_rowIdx);
/* 189 */         int scan_value10 = scan_isNull10 ? -1 : (scan_colInstance10.getInt(scan_rowIdx));
/* 190 */
/* 191 */         if (!(!(scan_isNull10))) continue;
/* 192 */
...
/* 216 */         boolean scan_isNull9 = scan_colInstance9.isNullAt(scan_rowIdx);
/* 217 */         int scan_value9 = scan_isNull9 ? -1 : (scan_colInstance9.getInt(scan_rowIdx));
/* 218 */         boolean scan_isNull11 = scan_colInstance11.isNullAt(scan_rowIdx);
/* 219 */         int scan_value11 = scan_isNull11 ? -1 : (scan_colInstance11.getInt(scan_rowIdx));
...
/* 313 */
/* 314 */         if (scan_isNull9) {
/* 315 */           project_rowWriter.setNullAt(9);
/* 316 */         } else {
/* 317 */           project_rowWriter.write(9, scan_value9);
/* 318 */         }
/* 319 */
/* 320 */         project_rowWriter.write(10, scan_value10);
/* 321 */
/* 322 */         if (scan_isNull11) {
/* 323 */           project_rowWriter.setNullAt(11);
/* 324 */         } else {
/* 325 */           project_rowWriter.write(11, scan_value11);
/* 326 */         }
/* 327 */
/* 328 */         project_rowWriter.write(12, scan_value12);
/* 329 */
