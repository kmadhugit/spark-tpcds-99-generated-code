...
/* 022 */
/* 023 */     Platform.putLong(buf, 16, Platform.getLong(obj1, offset1 + 0) | (Platform.getLong(obj2, offset2) << 2));
/* 024 */
...
/* 048 */     long numBytesVariableRow2 = row2.getSizeInBytes() - 64;
...
/* 053 */
/* 054 */
/* 055 */     Platform.putLong(buf, 24, Platform.getLong(buf, 24) + (56L << 32));
/* 056 */
/* 057 */
/* 058 */     Platform.putLong(buf, 32, Platform.getLong(buf, 32) + (56L << 32));
/* 059 */
/* 060 */
/* 061 */
/* 062 */
...
/* 066 */
/* 067 */
/* 068 */     out.pointTo(buf, sizeInBytes);
/* 069 */
/* 070 */     return out;
/* 071 */   }
/* 072 */ }
