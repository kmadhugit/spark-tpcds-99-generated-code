...
/* 078 */       return 1;
/* 079 */     } else {
/* 080 */       int comp = org.apache.spark.util.Utils.nanSafeCompareDoubles(primitiveA5, primitiveB5);
/* 081 */       if (comp != 0) {
/* 082 */         return comp;
/* 083 */       }
/* 084 */     }
...
/* 097 */     double primitiveA2;
/* 098 */     {
/* 099 */
/* 100 */       boolean isNull2 = i.isNullAt(2);
/* 101 */       double value2 = isNull2 ? -1.0 : (i.getDouble(2));
/* 102 */       isNullA2 = isNull2;
/* 103 */       primitiveA2 = value2;
/* 104 */     }
/* 105 */     i = b;
/* 106 */     boolean isNullB2;
/* 107 */     double primitiveB2;
/* 108 */     {
/* 109 */
/* 110 */       boolean isNull2 = i.isNullAt(2);
/* 111 */       double value2 = isNull2 ? -1.0 : (i.getDouble(2));
...
/* 120 */       return 1;
/* 121 */     } else {
/* 122 */       int comp = org.apache.spark.util.Utils.nanSafeCompareDoubles(primitiveA2, primitiveB2);
/* 123 */       if (comp != 0) {
/* 124 */         return comp;
/* 125 */       }
/* 126 */     }
...
/* 214 */     double primitiveA6;
/* 215 */     {
/* 216 */
/* 217 */       boolean isNull6 = i.isNullAt(6);
/* 218 */       double value6 = isNull6 ? -1.0 : (i.getDouble(6));
/* 219 */       isNullA6 = isNull6;
/* 220 */       primitiveA6 = value6;
/* 221 */     }
/* 222 */     i = b;
/* 223 */     boolean isNullB6;
/* 224 */     double primitiveB6;
/* 225 */     {
/* 226 */
/* 227 */       boolean isNull6 = i.isNullAt(6);
/* 228 */       double value6 = isNull6 ? -1.0 : (i.getDouble(6));
...
/* 237 */       return 1;
/* 238 */     } else {
/* 239 */       int comp = org.apache.spark.util.Utils.nanSafeCompareDoubles(primitiveA6, primitiveB6);
/* 240 */       if (comp != 0) {
/* 241 */         return comp;
/* 242 */       }
/* 243 */     }
...
/* 247 */     double primitiveA7;
/* 248 */     {
/* 249 */
/* 250 */       boolean isNull7 = i.isNullAt(7);
/* 251 */       double value7 = isNull7 ? -1.0 : (i.getDouble(7));
/* 252 */       isNullA7 = isNull7;
/* 253 */       primitiveA7 = value7;
/* 254 */     }
/* 255 */     i = b;
/* 256 */     boolean isNullB7;
/* 257 */     double primitiveB7;
/* 258 */     {
/* 259 */
/* 260 */       boolean isNull7 = i.isNullAt(7);
/* 261 */       double value7 = isNull7 ? -1.0 : (i.getDouble(7));
...
/* 270 */       return 1;
/* 271 */     } else {
/* 272 */       int comp = org.apache.spark.util.Utils.nanSafeCompareDoubles(primitiveA7, primitiveB7);
/* 273 */       if (comp != 0) {
/* 274 */         return comp;
/* 275 */       }
/* 276 */     }
