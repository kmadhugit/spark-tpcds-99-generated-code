...
/* 136 */
/* 137 */
/* 138 */   public java.lang.Object apply(java.lang.Object _i) {
/* 139 */     InternalRow i = (InternalRow) _i;
/* 140 */
/* 141 */     values = new Object[9];
/* 142 */     apply_0(i);
/* 143 */     apply_1(i);
/* 144 */     apply_2(i);
/* 145 */     final org.apache.spark.sql.Row value = new org.apache.spark.sql.catalyst.expressions.GenericRowWithSchema(values, schema);
/* 146 */     if (false) {
/* 147 */       mutableRow.setNullAt(0);
/* 148 */     } else {
/* 149 */
/* 150 */       mutableRow.update(0, value);
/* 151 */     }
/* 152 */
/* 153 */     return mutableRow;
/* 154 */   }
/* 155 */ }
