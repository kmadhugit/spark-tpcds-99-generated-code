...
/* 061 */     }
/* 062 */
/* 063 */     final org.apache.spark.sql.Row value = new org.apache.spark.sql.catalyst.expressions.GenericRowWithSchema(values, schema);
/* 064 */     if (false) {
/* 065 */       mutableRow.setNullAt(0);
/* 066 */     } else {
/* 067 */
/* 068 */       mutableRow.update(0, value);
/* 069 */     }
/* 070 */
/* 071 */     return mutableRow;
/* 072 */   }
/* 073 */ }
