...
/* 023 */     {
/* 024 */
/* 025 */       boolean isNull4 = i.isNullAt(3);
/* 026 */       UTF8String value4 = isNull4 ? null : (i.getUTF8String(3));
...
/* 033 */     {
/* 034 */
/* 035 */       boolean isNull4 = i.isNullAt(3);
/* 036 */       UTF8String value4 = isNull4 ? null : (i.getUTF8String(3));
...
/* 065 */     {
/* 066 */
/* 067 */       boolean isNull2 = i.isNullAt(1);
/* 068 */       UTF8String value2 = isNull2 ? null : (i.getUTF8String(1));
...
/* 075 */     {
/* 076 */
/* 077 */       boolean isNull2 = i.isNullAt(1);
/* 078 */       UTF8String value2 = isNull2 ? null : (i.getUTF8String(1));
...
/* 098 */     {
/* 099 */
/* 100 */       boolean isNull3 = i.isNullAt(2);
/* 101 */       UTF8String value3 = isNull3 ? null : (i.getUTF8String(2));
...
/* 108 */     {
/* 109 */
/* 110 */       boolean isNull3 = i.isNullAt(2);
/* 111 */       UTF8String value3 = isNull3 ? null : (i.getUTF8String(2));
...
/* 137 */     i = a;
/* 138 */     boolean isNullA;
/* 139 */     double primitiveA;
/* 140 */     {
/* 141 */
/* 142 */       boolean isNull = i.isNullAt(4);
/* 143 */       double value = isNull ? -1.0 : (i.getDouble(4));
/* 144 */       isNullA = isNull;
/* 145 */       primitiveA = value;
/* 146 */     }
/* 147 */     i = b;
/* 148 */     boolean isNullB;
/* 149 */     double primitiveB;
/* 150 */     {
/* 151 */
/* 152 */       boolean isNull = i.isNullAt(4);
/* 153 */       double value = isNull ? -1.0 : (i.getDouble(4));
/* 154 */       isNullB = isNull;
...
/* 162 */       return 1;
/* 163 */     } else {
/* 164 */       int comp = org.apache.spark.util.Utils.nanSafeCompareDoubles(primitiveA, primitiveB);
/* 165 */       if (comp != 0) {
/* 166 */         return comp;
/* 167 */       }
/* 168 */     }
...
/* 173 */     {
/* 174 */
/* 175 */       boolean isNull1 = i.isNullAt(0);
/* 176 */       UTF8String value1 = isNull1 ? null : (i.getUTF8String(0));
...
/* 183 */     {
/* 184 */
/* 185 */       boolean isNull1 = i.isNullAt(0);
/* 186 */       UTF8String value1 = isNull1 ? null : (i.getUTF8String(0));
