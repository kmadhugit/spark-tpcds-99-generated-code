...
/* 122 */     double value9 = isNull9 ? -1.0 : (i.getDouble(4));
/* 123 */     if (isNull9) {
/* 124 */       values[4] = null;
/* 125 */     } else {
/* 126 */       values[4] = value9;
...
/* 130 */
/* 131 */
/* 132 */   public java.lang.Object apply(java.lang.Object _i) {
/* 133 */     InternalRow i = (InternalRow) _i;
/* 134 */
/* 135 */     values = new Object[5];
/* 136 */     apply_0(i);
/* 137 */     apply_1(i);
/* 138 */     apply_2(i);
/* 139 */     final org.apache.spark.sql.Row value = new org.apache.spark.sql.catalyst.expressions.GenericRowWithSchema(values, schema);
/* 140 */     if (false) {
/* 141 */       mutableRow.setNullAt(0);
/* 142 */     } else {
/* 143 */
/* 144 */       mutableRow.update(0, value);
/* 145 */     }
/* 146 */
/* 147 */     return mutableRow;
/* 148 */   }
/* 149 */ }
