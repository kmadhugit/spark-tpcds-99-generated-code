...
/* 092 */
/* 093 */         boolean filter_value = false;
/* 094 */         boolean filter_isNull = scan_isNull2;
/* 095 */         if (!filter_isNull) {
/* 096 */           if (!filter_value) {
/* 097 */             if (false) {
/* 098 */               filter_isNull = true;
/* 099 */             } else if (scan_value2 == 6) {
/* 100 */               filter_isNull = false;
/* 101 */               filter_value = true;
/* 102 */             }
/* 103 */           }
/* 104 */
/* 105 */           if (!filter_value) {
...
/* 113 */
/* 114 */         }
/* 115 */         if (filter_isNull || !filter_value) continue;
...
/* 118 */
/* 119 */         boolean filter_value4 = false;
/* 120 */         boolean filter_isNull4 = scan_isNull1;
/* 121 */         if (!filter_isNull4) {
/* 122 */           if (!filter_value4) {
/* 123 */             if (false) {
/* 124 */               filter_isNull4 = true;
/* 125 */             } else if (scan_value1 == 1999) {
/* 126 */               filter_isNull4 = false;
/* 127 */               filter_value4 = true;
/* 128 */             }
/* 129 */           }
/* 130 */
/* 131 */           if (!filter_value4) {
/* 132 */             if (false) {
/* 133 */               filter_isNull4 = true;
/* 134 */             } else if (scan_value1 == 2000) {
/* 135 */               filter_isNull4 = false;
/* 136 */               filter_value4 = true;
/* 137 */             }
/* 138 */           }
/* 139 */
/* 140 */           if (!filter_value4) {
/* 141 */             if (false) {
/* 142 */               filter_isNull4 = true;
/* 143 */             } else if (scan_value1 == 2001) {
/* 144 */               filter_isNull4 = false;
/* 145 */               filter_value4 = true;
/* 146 */             }
/* 147 */           }
/* 148 */
/* 149 */         }
/* 150 */         if (filter_isNull4 || !filter_value4) continue;
/* 151 */
...
/* 160 */         append(project_result);
/* 161 */         if (shouldStop()) { scan_batchIdx = scan_rowIdx + 1; return; }
/* 162 */       }
/* 163 */       scan_batchIdx = scan_numRows;
/* 164 */       scan_batch = null;
/* 165 */       scan_nextBatch();
/* 166 */     }
/* 167 */     scan_scanTime.add(scan_scanTime1 / (1000 * 1000));
/* 168 */     scan_scanTime1 = 0;
/* 169 */   }
/* 170 */ }
