...
/* 053 */
/* 054 */
/* 055 */     Platform.putLong(buf, 24, Platform.getLong(buf, 24) + (16L << 32));
/* 056 */
/* 057 */
/* 058 */     Platform.putLong(buf, 32, Platform.getLong(buf, 32) + (16L << 32));
/* 059 */
/* 060 */
/* 061 */     Platform.putLong(buf, 40, Platform.getLong(buf, 40) + (16L << 32));
/* 062 */
/* 063 */
/* 064 */     Platform.putLong(buf, 48, Platform.getLong(buf, 48) + (16L << 32));
/* 065 */
/* 066 */
/* 067 */     Platform.putLong(buf, 56, Platform.getLong(buf, 56) + (16L << 32));
/* 068 */
/* 069 */
/* 070 */
/* 071 */
/* 072 */
/* 073 */     out.pointTo(buf, sizeInBytes);
/* 074 */
/* 075 */     return out;
/* 076 */   }
/* 077 */ }
