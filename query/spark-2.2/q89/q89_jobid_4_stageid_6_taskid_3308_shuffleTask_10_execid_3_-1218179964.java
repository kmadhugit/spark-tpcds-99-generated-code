...
/* 023 */     {
/* 024 */
/* 025 */       boolean isNull3 = i.isNullAt(3);
/* 026 */       UTF8String value3 = isNull3 ? null : (i.getUTF8String(3));
...
/* 033 */     {
/* 034 */
/* 035 */       boolean isNull3 = i.isNullAt(3);
/* 036 */       UTF8String value3 = isNull3 ? null : (i.getUTF8String(3));
...
/* 072 */       if (!isNull1) {
/* 073 */
/* 074 */         boolean isNull2 = i.isNullAt(7);
/* 075 */         double value2 = isNull2 ? -1.0 : (i.getDouble(7));
/* 076 */         if (!isNull2) {
/* 077 */
...
/* 097 */       if (!isNull1) {
/* 098 */
/* 099 */         boolean isNull2 = i.isNullAt(7);
/* 100 */         double value2 = isNull2 ? -1.0 : (i.getDouble(7));
/* 101 */         if (!isNull2) {
/* 102 */
