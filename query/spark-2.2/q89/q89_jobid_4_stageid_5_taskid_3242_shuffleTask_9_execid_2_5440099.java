...
/* 042 */     }
/* 043 */
/* 044 */     boolean isNull3 = i.isNullAt(2);
/* 045 */     UTF8String value3 = isNull3 ? null : (i.getUTF8String(2));
/* 046 */     if (!isNull3) {
...
/* 048 */     }
/* 049 */
/* 050 */     boolean isNull4 = i.isNullAt(3);
/* 051 */     UTF8String value4 = isNull4 ? null : (i.getUTF8String(3));
/* 052 */     if (!isNull4) {
...
/* 054 */     }
/* 055 */
/* 056 */     boolean isNull5 = i.isNullAt(4);
/* 057 */     UTF8String value5 = isNull5 ? null : (i.getUTF8String(4));
/* 058 */     if (!isNull5) {
/* 059 */       value1 = org.apache.spark.unsafe.hash.Murmur3_x86_32.hashUnsafeBytes(value5.getBaseObject(), value5.getBaseOffset(), value5.numBytes(), value1);
/* 060 */     }
/* 061 */
/* 062 */     int value = -1;
/* 063 */
