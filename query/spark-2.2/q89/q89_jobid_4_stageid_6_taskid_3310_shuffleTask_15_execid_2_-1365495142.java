...
/* 044 */
/* 045 */
/* 046 */     boolean isNull1 = i.isNullAt(2);
/* 047 */     UTF8String value1 = isNull1 ? null : (i.getUTF8String(2));
/* 048 */     if (isNull1) {
...
/* 053 */
/* 054 */
/* 055 */     boolean isNull2 = i.isNullAt(3);
/* 056 */     UTF8String value2 = isNull2 ? null : (i.getUTF8String(3));
/* 057 */     if (isNull2) {
...
/* 062 */
/* 063 */
/* 064 */     boolean isNull3 = i.isNullAt(4);
/* 065 */     UTF8String value3 = isNull3 ? null : (i.getUTF8String(4));
/* 066 */     if (isNull3) {
