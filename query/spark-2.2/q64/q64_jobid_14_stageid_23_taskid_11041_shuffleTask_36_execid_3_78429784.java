...
/* 051 */
/* 052 */     agg_result1 = new UnsafeRow(17);
/* 053 */     this.agg_holder1 = new org.apache.spark.sql.catalyst.expressions.codegen.BufferHolder(agg_result1, 352);
/* 054 */     this.agg_rowWriter1 = new org.apache.spark.sql.catalyst.expressions.codegen.UnsafeRowWriter(agg_holder1, 17);
...
/* 491 */       } else {
/* 492 */         agg_rowWriter1.write(0, agg_value81);
/* 493 */       }
/* 494 */
/* 495 */       if (agg_isNull78) {
/* 496 */         agg_rowWriter1.setNullAt(1);
/* 497 */       } else {
/* 498 */         agg_rowWriter1.write(1, agg_value82);
/* 499 */       }
/* 500 */
/* 501 */       if (agg_isNull79) {
/* 502 */         agg_rowWriter1.setNullAt(2);
/* 503 */       } else {
/* 504 */         agg_rowWriter1.write(2, agg_value83);
/* 505 */       }
/* 506 */
/* 507 */       if (agg_isNull80) {
/* 508 */         agg_rowWriter1.setNullAt(3);
/* 509 */       } else {
/* 510 */         agg_rowWriter1.write(3, agg_value84);
/* 511 */       }
/* 512 */
/* 513 */       if (agg_isNull81) {
/* 514 */         agg_rowWriter1.setNullAt(4);
/* 515 */       } else {
/* 516 */         agg_rowWriter1.write(4, agg_value85);
/* 517 */       }
/* 518 */
/* 519 */       if (agg_isNull82) {
/* 520 */         agg_rowWriter1.setNullAt(5);
/* 521 */       } else {
/* 522 */         agg_rowWriter1.write(5, agg_value86);
/* 523 */       }
/* 524 */
/* 525 */       if (agg_isNull83) {
/* 526 */         agg_rowWriter1.setNullAt(6);
/* 527 */       } else {
/* 528 */         agg_rowWriter1.write(6, agg_value87);
/* 529 */       }
/* 530 */
/* 531 */       if (agg_isNull84) {
/* 532 */         agg_rowWriter1.setNullAt(7);
/* 533 */       } else {
/* 534 */         agg_rowWriter1.write(7, agg_value88);
/* 535 */       }
/* 536 */
/* 537 */       if (agg_isNull85) {
/* 538 */         agg_rowWriter1.setNullAt(8);
/* 539 */       } else {
/* 540 */         agg_rowWriter1.write(8, agg_value89);
/* 541 */       }
/* 542 */
/* 543 */       if (agg_isNull86) {
/* 544 */         agg_rowWriter1.setNullAt(9);
/* 545 */       } else {
/* 546 */         agg_rowWriter1.write(9, agg_value90);
/* 547 */       }
/* 548 */
/* 549 */       if (agg_isNull87) {
/* 550 */         agg_rowWriter1.setNullAt(10);
/* 551 */       } else {
/* 552 */         agg_rowWriter1.write(10, agg_value91);
/* 553 */       }
/* 554 */
/* 555 */       if (agg_isNull88) {
/* 556 */         agg_rowWriter1.setNullAt(11);
/* 557 */       } else {
/* 558 */         agg_rowWriter1.write(11, agg_value92);
/* 559 */       }
/* 560 */
/* 561 */       if (agg_isNull89) {
/* 562 */         agg_rowWriter1.setNullAt(12);
/* 563 */       } else {
/* 564 */         agg_rowWriter1.write(12, agg_value93);
/* 565 */       }
/* 566 */
/* 567 */       agg_rowWriter1.write(13, agg_value96);
/* 568 */
/* 569 */       if (agg_isNull93) {
/* 570 */         agg_rowWriter1.setNullAt(14);
/* 571 */       } else {
/* 572 */         agg_rowWriter1.write(14, agg_value97);
/* 573 */       }
/* 574 */
/* 575 */       if (agg_isNull94) {
/* 576 */         agg_rowWriter1.setNullAt(15);
/* 577 */       } else {
/* 578 */         agg_rowWriter1.write(15, agg_value98);
/* 579 */       }
/* 580 */
/* 581 */       if (agg_isNull95) {
/* 582 */         agg_rowWriter1.setNullAt(16);
/* 583 */       } else {
/* 584 */         agg_rowWriter1.write(16, agg_value99);
/* 585 */       }
/* 586 */       agg_result1.setTotalSize(agg_holder1.totalSize());
/* 587 */       append(agg_result1);
/* 588 */
