...
/* 022 */
/* 023 */     Platform.putLong(buf, 16, Platform.getLong(obj1, offset1 + 0) | (Platform.getLong(obj2, offset2) << 15));
/* 024 */
...
/* 053 */
/* 054 */
/* 055 */     Platform.putLong(buf, 24, Platform.getLong(buf, 24) + (32L << 32));
/* 056 */
/* 057 */
/* 058 */
/* 059 */     Platform.putLong(buf, 40, Platform.getLong(buf, 40) + (32L << 32));
/* 060 */
/* 061 */
/* 062 */     Platform.putLong(buf, 48, Platform.getLong(buf, 48) + (32L << 32));
/* 063 */
/* 064 */
/* 065 */     Platform.putLong(buf, 56, Platform.getLong(buf, 56) + (32L << 32));
/* 066 */
/* 067 */
/* 068 */     Platform.putLong(buf, 64, Platform.getLong(buf, 64) + (32L << 32));
/* 069 */
/* 070 */
/* 071 */     Platform.putLong(buf, 72, Platform.getLong(buf, 72) + (32L << 32));
/* 072 */
/* 073 */
/* 074 */     Platform.putLong(buf, 80, Platform.getLong(buf, 80) + (32L << 32));
/* 075 */
/* 076 */
/* 077 */     Platform.putLong(buf, 88, Platform.getLong(buf, 88) + (32L << 32));
/* 078 */
/* 079 */
/* 080 */     Platform.putLong(buf, 96, Platform.getLong(buf, 96) + (32L << 32));
/* 081 */
/* 082 */
/* 083 */     Platform.putLong(buf, 104, Platform.getLong(buf, 104) + (32L << 32));
/* 084 */
/* 085 */
/* 086 */     Platform.putLong(buf, 112, Platform.getLong(buf, 112) + (32L << 32));
/* 087 */
/* 088 */
/* 089 */
/* 090 */
