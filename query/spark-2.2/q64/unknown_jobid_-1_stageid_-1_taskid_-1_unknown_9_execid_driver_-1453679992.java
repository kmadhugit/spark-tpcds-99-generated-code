...
/* 100 */
/* 101 */         project_rowWriter.write(1, scan_value1);
/* 102 */         append(project_result);
/* 103 */         if (shouldStop()) { scan_batchIdx = scan_rowIdx + 1; return; }
/* 104 */       }
/* 105 */       scan_batchIdx = scan_numRows;
/* 106 */       scan_batch = null;
/* 107 */       scan_nextBatch();
/* 108 */     }
/* 109 */     scan_scanTime.add(scan_scanTime1 / (1000 * 1000));
/* 110 */     scan_scanTime1 = 0;
/* 111 */   }
/* 112 */ }
