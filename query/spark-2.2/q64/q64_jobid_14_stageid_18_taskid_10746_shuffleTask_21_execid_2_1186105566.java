...
/* 023 */     {
/* 024 */
/* 025 */       boolean isNull3 = i.isNullAt(7);
/* 026 */       int value3 = isNull3 ? -1 : (i.getInt(7));
...
/* 038 */     {
/* 039 */
/* 040 */       boolean isNull3 = i.isNullAt(7);
/* 041 */       int value3 = isNull3 ? -1 : (i.getInt(7));
...
/* 075 */     {
/* 076 */
/* 077 */       boolean isNull1 = i.isNullAt(0);
/* 078 */       int value1 = isNull1 ? -1 : (i.getInt(0));
...
/* 090 */     {
/* 091 */
/* 092 */       boolean isNull1 = i.isNullAt(0);
/* 093 */       int value1 = isNull1 ? -1 : (i.getInt(0));
