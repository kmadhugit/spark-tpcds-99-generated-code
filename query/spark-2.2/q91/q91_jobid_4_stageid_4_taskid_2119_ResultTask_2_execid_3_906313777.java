...
/* 088 */         double scan_value1 = scan_isNull1 ? -1.0 : (scan_colInstance1.getDouble(scan_rowIdx));
/* 089 */
...
/* 095 */         filter_value2 = (java.lang.Double.isNaN(scan_value1) && java.lang.Double.isNaN(-7.0D)) || scan_value1 == -7.0D;
...
/* 106 */         append(project_result);
/* 107 */         if (shouldStop()) { scan_batchIdx = scan_rowIdx + 1; return; }
/* 108 */       }
/* 109 */       scan_batchIdx = scan_numRows;
/* 110 */       scan_batch = null;
/* 111 */       scan_nextBatch();
/* 112 */     }
/* 113 */     scan_scanTime.add(scan_scanTime1 / (1000 * 1000));
/* 114 */     scan_scanTime1 = 0;
/* 115 */   }
/* 116 */ }
