...
/* 097 */
/* 098 */         filter_numOutputRows.add(1);
/* 099 */
/* 100 */         boolean scan_isNull1 = scan_colInstance1.isNullAt(scan_rowIdx);
/* 101 */         UTF8String scan_value1 = scan_isNull1 ? null : (scan_colInstance1.getUTF8String(scan_rowIdx));
/* 102 */         boolean scan_isNull2 = scan_colInstance2.isNullAt(scan_rowIdx);
/* 103 */         UTF8String scan_value2 = scan_isNull2 ? null : (scan_colInstance2.getUTF8String(scan_rowIdx));
/* 104 */         boolean scan_isNull3 = scan_colInstance3.isNullAt(scan_rowIdx);
/* 105 */         UTF8String scan_value3 = scan_isNull3 ? null : (scan_colInstance3.getUTF8String(scan_rowIdx));
/* 106 */         project_holder.reset();
/* 107 */
/* 108 */         project_rowWriter.zeroOutNullBytes();
/* 109 */
/* 110 */         project_rowWriter.write(0, scan_value);
/* 111 */
/* 112 */         if (scan_isNull1) {
/* 113 */           project_rowWriter.setNullAt(1);
/* 114 */         } else {
/* 115 */           project_rowWriter.write(1, scan_value1);
/* 116 */         }
/* 117 */
/* 118 */         if (scan_isNull2) {
/* 119 */           project_rowWriter.setNullAt(2);
/* 120 */         } else {
/* 121 */           project_rowWriter.write(2, scan_value2);
/* 122 */         }
/* 123 */
/* 124 */         if (scan_isNull3) {
/* 125 */           project_rowWriter.setNullAt(3);
/* 126 */         } else {
/* 127 */           project_rowWriter.write(3, scan_value3);
/* 128 */         }
/* 129 */         project_result.setTotalSize(project_holder.totalSize());
