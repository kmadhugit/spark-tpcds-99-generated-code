...
/* 104 */     this.bhj_holder1 = new org.apache.spark.sql.catalyst.expressions.codegen.BufferHolder(bhj_result1, 96);
/* 105 */     this.bhj_rowWriter1 = new org.apache.spark.sql.catalyst.expressions.codegen.UnsafeRowWriter(bhj_holder1, 7);
/* 106 */     project_result2 = new UnsafeRow(5);
/* 107 */     this.project_holder2 = new org.apache.spark.sql.catalyst.expressions.codegen.BufferHolder(project_result2, 96);
/* 108 */     this.project_rowWriter2 = new org.apache.spark.sql.catalyst.expressions.codegen.UnsafeRowWriter(project_holder2, 5);
/* 109 */
/* 110 */   }
/* 111 */
...
/* 120 */     bhj_result = new UnsafeRow(8);
/* 121 */     this.bhj_holder = new org.apache.spark.sql.catalyst.expressions.codegen.BufferHolder(bhj_result, 96);
/* 122 */     this.bhj_rowWriter = new org.apache.spark.sql.catalyst.expressions.codegen.UnsafeRowWriter(bhj_holder, 8);
/* 123 */     project_result1 = new UnsafeRow(6);
/* 124 */     this.project_holder1 = new org.apache.spark.sql.catalyst.expressions.codegen.BufferHolder(project_result1, 96);
/* 125 */     this.project_rowWriter1 = new org.apache.spark.sql.catalyst.expressions.codegen.UnsafeRowWriter(project_holder1, 6);
...
/* 139 */         boolean scan_isNull1 = scan_colInstance1.isNullAt(scan_rowIdx);
/* 140 */         int scan_value1 = scan_isNull1 ? -1 : (scan_colInstance1.getInt(scan_rowIdx));
/* 141 */
/* 142 */         if (!(!(scan_isNull1))) continue;
/* 143 */
/* 144 */         boolean scan_isNull = scan_colInstance0.isNullAt(scan_rowIdx);
/* 145 */         int scan_value = scan_isNull ? -1 : (scan_colInstance0.getInt(scan_rowIdx));
/* 146 */
/* 147 */         if (!(!(scan_isNull))) continue;
/* 148 */
...
/* 168 */
/* 169 */         boolean bhj_isNull14 = scan_isNull3;
/* 170 */         long bhj_value14 = -1L;
/* 171 */         if (!scan_isNull3) {
/* 172 */           bhj_value14 = (long) scan_value3;
/* 173 */         }
/* 174 */         // find matches from HashedRelation
/* 175 */         UnsafeRow bhj_matched1 = bhj_isNull14 ? null: (UnsafeRow)bhj_relation1.getValue(bhj_value14);
/* 176 */         if (bhj_matched1 == null) continue;
/* 177 */
/* 178 */         bhj_numOutputRows1.add(1);
/* 179 */
/* 180 */         boolean bhj_isNull3 = bhj_matched.isNullAt(1);
/* 181 */         UTF8String bhj_value3 = bhj_isNull3 ? null : (bhj_matched.getUTF8String(1));
/* 182 */         boolean bhj_isNull4 = bhj_matched.isNullAt(2);
/* 183 */         UTF8String bhj_value4 = bhj_isNull4 ? null : (bhj_matched.getUTF8String(2));
/* 184 */         boolean bhj_isNull5 = bhj_matched.isNullAt(3);
/* 185 */         UTF8String bhj_value5 = bhj_isNull5 ? null : (bhj_matched.getUTF8String(3));
...
/* 191 */
/* 192 */         if (bhj_isNull3) {
/* 193 */           project_rowWriter2.setNullAt(0);
/* 194 */         } else {
/* 195 */           project_rowWriter2.write(0, bhj_value3);
/* 196 */         }
/* 197 */
/* 198 */         if (bhj_isNull4) {
/* 199 */           project_rowWriter2.setNullAt(1);
/* 200 */         } else {
/* 201 */           project_rowWriter2.write(1, bhj_value4);
/* 202 */         }
/* 203 */
/* 204 */         if (bhj_isNull5) {
/* 205 */           project_rowWriter2.setNullAt(2);
/* 206 */         } else {
/* 207 */           project_rowWriter2.write(2, bhj_value5);
/* 208 */         }
/* 209 */
/* 210 */         project_rowWriter2.write(3, scan_value);
/* 211 */
/* 212 */         if (scan_isNull2) {
/* 213 */           project_rowWriter2.setNullAt(4);
/* 214 */         } else {
/* 215 */           project_rowWriter2.write(4, scan_value2);
/* 216 */         }
/* 217 */         project_result2.setTotalSize(project_holder2.totalSize());
/* 218 */         append(project_result2);
