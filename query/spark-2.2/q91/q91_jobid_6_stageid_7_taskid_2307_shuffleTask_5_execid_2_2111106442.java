...
/* 099 */         int scan_value3 = scan_isNull3 ? -1 : (scan_colInstance3.getInt(scan_rowIdx));
/* 100 */
/* 101 */         if (!(!(scan_isNull3))) continue;
/* 102 */
/* 103 */         boolean scan_isNull1 = scan_colInstance1.isNullAt(scan_rowIdx);
/* 104 */         int scan_value1 = scan_isNull1 ? -1 : (scan_colInstance1.getInt(scan_rowIdx));
/* 105 */
/* 106 */         if (!(!(scan_isNull1))) continue;
/* 107 */
