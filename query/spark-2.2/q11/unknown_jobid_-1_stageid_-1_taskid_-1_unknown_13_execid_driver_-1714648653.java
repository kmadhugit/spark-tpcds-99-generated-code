...
/* 335 */
/* 336 */         if (true) {
/* 337 */           if (!smj_isNull3 && !smj_isNull4 && !smj_isNull5 && !smj_isNull6 && !smj_isNull7 && !smj_isNull8 && !smj_isNull9 && !bhj_isNull3) {
/* 338 */             agg_fastAggBuffer = agg_fastHashMap.findOrInsert(
/* 339 */               smj_value5, smj_value6, smj_value7, smj_value8, smj_value9, smj_value10, smj_value11, bhj_value3);
/* 340 */           }
/* 341 */         }
/* 342 */
...
/* 369 */           } else {
/* 370 */             agg_rowWriter.write(3, smj_value8);
/* 371 */           }
/* 372 */
/* 373 */           if (smj_isNull7) {
/* 374 */             agg_rowWriter.setNullAt(4);
/* 375 */           } else {
/* 376 */             agg_rowWriter.write(4, smj_value9);
/* 377 */           }
/* 378 */
/* 379 */           if (smj_isNull8) {
/* 380 */             agg_rowWriter.setNullAt(5);
/* 381 */           } else {
/* 382 */             agg_rowWriter.write(5, smj_value10);
/* 383 */           }
/* 384 */
/* 385 */           if (smj_isNull9) {
/* 386 */             agg_rowWriter.setNullAt(6);
/* 387 */           } else {
/* 388 */             agg_rowWriter.write(6, smj_value11);
/* 389 */           }
/* 390 */
/* 391 */           if (bhj_isNull3) {
/* 392 */             agg_rowWriter.setNullAt(7);
/* 393 */           } else {
/* 394 */             agg_rowWriter.write(7, bhj_value3);
/* 395 */           }
...
/* 410 */
/* 411 */           if (!smj_isNull6) {
/* 412 */             agg_value18 = org.apache.spark.unsafe.hash.Murmur3_x86_32.hashUnsafeBytes(smj_value8.getBaseObject(), smj_value8.getBaseOffset(), smj_value8.numBytes(), agg_value18);
/* 413 */           }
/* 414 */
/* 415 */           if (!smj_isNull7) {
/* 416 */             agg_value18 = org.apache.spark.unsafe.hash.Murmur3_x86_32.hashUnsafeBytes(smj_value9.getBaseObject(), smj_value9.getBaseOffset(), smj_value9.numBytes(), agg_value18);
/* 417 */           }
/* 418 */
/* 419 */           if (!smj_isNull8) {
/* 420 */             agg_value18 = org.apache.spark.unsafe.hash.Murmur3_x86_32.hashUnsafeBytes(smj_value10.getBaseObject(), smj_value10.getBaseOffset(), smj_value10.numBytes(), agg_value18);
/* 421 */           }
/* 422 */
/* 423 */           if (!smj_isNull9) {
/* 424 */             agg_value18 = org.apache.spark.unsafe.hash.Murmur3_x86_32.hashUnsafeBytes(smj_value11.getBaseObject(), smj_value11.getBaseOffset(), smj_value11.numBytes(), agg_value18);
/* 425 */           }
/* 426 */
/* 427 */           if (!bhj_isNull3) {
/* 428 */             agg_value18 = org.apache.spark.unsafe.hash.Murmur3_x86_32.hashInt(bhj_value3, agg_value18);
/* 429 */           }
/* 430 */           if (true) {
