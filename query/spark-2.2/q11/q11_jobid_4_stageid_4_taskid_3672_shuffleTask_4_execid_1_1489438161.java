...
/* 101 */         double scan_value1 = scan_isNull1 ? -1.0 : (scan_colInstance1.getDouble(scan_rowIdx));
/* 102 */         boolean scan_isNull2 = scan_colInstance2.isNullAt(scan_rowIdx);
/* 103 */         double scan_value2 = scan_isNull2 ? -1.0 : (scan_colInstance2.getDouble(scan_rowIdx));
...
/* 118 */         } else {
/* 119 */           project_rowWriter.write(2, scan_value2);
/* 120 */         }
/* 121 */
/* 122 */         if (scan_isNull3) {
/* 123 */           project_rowWriter.setNullAt(3);
/* 124 */         } else {
/* 125 */           project_rowWriter.write(3, scan_value3);
/* 126 */         }
