...
/* 051 */     this.scan_holder = new org.apache.spark.sql.catalyst.expressions.codegen.BufferHolder(scan_result, 96);
...
/* 055 */     this.filter_holder = new org.apache.spark.sql.catalyst.expressions.codegen.BufferHolder(filter_result, 96);
...
/* 058 */     this.project_holder = new org.apache.spark.sql.catalyst.expressions.codegen.BufferHolder(project_result, 96);
/* 059 */
/* 060 */   }
/* 061 */
...
/* 094 */
/* 095 */         filter_numOutputRows.add(1);
/* 096 */
/* 097 */         boolean scan_isNull = scan_colInstance0.isNullAt(scan_rowIdx);
/* 098 */         UTF8String scan_value = scan_isNull ? null : (scan_colInstance0.getUTF8String(scan_rowIdx));
/* 099 */         boolean scan_isNull2 = scan_colInstance2.isNullAt(scan_rowIdx);
/* 100 */         UTF8String scan_value2 = scan_isNull2 ? null : (scan_colInstance2.getUTF8String(scan_rowIdx));
/* 101 */         project_holder.reset();
/* 102 */
/* 103 */         project_rowWriter.zeroOutNullBytes();
/* 104 */
/* 105 */         if (scan_isNull) {
/* 106 */           project_rowWriter.setNullAt(0);
/* 107 */         } else {
/* 108 */           project_rowWriter.write(0, scan_value);
/* 109 */         }
/* 110 */
/* 111 */         project_rowWriter.write(1, scan_value1);
/* 112 */
/* 113 */         if (scan_isNull2) {
/* 114 */           project_rowWriter.setNullAt(2);
/* 115 */         } else {
/* 116 */           project_rowWriter.write(2, scan_value2);
/* 117 */         }
/* 118 */         project_result.setTotalSize(project_holder.totalSize());
/* 119 */         append(project_result);
/* 120 */         if (shouldStop()) { scan_batchIdx = scan_rowIdx + 1; return; }
/* 121 */       }
/* 122 */       scan_batchIdx = scan_numRows;
/* 123 */       scan_batch = null;
/* 124 */       scan_nextBatch();
/* 125 */     }
