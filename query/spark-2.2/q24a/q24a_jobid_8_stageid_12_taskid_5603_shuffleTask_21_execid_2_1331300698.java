...
/* 042 */     double value8 = isNull8 ? -1.0 : (i.getDouble(6));
/* 043 */     if (!isNull8) {
/* 044 */       value1 = org.apache.spark.unsafe.hash.Murmur3_x86_32.hashLong(Double.doubleToLongBits(value8), value1);
/* 045 */     }
/* 046 */
/* 047 */     boolean isNull9 = i.isNullAt(7);
/* 048 */     int value9 = isNull9 ? -1 : (i.getInt(7));
/* 049 */     if (!isNull9) {
/* 050 */       value1 = org.apache.spark.unsafe.hash.Murmur3_x86_32.hashInt(value9, value1);
/* 051 */     }
/* 052 */
/* 053 */   }
/* 054 */
