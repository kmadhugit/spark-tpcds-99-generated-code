...
/* 062 */     this.project_holder = new org.apache.spark.sql.catalyst.expressions.codegen.BufferHolder(project_result, 96);
/* 063 */
/* 064 */   }
/* 065 */
...
/* 096 */         boolean scan_isNull2 = scan_colInstance2.isNullAt(scan_rowIdx);
/* 097 */         int scan_value2 = scan_isNull2 ? -1 : (scan_colInstance2.getInt(scan_rowIdx));
/* 098 */
/* 099 */         if (!(!(scan_isNull2))) continue;
/* 100 */
/* 101 */         boolean filter_isNull2 = false;
/* 102 */
/* 103 */         boolean filter_value2 = false;
/* 104 */         filter_value2 = scan_value2 == 8;
...
/* 114 */
/* 115 */         if (!(!(scan_isNull4))) continue;
/* 116 */
/* 117 */         filter_numOutputRows.add(1);
/* 118 */
/* 119 */         boolean scan_isNull1 = scan_colInstance1.isNullAt(scan_rowIdx);
/* 120 */         UTF8String scan_value1 = scan_isNull1 ? null : (scan_colInstance1.getUTF8String(scan_rowIdx));
/* 121 */         boolean scan_isNull3 = scan_colInstance3.isNullAt(scan_rowIdx);
/* 122 */         UTF8String scan_value3 = scan_isNull3 ? null : (scan_colInstance3.getUTF8String(scan_rowIdx));
/* 123 */         project_holder.reset();
/* 124 */
/* 125 */         project_rowWriter.zeroOutNullBytes();
/* 126 */
/* 127 */         project_rowWriter.write(0, scan_value);
/* 128 */
/* 129 */         if (scan_isNull1) {
/* 130 */           project_rowWriter.setNullAt(1);
/* 131 */         } else {
/* 132 */           project_rowWriter.write(1, scan_value1);
/* 133 */         }
/* 134 */
/* 135 */         if (scan_isNull3) {
/* 136 */           project_rowWriter.setNullAt(2);
/* 137 */         } else {
/* 138 */           project_rowWriter.write(2, scan_value3);
/* 139 */         }
/* 140 */
/* 141 */         project_rowWriter.write(3, scan_value4);
/* 142 */         project_result.setTotalSize(project_holder.totalSize());
/* 143 */         append(project_result);
/* 144 */         if (shouldStop()) { scan_batchIdx = scan_rowIdx + 1; return; }
/* 145 */       }
/* 146 */       scan_batchIdx = scan_numRows;
/* 147 */       scan_batch = null;
/* 148 */       scan_nextBatch();
/* 149 */     }
/* 150 */     scan_scanTime.add(scan_scanTime1 / (1000 * 1000));
/* 151 */     scan_scanTime1 = 0;
/* 152 */   }
/* 153 */ }
