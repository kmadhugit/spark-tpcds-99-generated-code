...
/* 107 */         filter_value2 = scan_value3.equals(((UTF8String) references[3]));
...
/* 118 */         double scan_value1 = scan_isNull1 ? -1.0 : (scan_colInstance1.getDouble(scan_rowIdx));
...
/* 155 */         }
/* 156 */         project_result.setTotalSize(project_holder.totalSize());
/* 157 */         append(project_result);
/* 158 */         if (shouldStop()) { scan_batchIdx = scan_rowIdx + 1; return; }
/* 159 */       }
/* 160 */       scan_batchIdx = scan_numRows;
/* 161 */       scan_batch = null;
/* 162 */       scan_nextBatch();
/* 163 */     }
