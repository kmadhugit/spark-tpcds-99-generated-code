...
/* 050 */       obj2, offset2 + 16,
/* 051 */       buf, 112 + numBytesVariableRow1,
...
/* 065 */
/* 066 */
/* 067 */     Platform.putLong(buf, 56, Platform.getLong(buf, 56) + (8L << 32));
/* 068 */
/* 069 */
/* 070 */     Platform.putLong(buf, 64, Platform.getLong(buf, 64) + (8L << 32));
/* 071 */
/* 072 */
/* 073 */
/* 074 */
/* 075 */     Platform.putLong(buf, 88, Platform.getLong(buf, 88) + (8L << 32));
/* 076 */
/* 077 */
/* 078 */     Platform.putLong(buf, 96, Platform.getLong(buf, 96) + (8L << 32));
/* 079 */
/* 080 */
/* 081 */
