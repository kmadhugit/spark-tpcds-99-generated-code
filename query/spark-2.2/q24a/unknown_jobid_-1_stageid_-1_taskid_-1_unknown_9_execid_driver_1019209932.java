...
/* 126 */
/* 127 */         project_rowWriter.write(1, scan_value1);
/* 128 */
/* 129 */         project_rowWriter.write(2, scan_value2);
/* 130 */
/* 131 */         project_rowWriter.write(3, scan_value3);
/* 132 */
/* 133 */         if (scan_isNull4) {
/* 134 */           project_rowWriter.setNullAt(4);
/* 135 */         } else {
/* 136 */           project_rowWriter.write(4, scan_value4);
/* 137 */         }
/* 138 */         append(project_result);
/* 139 */         if (shouldStop()) { scan_batchIdx = scan_rowIdx + 1; return; }
/* 140 */       }
/* 141 */       scan_batchIdx = scan_numRows;
/* 142 */       scan_batch = null;
/* 143 */       scan_nextBatch();
/* 144 */     }
/* 145 */     scan_scanTime.add(scan_scanTime1 / (1000 * 1000));
/* 146 */     scan_scanTime1 = 0;
/* 147 */   }
/* 148 */ }
