...
/* 069 */
/* 070 */       boolean isNull1 = i.isNullAt(7);
/* 071 */       double value1 = isNull1 ? -1.0 : (i.getDouble(7));
/* 072 */       if (!isNull1) {
/* 073 */
/* 074 */         boolean isNull2 = i.isNullAt(6);
/* 075 */         double value2 = isNull2 ? -1.0 : (i.getDouble(6));
/* 076 */         if (!isNull2) {
/* 077 */
...
/* 094 */
/* 095 */       boolean isNull1 = i.isNullAt(7);
/* 096 */       double value1 = isNull1 ? -1.0 : (i.getDouble(7));
/* 097 */       if (!isNull1) {
/* 098 */
/* 099 */         boolean isNull2 = i.isNullAt(6);
/* 100 */         double value2 = isNull2 ? -1.0 : (i.getDouble(6));
/* 101 */         if (!isNull2) {
/* 102 */
