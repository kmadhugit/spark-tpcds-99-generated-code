...
/* 007 */   private UnsafeRow out = new UnsafeRow(21);
/* 008 */
/* 009 */   public UnsafeRow join(UnsafeRow row1, UnsafeRow row2) {
/* 010 */     // row1: 6 fields, 1 words in bitset
/* 011 */     // row2: 15, 1 words in bitset
/* 012 */     // output: 21 fields, 1 words in bitset
...
/* 022 */
/* 023 */     Platform.putLong(buf, 16, Platform.getLong(obj1, offset1 + 0) | (Platform.getLong(obj2, offset2) << 6));
/* 024 */
...
/* 040 */     long numBytesVariableRow1 = row1.getSizeInBytes() - 56;
...
/* 048 */     long numBytesVariableRow2 = row2.getSizeInBytes() - 128;
/* 049 */     Platform.copyMemory(
/* 050 */       obj2, offset2 + 128,
/* 051 */       buf, 192 + numBytesVariableRow1,
/* 052 */       numBytesVariableRow2);
/* 053 */
/* 054 */
/* 055 */     Platform.putLong(buf, 24, Platform.getLong(buf, 24) + (120L << 32));
/* 056 */
/* 057 */
/* 058 */     Platform.putLong(buf, 32, Platform.getLong(buf, 32) + (120L << 32));
/* 059 */
/* 060 */
/* 061 */     Platform.putLong(buf, 40, Platform.getLong(buf, 40) + (120L << 32));
/* 062 */
/* 063 */
/* 064 */
/* 065 */
