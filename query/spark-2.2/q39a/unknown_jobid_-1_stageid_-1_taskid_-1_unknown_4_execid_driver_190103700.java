...
/* 490 */
/* 491 */       filter_numOutputRows.add(1);
/* 492 */
/* 493 */       boolean project_isNull4 = true;
/* 494 */       double project_value4 = -1.0;
/* 495 */
/* 496 */       boolean project_isNull5 = true;
/* 497 */       boolean project_value5 = false;
/* 498 */
/* 499 */       if (!agg_isNull83) {
/* 500 */         project_isNull5 = false; // resultCode could change nullability.
/* 501 */         project_value5 = (java.lang.Double.isNaN(agg_value88) && java.lang.Double.isNaN(0.0D)) || agg_value88 == 0.0D;
/* 502 */
/* 503 */       }
/* 504 */       if (!project_isNull5 && project_value5) {
/* 505 */         final double project_value8 = -1.0;
/* 506 */         project_isNull4 = true;
/* 507 */         project_value4 = project_value8;
/* 508 */       }
/* 509 */
/* 510 */       else {
/* 511 */         boolean project_isNull9 = false;
/* 512 */         double project_value9 = -1.0;
/* 513 */         if (agg_isNull83 || agg_value88 == 0) {
/* 514 */           project_isNull9 = true;
/* 515 */         } else {
/* 516 */           if (agg_isNull67) {
/* 517 */             project_isNull9 = true;
/* 518 */           } else {
/* 519 */             project_value9 = (double)(agg_value72 / agg_value88);
/* 520 */           }
/* 521 */         }
/* 522 */         project_isNull4 = project_isNull9;
/* 523 */         project_value4 = project_value9;
/* 524 */       }
/* 525 */       project_rowWriter.zeroOutNullBytes();
/* 526 */
/* 527 */       if (agg_isNull59) {
/* 528 */         project_rowWriter.setNullAt(0);
/* 529 */       } else {
/* 530 */         project_rowWriter.write(0, agg_value64);
/* 531 */       }
/* 532 */
/* 533 */       if (agg_isNull60) {
/* 534 */         project_rowWriter.setNullAt(1);
/* 535 */       } else {
/* 536 */         project_rowWriter.write(1, agg_value65);
/* 537 */       }
/* 538 */
/* 539 */       if (agg_isNull61) {
/* 540 */         project_rowWriter.setNullAt(2);
/* 541 */       } else {
/* 542 */         project_rowWriter.write(2, agg_value66);
/* 543 */       }
/* 544 */
/* 545 */       if (agg_isNull83) {
/* 546 */         project_rowWriter.setNullAt(3);
/* 547 */       } else {
/* 548 */         project_rowWriter.write(3, agg_value88);
/* 549 */       }
/* 550 */
/* 551 */       if (project_isNull4) {
/* 552 */         project_rowWriter.setNullAt(4);
/* 553 */       } else {
/* 554 */         project_rowWriter.write(4, project_value4);
/* 555 */       }
/* 556 */       append(project_result);
/* 557 */
/* 558 */       if (shouldStop()) return;
/* 559 */     }
/* 560 */
/* 561 */     agg_mapIter.close();
/* 562 */     if (agg_sorter == null) {
/* 563 */       agg_hashMap.free();
/* 564 */     }
/* 565 */   }
/* 566 */ }
