...
/* 466 */     this.bhj_rowWriter1 = new org.apache.spark.sql.catalyst.expressions.codegen.UnsafeRowWriter(bhj_holder1, 11);
/* 467 */     project_result1 = new UnsafeRow(10);
/* 468 */     this.project_holder1 = new org.apache.spark.sql.catalyst.expressions.codegen.BufferHolder(project_result1, 64);
/* 469 */     this.project_rowWriter1 = new org.apache.spark.sql.catalyst.expressions.codegen.UnsafeRowWriter(project_holder1, 10);
...
/* 477 */     bhj_result = new UnsafeRow(12);
/* 478 */     this.bhj_holder = new org.apache.spark.sql.catalyst.expressions.codegen.BufferHolder(bhj_result, 64);
/* 479 */     this.bhj_rowWriter = new org.apache.spark.sql.catalyst.expressions.codegen.UnsafeRowWriter(bhj_holder, 12);
/* 480 */     project_result = new UnsafeRow(10);
/* 481 */     this.project_holder = new org.apache.spark.sql.catalyst.expressions.codegen.BufferHolder(project_result, 64);
/* 482 */     this.project_rowWriter = new org.apache.spark.sql.catalyst.expressions.codegen.UnsafeRowWriter(project_holder, 10);
...
/* 489 */     bhj_result1 = new UnsafeRow(11);
/* 490 */     this.bhj_holder1 = new org.apache.spark.sql.catalyst.expressions.codegen.BufferHolder(bhj_result1, 64);
/* 491 */
/* 492 */   }
/* 493 */
...
/* 542 */
/* 543 */       boolean bhj_isNull17 = agg_isNull70;
/* 544 */       long bhj_value17 = -1L;
/* 545 */       if (!agg_isNull70) {
/* 546 */         bhj_value17 = (long) agg_value77;
/* 547 */       }
/* 548 */       // find matches from HashRelation
/* 549 */       scala.collection.Iterator bhj_matches = bhj_isNull17 ? null : (scala.collection.Iterator)bhj_relation1.get(bhj_value17);
...
/* 555 */
/* 556 */         boolean bhj_isNull4 = bhj_matched.isNullAt(2);
/* 557 */         UTF8String bhj_value4 = bhj_isNull4 ? null : (bhj_matched.getUTF8String(2));
/* 558 */         boolean bhj_isNull3 = bhj_matched.isNullAt(1);
/* 559 */         UTF8String bhj_value3 = bhj_isNull3 ? null : (bhj_matched.getUTF8String(1));
/* 560 */         project_holder1.reset();
/* 561 */
/* 562 */         project_rowWriter1.zeroOutNullBytes();
/* 563 */
/* 564 */         if (bhj_isNull4) {
/* 565 */           project_rowWriter1.setNullAt(0);
/* 566 */         } else {
/* 567 */           project_rowWriter1.write(0, bhj_value4);
/* 568 */         }
/* 569 */
/* 570 */         if (agg_isNull70) {
/* 571 */           project_rowWriter1.setNullAt(1);
/* 572 */         } else {
/* 573 */           project_rowWriter1.write(1, agg_value77);
/* 574 */         }
/* 575 */
/* 576 */         if (bhj_isNull3) {
/* 577 */           project_rowWriter1.setNullAt(2);
/* 578 */         } else {
/* 579 */           project_rowWriter1.write(2, bhj_value3);
/* 580 */         }
/* 581 */
/* 582 */         if (agg_isNull72) {
/* 583 */           project_rowWriter1.setNullAt(3);
/* 584 */         } else {
/* 585 */           project_rowWriter1.write(3, agg_value79);
/* 586 */         }
/* 587 */
/* 588 */         if (agg_isNull73) {
/* 589 */           project_rowWriter1.setNullAt(4);
/* 590 */         } else {
/* 591 */           project_rowWriter1.write(4, agg_value80);
/* 592 */         }
/* 593 */
/* 594 */         if (agg_isNull74) {
/* 595 */           project_rowWriter1.setNullAt(5);
/* 596 */         } else {
/* 597 */           project_rowWriter1.write(5, agg_value81);
/* 598 */         }
/* 599 */
/* 600 */         if (agg_isNull75) {
/* 601 */           project_rowWriter1.setNullAt(6);
/* 602 */         } else {
/* 603 */           project_rowWriter1.write(6, agg_value82);
/* 604 */         }
/* 605 */
/* 606 */         if (agg_isNull76) {
/* 607 */           project_rowWriter1.setNullAt(7);
/* 608 */         } else {
/* 609 */           project_rowWriter1.write(7, agg_value83);
/* 610 */         }
/* 611 */
/* 612 */         if (agg_isNull77) {
/* 613 */           project_rowWriter1.setNullAt(8);
/* 614 */         } else {
/* 615 */           project_rowWriter1.write(8, agg_value84);
/* 616 */         }
/* 617 */
/* 618 */         if (agg_isNull78) {
/* 619 */           project_rowWriter1.setNullAt(9);
/* 620 */         } else {
/* 621 */           project_rowWriter1.write(9, agg_value85);
/* 622 */         }
/* 623 */         project_result1.setTotalSize(project_holder1.totalSize());
/* 624 */         append(project_result1.copy());
/* 625 */
/* 626 */       }
/* 627 */
