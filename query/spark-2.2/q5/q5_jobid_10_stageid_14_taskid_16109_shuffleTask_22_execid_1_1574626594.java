...
/* 094 */         long scan_value = scan_isNull ? -1L : (scan_colInstance0.getLong(scan_rowIdx));
/* 095 */
...
/* 101 */         int scan_value3 = scan_isNull3 ? -1 : (scan_colInstance3.getInt(scan_rowIdx));
/* 102 */         boolean scan_isNull1 = scan_colInstance1.isNullAt(scan_rowIdx);
/* 103 */         double scan_value1 = scan_isNull1 ? -1.0 : (scan_colInstance1.getDouble(scan_rowIdx));
...
/* 109 */
/* 110 */         if (scan_isNull3) {
/* 111 */           project_rowWriter.setNullAt(1);
/* 112 */         } else {
/* 113 */           project_rowWriter.write(1, scan_value3);
/* 114 */         }
/* 115 */
/* 116 */         project_rowWriter.write(2, 0.0D);
/* 117 */
/* 118 */         project_rowWriter.write(3, 0.0D);
/* 119 */
/* 120 */         if (scan_isNull1) {
/* 121 */           project_rowWriter.setNullAt(4);
/* 122 */         } else {
/* 123 */           project_rowWriter.write(4, scan_value1);
/* 124 */         }
/* 125 */
/* 126 */         if (scan_isNull2) {
/* 127 */           project_rowWriter.setNullAt(5);
/* 128 */         } else {
/* 129 */           project_rowWriter.write(5, scan_value2);
/* 130 */         }
