...
/* 115 */
/* 116 */         if (scan_isNull1) {
/* 117 */           project_rowWriter.setNullAt(2);
/* 118 */         } else {
/* 119 */           project_rowWriter.write(2, scan_value1);
/* 120 */         }
/* 121 */
/* 122 */         if (scan_isNull2) {
/* 123 */           project_rowWriter.setNullAt(3);
/* 124 */         } else {
/* 125 */           project_rowWriter.write(3, scan_value2);
/* 126 */         }
/* 127 */
/* 128 */         project_rowWriter.write(4, 0.0D);
/* 129 */
/* 130 */         project_rowWriter.write(5, 0.0D);
