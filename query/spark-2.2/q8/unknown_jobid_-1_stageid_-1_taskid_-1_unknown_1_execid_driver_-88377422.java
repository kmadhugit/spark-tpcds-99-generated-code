...
/* 119 */         if (shouldStop()) { scan_batchIdx = scan_rowIdx + 1; return; }
/* 120 */       }
/* 121 */       scan_batchIdx = scan_numRows;
/* 122 */       scan_batch = null;
/* 123 */       scan_nextBatch();
/* 124 */     }
/* 125 */     scan_scanTime.add(scan_scanTime1 / (1000 * 1000));
/* 126 */     scan_scanTime1 = 0;
/* 127 */   }
/* 128 */ }
