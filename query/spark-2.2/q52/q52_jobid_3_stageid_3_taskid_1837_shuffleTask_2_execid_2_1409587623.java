...
/* 136 */     .add("((java.lang.String) references[4])", org.apache.spark.sql.types.DataTypes.StringType)
...
/* 305 */
/* 306 */         if (true) {
/* 307 */           if (!bhj_isNull3 && !bhj_isNull13 && !bhj_isNull12) {
/* 308 */             agg_fastAggBuffer = agg_fastHashMap.findOrInsert(
/* 309 */               bhj_value3, bhj_value13, bhj_value12);
/* 310 */           }
/* 311 */         }
/* 312 */
...
/* 327 */           } else {
/* 328 */             agg_rowWriter.write(1, bhj_value13);
/* 329 */           }
/* 330 */
/* 331 */           if (bhj_isNull12) {
/* 332 */             agg_rowWriter.setNullAt(2);
/* 333 */           } else {
/* 334 */             agg_rowWriter.write(2, bhj_value12);
/* 335 */           }
...
/* 342 */
/* 343 */           if (!bhj_isNull13) {
/* 344 */             agg_value8 = org.apache.spark.unsafe.hash.Murmur3_x86_32.hashUnsafeBytes(bhj_value13.getBaseObject(), bhj_value13.getBaseOffset(), bhj_value13.numBytes(), agg_value8);
/* 345 */           }
/* 346 */
/* 347 */           if (!bhj_isNull12) {
/* 348 */             agg_value8 = org.apache.spark.unsafe.hash.Murmur3_x86_32.hashInt(bhj_value12, agg_value8);
/* 349 */           }
/* 350 */           if (true) {
