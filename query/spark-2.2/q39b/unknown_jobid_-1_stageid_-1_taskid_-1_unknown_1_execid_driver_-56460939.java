...
/* 098 */         filter_value2 = scan_value1 == 2001;
/* 099 */         if (!filter_value2) continue;
/* 100 */         boolean scan_isNull2 = scan_colInstance2.isNullAt(scan_rowIdx);
/* 101 */         int scan_value2 = scan_isNull2 ? -1 : (scan_colInstance2.getInt(scan_rowIdx));
/* 102 */
/* 103 */         if (!(!(scan_isNull2))) continue;
/* 104 */
/* 105 */         boolean filter_isNull7 = false;
/* 106 */
/* 107 */         boolean filter_value7 = false;
/* 108 */         filter_value7 = scan_value2 == 2;
...
/* 119 */
/* 120 */         project_rowWriter.write(1, scan_value2);
/* 121 */         append(project_result);
/* 122 */         if (shouldStop()) { scan_batchIdx = scan_rowIdx + 1; return; }
/* 123 */       }
/* 124 */       scan_batchIdx = scan_numRows;
/* 125 */       scan_batch = null;
/* 126 */       scan_nextBatch();
/* 127 */     }
