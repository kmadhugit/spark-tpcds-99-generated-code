...
/* 100 */         boolean scan_isNull1 = scan_colInstance1.isNullAt(scan_rowIdx);
/* 101 */         int scan_value1 = scan_isNull1 ? -1 : (scan_colInstance1.getInt(scan_rowIdx));
/* 102 */
/* 103 */         boolean filter_value5 = false;
/* 104 */         boolean filter_isNull5 = scan_isNull1;
/* 105 */         if (!filter_isNull5) {
/* 106 */           if (!filter_value5) {
/* 107 */             if (false) {
/* 108 */               filter_isNull5 = true;
/* 109 */             } else if (scan_value1 == 1999) {
/* 110 */               filter_isNull5 = false;
/* 111 */               filter_value5 = true;
/* 112 */             }
/* 113 */           }
/* 114 */
/* 115 */           if (!filter_value5) {
/* 116 */             if (false) {
/* 117 */               filter_isNull5 = true;
/* 118 */             } else if (scan_value1 == 2000) {
/* 119 */               filter_isNull5 = false;
/* 120 */               filter_value5 = true;
/* 121 */             }
/* 122 */           }
/* 123 */
/* 124 */           if (!filter_value5) {
/* 125 */             if (false) {
/* 126 */               filter_isNull5 = true;
/* 127 */             } else if (scan_value1 == 2001) {
/* 128 */               filter_isNull5 = false;
/* 129 */               filter_value5 = true;
/* 130 */             }
/* 131 */           }
/* 132 */
/* 133 */         }
/* 134 */         if (filter_isNull5 || !filter_value5) continue;
/* 135 */
...
/* 140 */
/* 141 */         filter_numOutputRows.add(1);
/* 142 */
/* 143 */         project_rowWriter.write(0, scan_value);
/* 144 */         append(project_result);
/* 145 */         if (shouldStop()) { scan_batchIdx = scan_rowIdx + 1; return; }
/* 146 */       }
/* 147 */       scan_batchIdx = scan_numRows;
/* 148 */       scan_batch = null;
/* 149 */       scan_nextBatch();
/* 150 */     }
