...
/* 069 */         agg_isNull2 = false; // resultCode could change nullability.
/* 070 */         agg_value2 = agg_value3 + inputadapter_value;
/* 071 */
/* 072 */       }
/* 073 */       boolean agg_isNull1 = agg_isNull2;
/* 074 */       double agg_value1 = agg_value2;
/* 075 */       if (agg_isNull1) {
/* 076 */         if (!agg_bufIsNull) {
/* 077 */           agg_isNull1 = false;
/* 078 */           agg_value1 = agg_bufValue;
/* 079 */         }
/* 080 */       }
/* 081 */       // update aggregation buffer
/* 082 */       agg_bufIsNull = agg_isNull1;
/* 083 */       agg_bufValue = agg_value1;
