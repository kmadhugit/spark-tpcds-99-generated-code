...
/* 051 */       buf, 376 + numBytesVariableRow1,
/* 052 */       numBytesVariableRow2);
/* 053 */
/* 054 */
/* 055 */     Platform.putLong(buf, 24, Platform.getLong(buf, 24) + (288L << 32));
/* 056 */
/* 057 */
/* 058 */
/* 059 */     Platform.putLong(buf, 40, Platform.getLong(buf, 40) + (288L << 32));
/* 060 */
/* 061 */
/* 062 */     Platform.putLong(buf, 48, Platform.getLong(buf, 48) + (288L << 32));
/* 063 */
/* 064 */
/* 065 */     Platform.putLong(buf, 56, Platform.getLong(buf, 56) + (288L << 32));
/* 066 */
/* 067 */
/* 068 */     Platform.putLong(buf, 64, Platform.getLong(buf, 64) + (288L << 32));
/* 069 */
/* 070 */
/* 071 */     Platform.putLong(buf, 72, Platform.getLong(buf, 72) + (288L << 32));
/* 072 */
/* 073 */
/* 074 */
/* 075 */
