...
/* 026 */       double value2 = isNull2 ? -1.0 : (i.getDouble(1));
...
/* 036 */       double value2 = isNull2 ? -1.0 : (i.getDouble(1));
...
/* 068 */       int value = isNull ? -1 : (i.getInt(0));
/* 069 */       isNullA = isNull;
...
/* 078 */       int value = isNull ? -1 : (i.getInt(0));
/* 079 */       isNullB = isNull;
...
/* 098 */     {
/* 099 */
/* 100 */       boolean isNull1 = i.isNullAt(2);
/* 101 */       double value1 = isNull1 ? -1.0 : (i.getDouble(2));
...
/* 108 */     {
/* 109 */
/* 110 */       boolean isNull1 = i.isNullAt(2);
/* 111 */       double value1 = isNull1 ? -1.0 : (i.getDouble(2));
