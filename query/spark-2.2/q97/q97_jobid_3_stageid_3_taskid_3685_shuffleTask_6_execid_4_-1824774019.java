...
/* 140 */           } else {
/* 141 */             agg_rowWriter.write(0, scan_value1);
/* 142 */           }
/* 143 */
/* 144 */           if (scan_isNull) {
/* 145 */             agg_rowWriter.setNullAt(1);
/* 146 */           } else {
/* 147 */             agg_rowWriter.write(1, scan_value);
/* 148 */           }
/* 149 */           agg_value4 = 42;
/* 150 */
/* 151 */           if (!scan_isNull1) {
/* 152 */             agg_value4 = org.apache.spark.unsafe.hash.Murmur3_x86_32.hashInt(scan_value1, agg_value4);
/* 153 */           }
/* 154 */
/* 155 */           if (!scan_isNull) {
/* 156 */             agg_value4 = org.apache.spark.unsafe.hash.Murmur3_x86_32.hashInt(scan_value, agg_value4);
/* 157 */           }
/* 158 */           if (true) {
