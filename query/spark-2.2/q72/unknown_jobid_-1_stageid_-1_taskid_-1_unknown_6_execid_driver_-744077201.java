...
/* 094 */         int scan_value3 = scan_isNull3 ? -1 : (scan_colInstance3.getInt(scan_rowIdx));
/* 095 */
/* 096 */         if (!(!(scan_isNull3))) continue;
/* 097 */
/* 098 */         boolean filter_isNull2 = false;
/* 099 */
/* 100 */         boolean filter_value2 = false;
/* 101 */         filter_value2 = scan_value3 == 1999;
...
/* 117 */         UTF8String scan_value1 = scan_isNull1 ? null : (scan_colInstance1.getUTF8String(scan_rowIdx));
...
/* 123 */
/* 124 */         if (scan_isNull1) {
/* 125 */           project_rowWriter.setNullAt(1);
/* 126 */         } else {
/* 127 */           project_rowWriter.write(1, scan_value1);
/* 128 */         }
/* 129 */
/* 130 */         project_rowWriter.write(2, scan_value2);
/* 131 */         project_result.setTotalSize(project_holder.totalSize());
