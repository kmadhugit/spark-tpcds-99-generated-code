...
/* 098 */         filter_value2 = scan_value2 == 3;
...
/* 108 */         filter_value7 = scan_value1 == 2000;
...
/* 121 */
/* 122 */         project_rowWriter.write(2, scan_value2);
/* 123 */         append(project_result);
/* 124 */         if (shouldStop()) { scan_batchIdx = scan_rowIdx + 1; return; }
/* 125 */       }
/* 126 */       scan_batchIdx = scan_numRows;
/* 127 */       scan_batch = null;
/* 128 */       scan_nextBatch();
/* 129 */     }
