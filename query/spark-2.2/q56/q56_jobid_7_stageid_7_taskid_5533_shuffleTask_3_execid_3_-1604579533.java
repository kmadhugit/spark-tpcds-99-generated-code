...
/* 268 */         boolean scan_isNull1 = scan_colInstance1.isNullAt(scan_rowIdx);
/* 269 */         int scan_value1 = scan_isNull1 ? -1 : (scan_colInstance1.getInt(scan_rowIdx));
/* 270 */
/* 271 */         if (!(!(scan_isNull1))) continue;
/* 272 */
/* 273 */         boolean scan_isNull = scan_colInstance0.isNullAt(scan_rowIdx);
/* 274 */         int scan_value = scan_isNull ? -1 : (scan_colInstance0.getInt(scan_rowIdx));
/* 275 */
/* 276 */         if (!(!(scan_isNull))) continue;
/* 277 */
...
/* 300 */         if (!false) {
/* 301 */           bhj_value8 = (long) scan_value1;
/* 302 */         }
...
/* 313 */         if (!false) {
/* 314 */           bhj_value15 = (long) scan_value;
/* 315 */         }
