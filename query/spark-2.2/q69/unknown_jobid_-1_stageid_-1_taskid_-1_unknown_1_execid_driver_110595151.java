...
/* 068 */       UTF8String value2 = isNull2 ? null : (i.getUTF8String(2));
...
/* 078 */       UTF8String value2 = isNull2 ? null : (i.getUTF8String(2));
...
/* 098 */     {
/* 099 */
/* 100 */       boolean isNull3 = i.isNullAt(4);
/* 101 */       int value3 = isNull3 ? -1 : (i.getInt(4));
...
/* 108 */     {
/* 109 */
/* 110 */       boolean isNull3 = i.isNullAt(4);
/* 111 */       int value3 = isNull3 ? -1 : (i.getInt(4));
...
/* 140 */     {
/* 141 */
/* 142 */       boolean isNull = i.isNullAt(0);
/* 143 */       UTF8String value = isNull ? null : (i.getUTF8String(0));
/* 144 */       isNullA = isNull;
...
/* 150 */     {
/* 151 */
/* 152 */       boolean isNull = i.isNullAt(0);
/* 153 */       UTF8String value = isNull ? null : (i.getUTF8String(0));
/* 154 */       isNullB = isNull;
