...
/* 135 */     private org.apache.spark.sql.types.StructType keySchema = new org.apache.spark.sql.types.StructType().add("((java.lang.String) references[3])", org.apache.spark.sql.types.DataTypes.IntegerType)
/* 136 */     .add("((java.lang.String) references[4])", org.apache.spark.sql.types.DataTypes.IntegerType)
/* 137 */     .add("((java.lang.String) references[5])", org.apache.spark.sql.types.DataTypes.StringType);
...
/* 159 */     }
/* 160 */
/* 161 */     public org.apache.spark.sql.catalyst.expressions.UnsafeRow findOrInsert(int agg_key, int agg_key1, UTF8String agg_key2) {
...
/* 208 */     }
/* 209 */
/* 210 */     private boolean equals(int idx, int agg_key, int agg_key1, UTF8String agg_key2) {
/* 211 */       UnsafeRow row = batch.getKeyRow(buckets[idx]);
/* 212 */       return (row.getInt(0) == agg_key) && (row.getInt(1) == agg_key1) && (row.getUTF8String(2).equals(agg_key2));
/* 213 */     }
/* 214 */
/* 215 */     private long hash(int agg_key, int agg_key1, UTF8String agg_key2) {
/* 216 */       long agg_hash = 0;
/* 217 */
/* 218 */       int agg_result = agg_key;
/* 219 */       agg_hash = (agg_hash ^ (0x9e3779b9)) + agg_result + (agg_hash << 6) + (agg_hash >>> 2);
/* 220 */
/* 221 */       int agg_result1 = agg_key1;
/* 222 */       agg_hash = (agg_hash ^ (0x9e3779b9)) + agg_result1 + (agg_hash << 6) + (agg_hash >>> 2);
/* 223 */
/* 224 */       int agg_result2 = 0;
/* 225 */       byte[] agg_bytes = agg_key2.getBytes();
/* 226 */       for (int i = 0; i < agg_bytes.length; i++) {
/* 227 */         int agg_hash1 = agg_bytes[i];
/* 228 */         agg_result2 = (agg_result2 ^ (0x9e3779b9)) + agg_hash1 + (agg_result2 << 6) + (agg_result2 >>> 2);
/* 229 */       }
/* 230 */
...
/* 281 */
/* 282 */         boolean bhj_isNull9 = false;
/* 283 */         long bhj_value9 = -1L;
/* 284 */         if (!false) {
/* 285 */           bhj_value9 = (long) scan_value;
/* 286 */         }
/* 287 */         // find matches from HashedRelation
/* 288 */         UnsafeRow bhj_matched1 = bhj_isNull9 ? null: (UnsafeRow)bhj_relation1.getValue(bhj_value9);
/* 289 */         if (bhj_matched1 == null) continue;
/* 290 */
/* 291 */         bhj_numOutputRows1.add(1);
/* 292 */
/* 293 */         boolean bhj_isNull3 = bhj_matched.isNullAt(1);
/* 294 */         int bhj_value3 = bhj_isNull3 ? -1 : (bhj_matched.getInt(1));
/* 295 */         boolean scan_isNull1 = scan_colInstance1.isNullAt(scan_rowIdx);
/* 296 */         double scan_value1 = scan_isNull1 ? -1.0 : (scan_colInstance1.getDouble(scan_rowIdx));
/* 297 */         boolean bhj_isNull12 = bhj_matched1.isNullAt(1);
/* 298 */         int bhj_value12 = bhj_isNull12 ? -1 : (bhj_matched1.getInt(1));
/* 299 */         boolean bhj_isNull13 = bhj_matched1.isNullAt(2);
/* 300 */         UTF8String bhj_value13 = bhj_isNull13 ? null : (bhj_matched1.getUTF8String(2));
/* 301 */
...
/* 305 */
/* 306 */         if (true) {
/* 307 */           if (!bhj_isNull3 && !bhj_isNull12 && !bhj_isNull13) {
/* 308 */             agg_fastAggBuffer = agg_fastHashMap.findOrInsert(
/* 309 */               bhj_value3, bhj_value12, bhj_value13);
/* 310 */           }
/* 311 */         }
/* 312 */
...
/* 321 */           } else {
/* 322 */             agg_rowWriter.write(0, bhj_value3);
/* 323 */           }
/* 324 */
/* 325 */           if (bhj_isNull12) {
/* 326 */             agg_rowWriter.setNullAt(1);
/* 327 */           } else {
/* 328 */             agg_rowWriter.write(1, bhj_value12);
/* 329 */           }
/* 330 */
/* 331 */           if (bhj_isNull13) {
/* 332 */             agg_rowWriter.setNullAt(2);
/* 333 */           } else {
/* 334 */             agg_rowWriter.write(2, bhj_value13);
/* 335 */           }
/* 336 */           agg_result3.setTotalSize(agg_holder.totalSize());
/* 337 */           agg_value8 = 42;
/* 338 */
/* 339 */           if (!bhj_isNull3) {
/* 340 */             agg_value8 = org.apache.spark.unsafe.hash.Murmur3_x86_32.hashInt(bhj_value3, agg_value8);
/* 341 */           }
/* 342 */
/* 343 */           if (!bhj_isNull12) {
/* 344 */             agg_value8 = org.apache.spark.unsafe.hash.Murmur3_x86_32.hashInt(bhj_value12, agg_value8);
/* 345 */           }
/* 346 */
/* 347 */           if (!bhj_isNull13) {
/* 348 */             agg_value8 = org.apache.spark.unsafe.hash.Murmur3_x86_32.hashUnsafeBytes(bhj_value13.getBaseObject(), bhj_value13.getBaseOffset(), bhj_value13.numBytes(), agg_value8);
/* 349 */           }
/* 350 */           if (true) {
...
/* 483 */     project_result1 = new UnsafeRow(3);
/* 484 */     this.project_holder1 = new org.apache.spark.sql.catalyst.expressions.codegen.BufferHolder(project_result1, 0);
/* 485 */     this.project_rowWriter1 = new org.apache.spark.sql.catalyst.expressions.codegen.UnsafeRowWriter(project_holder1, 3);
...
/* 514 */     bhj_result = new UnsafeRow(5);
/* 515 */     this.bhj_holder = new org.apache.spark.sql.catalyst.expressions.codegen.BufferHolder(bhj_result, 0);
/* 516 */     this.bhj_rowWriter = new org.apache.spark.sql.catalyst.expressions.codegen.UnsafeRowWriter(bhj_holder, 5);
/* 517 */
/* 518 */   }
/* 519 */
