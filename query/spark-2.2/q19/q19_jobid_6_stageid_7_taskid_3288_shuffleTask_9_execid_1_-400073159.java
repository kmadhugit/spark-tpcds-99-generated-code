...
/* 065 */     {
/* 066 */
/* 067 */       boolean isNull2 = i.isNullAt(0);
/* 068 */       int value2 = isNull2 ? -1 : (i.getInt(0));
...
/* 078 */       int value2 = isNull2 ? -1 : (i.getInt(0));
...
/* 101 */       int value3 = isNull3 ? -1 : (i.getInt(2));
...
/* 111 */       int value3 = isNull3 ? -1 : (i.getInt(2));
...
/* 173 */     {
/* 174 */
/* 175 */       boolean isNull1 = i.isNullAt(1);
/* 176 */       UTF8String value1 = isNull1 ? null : (i.getUTF8String(1));
...
/* 183 */     {
/* 184 */
/* 185 */       boolean isNull1 = i.isNullAt(1);
/* 186 */       UTF8String value1 = isNull1 ? null : (i.getUTF8String(1));
