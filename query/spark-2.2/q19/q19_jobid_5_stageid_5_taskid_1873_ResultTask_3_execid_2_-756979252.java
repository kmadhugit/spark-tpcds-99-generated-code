...
/* 100 */         int scan_value5 = scan_isNull5 ? -1 : (scan_colInstance5.getInt(scan_rowIdx));
/* 101 */
/* 102 */         if (!(!(scan_isNull5))) continue;
/* 103 */
/* 104 */         boolean filter_isNull2 = false;
/* 105 */
/* 106 */         boolean filter_value2 = false;
/* 107 */         filter_value2 = scan_value5 == 8;
...
/* 116 */
/* 117 */         boolean scan_isNull1 = scan_colInstance1.isNullAt(scan_rowIdx);
/* 118 */         int scan_value1 = scan_isNull1 ? -1 : (scan_colInstance1.getInt(scan_rowIdx));
/* 119 */         boolean scan_isNull2 = scan_colInstance2.isNullAt(scan_rowIdx);
/* 120 */         UTF8String scan_value2 = scan_isNull2 ? null : (scan_colInstance2.getUTF8String(scan_rowIdx));
/* 121 */         boolean scan_isNull3 = scan_colInstance3.isNullAt(scan_rowIdx);
/* 122 */         int scan_value3 = scan_isNull3 ? -1 : (scan_colInstance3.getInt(scan_rowIdx));
/* 123 */         boolean scan_isNull4 = scan_colInstance4.isNullAt(scan_rowIdx);
/* 124 */         UTF8String scan_value4 = scan_isNull4 ? null : (scan_colInstance4.getUTF8String(scan_rowIdx));
/* 125 */         project_holder.reset();
/* 126 */
/* 127 */         project_rowWriter.zeroOutNullBytes();
/* 128 */
/* 129 */         project_rowWriter.write(0, scan_value);
/* 130 */
/* 131 */         if (scan_isNull1) {
/* 132 */           project_rowWriter.setNullAt(1);
/* 133 */         } else {
/* 134 */           project_rowWriter.write(1, scan_value1);
/* 135 */         }
/* 136 */
/* 137 */         if (scan_isNull2) {
