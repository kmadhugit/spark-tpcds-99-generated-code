...
/* 078 */       return 1;
/* 079 */     } else {
/* 080 */       int comp = org.apache.spark.util.Utils.nanSafeCompareDoubles(primitiveA3, primitiveB3);
/* 081 */       if (comp != 0) {
/* 082 */         return comp;
/* 083 */       }
/* 084 */     }
...
/* 130 */     double primitiveA1;
/* 131 */     {
/* 132 */
/* 133 */       boolean isNull1 = i.isNullAt(4);
/* 134 */       double value1 = isNull1 ? -1.0 : (i.getDouble(4));
/* 135 */       isNullA1 = isNull1;
/* 136 */       primitiveA1 = value1;
/* 137 */     }
/* 138 */     i = b;
/* 139 */     boolean isNullB1;
/* 140 */     double primitiveB1;
/* 141 */     {
/* 142 */
/* 143 */       boolean isNull1 = i.isNullAt(4);
/* 144 */       double value1 = isNull1 ? -1.0 : (i.getDouble(4));
...
/* 153 */       return 1;
/* 154 */     } else {
/* 155 */       int comp = org.apache.spark.util.Utils.nanSafeCompareDoubles(primitiveA1, primitiveB1);
/* 156 */       if (comp != 0) {
/* 157 */         return comp;
/* 158 */       }
/* 159 */     }
