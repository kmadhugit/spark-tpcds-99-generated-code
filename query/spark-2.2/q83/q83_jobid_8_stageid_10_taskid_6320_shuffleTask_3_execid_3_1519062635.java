...
/* 248 */         long scan_value = scan_isNull ? -1L : (scan_colInstance0.getLong(scan_rowIdx));
/* 249 */
...
/* 255 */
/* 256 */         // find matches from HashedRelation
/* 257 */         UnsafeRow bhj_matched = false ? null: (UnsafeRow)bhj_relation.getValue(scan_value);
/* 258 */         if (bhj_matched == null) continue;
/* 259 */
/* 260 */         bhj_numOutputRows.add(1);
/* 261 */
/* 262 */         boolean scan_isNull2 = scan_colInstance2.isNullAt(scan_rowIdx);
/* 263 */         int scan_value2 = scan_isNull2 ? -1 : (scan_colInstance2.getInt(scan_rowIdx));
/* 264 */
/* 265 */         // generate join key for stream side
/* 266 */
/* 267 */         boolean bhj_isNull8 = scan_isNull2;
/* 268 */         long bhj_value8 = -1L;
/* 269 */         if (!scan_isNull2) {
/* 270 */           bhj_value8 = (long) scan_value2;
/* 271 */         }
/* 272 */         // find matches from HashedRelation
/* 273 */         UnsafeRow bhj_matched1 = bhj_isNull8 ? null: (UnsafeRow)bhj_relation1.getValue(bhj_value8);
/* 274 */         if (bhj_matched1 == null) continue;
/* 275 */
/* 276 */         bhj_numOutputRows1.add(1);
/* 277 */
/* 278 */         boolean scan_isNull1 = scan_colInstance1.isNullAt(scan_rowIdx);
/* 279 */         long scan_value1 = scan_isNull1 ? -1L : (scan_colInstance1.getLong(scan_rowIdx));
/* 280 */         boolean bhj_isNull2 = bhj_matched.isNullAt(1);
/* 281 */         UTF8String bhj_value2 = bhj_isNull2 ? null : (bhj_matched.getUTF8String(1));
/* 282 */
/* 283 */         UnsafeRow agg_unsafeRowAggBuffer = null;
/* 284 */
/* 285 */         UnsafeRow agg_fastAggBuffer = null;
/* 286 */
/* 287 */         if (true) {
/* 288 */           if (!bhj_isNull2) {
/* 289 */             agg_fastAggBuffer = agg_fastHashMap.findOrInsert(
/* 290 */               bhj_value2);
/* 291 */           }
/* 292 */         }
/* 293 */
/* 294 */         if (agg_fastAggBuffer == null) {
/* 295 */           // generate grouping key
/* 296 */           agg_holder.reset();
/* 297 */
/* 298 */           agg_rowWriter.zeroOutNullBytes();
/* 299 */
/* 300 */           if (bhj_isNull2) {
/* 301 */             agg_rowWriter.setNullAt(0);
/* 302 */           } else {
/* 303 */             agg_rowWriter.write(0, bhj_value2);
/* 304 */           }
/* 305 */           agg_result1.setTotalSize(agg_holder.totalSize());
/* 306 */           agg_value4 = 42;
/* 307 */
/* 308 */           if (!bhj_isNull2) {
/* 309 */             agg_value4 = org.apache.spark.unsafe.hash.Murmur3_x86_32.hashUnsafeBytes(bhj_value2.getBaseObject(), bhj_value2.getBaseOffset(), bhj_value2.numBytes(), agg_value4);
/* 310 */           }
/* 311 */           if (true) {
/* 312 */             // try to get the buffer from hash map
/* 313 */             agg_unsafeRowAggBuffer =
/* 314 */             agg_hashMap.getAggregationBufferFromUnsafeRow(agg_result1, agg_value4);
/* 315 */           }
/* 316 */           if (agg_unsafeRowAggBuffer == null) {
/* 317 */             if (agg_sorter == null) {
/* 318 */               agg_sorter = agg_hashMap.destructAndCreateExternalSorter();
/* 319 */             } else {
/* 320 */               agg_sorter.merge(agg_hashMap.destructAndCreateExternalSorter());
/* 321 */             }
/* 322 */
/* 323 */             // the hash map had be spilled, it should have enough memory now,
/* 324 */             // try  to allocate buffer again.
...
/* 328 */               // failed to allocate the first page
/* 329 */               throw new OutOfMemoryError("No enough memory for aggregation");
/* 330 */             }
/* 331 */           }
/* 332 */         }
/* 333 */
/* 334 */         if (agg_fastAggBuffer != null) {
/* 335 */           // update fast row
/* 336 */
/* 337 */           // common sub-expressions
/* 338 */
/* 339 */           // evaluate aggregate function
/* 340 */           boolean agg_isNull14 = true;
/* 341 */           long agg_value15 = -1L;
/* 342 */
/* 343 */           boolean agg_isNull16 = agg_fastAggBuffer.isNullAt(0);
/* 344 */           long agg_value17 = agg_isNull16 ? -1L : (agg_fastAggBuffer.getLong(0));
/* 345 */           boolean agg_isNull15 = agg_isNull16;
/* 346 */           long agg_value16 = agg_value17;
/* 347 */           if (agg_isNull15) {
/* 348 */             boolean agg_isNull17 = false;
/* 349 */             long agg_value18 = -1L;
/* 350 */             if (!false) {
/* 351 */               agg_value18 = (long) 0;
/* 352 */             }
/* 353 */             if (!agg_isNull17) {
/* 354 */               agg_isNull15 = false;
/* 355 */               agg_value16 = agg_value18;
/* 356 */             }
/* 357 */           }
/* 358 */
/* 359 */           if (!scan_isNull1) {
/* 360 */             agg_isNull14 = false; // resultCode could change nullability.
/* 361 */             agg_value15 = agg_value16 + scan_value1;
/* 362 */
/* 363 */           }
/* 364 */           boolean agg_isNull13 = agg_isNull14;
/* 365 */           long agg_value14 = agg_value15;
/* 366 */           if (agg_isNull13) {
/* 367 */             boolean agg_isNull20 = agg_fastAggBuffer.isNullAt(0);
/* 368 */             long agg_value21 = agg_isNull20 ? -1L : (agg_fastAggBuffer.getLong(0));
/* 369 */             if (!agg_isNull20) {
/* 370 */               agg_isNull13 = false;
/* 371 */               agg_value14 = agg_value21;
/* 372 */             }
/* 373 */           }
/* 374 */           // update fast row
/* 375 */           if (!agg_isNull13) {
/* 376 */             agg_fastAggBuffer.setLong(0, agg_value14);
/* 377 */           } else {
/* 378 */             agg_fastAggBuffer.setNullAt(0);
/* 379 */           }
/* 380 */
/* 381 */         } else {
/* 382 */           // update unsafe row
/* 383 */
/* 384 */           // common sub-expressions
/* 385 */
/* 386 */           // evaluate aggregate function
/* 387 */           boolean agg_isNull6 = true;
/* 388 */           long agg_value7 = -1L;
/* 389 */
/* 390 */           boolean agg_isNull8 = agg_unsafeRowAggBuffer.isNullAt(0);
/* 391 */           long agg_value9 = agg_isNull8 ? -1L : (agg_unsafeRowAggBuffer.getLong(0));
/* 392 */           boolean agg_isNull7 = agg_isNull8;
/* 393 */           long agg_value8 = agg_value9;
/* 394 */           if (agg_isNull7) {
/* 395 */             boolean agg_isNull9 = false;
/* 396 */             long agg_value10 = -1L;
/* 397 */             if (!false) {
/* 398 */               agg_value10 = (long) 0;
/* 399 */             }
/* 400 */             if (!agg_isNull9) {
/* 401 */               agg_isNull7 = false;
/* 402 */               agg_value8 = agg_value10;
/* 403 */             }
/* 404 */           }
/* 405 */
/* 406 */           if (!scan_isNull1) {
/* 407 */             agg_isNull6 = false; // resultCode could change nullability.
/* 408 */             agg_value7 = agg_value8 + scan_value1;
/* 409 */
/* 410 */           }
/* 411 */           boolean agg_isNull5 = agg_isNull6;
/* 412 */           long agg_value6 = agg_value7;
/* 413 */           if (agg_isNull5) {
/* 414 */             boolean agg_isNull12 = agg_unsafeRowAggBuffer.isNullAt(0);
/* 415 */             long agg_value13 = agg_isNull12 ? -1L : (agg_unsafeRowAggBuffer.getLong(0));
/* 416 */             if (!agg_isNull12) {
/* 417 */               agg_isNull5 = false;
/* 418 */               agg_value6 = agg_value13;
/* 419 */             }
/* 420 */           }
/* 421 */           // update unsafe row buffer
/* 422 */           if (!agg_isNull5) {
/* 423 */             agg_unsafeRowAggBuffer.setLong(0, agg_value6);
/* 424 */           } else {
/* 425 */             agg_unsafeRowAggBuffer.setNullAt(0);
/* 426 */           }
/* 427 */
/* 428 */         }
/* 429 */         // shouldStop check is eliminated
/* 430 */       }
/* 431 */       scan_batchIdx = scan_numRows;
/* 432 */       scan_batch = null;
/* 433 */       scan_nextBatch();
/* 434 */     }
/* 435 */     scan_scanTime.add(scan_scanTime1 / (1000 * 1000));
/* 436 */     scan_scanTime1 = 0;
/* 437 */
/* 438 */     agg_fastHashMapIter = agg_fastHashMap.rowIterator();
/* 439 */
...
/* 444 */     project_result1 = new UnsafeRow(3);
/* 445 */     this.project_holder1 = new org.apache.spark.sql.catalyst.expressions.codegen.BufferHolder(project_result1, 32);
/* 446 */     this.project_rowWriter1 = new org.apache.spark.sql.catalyst.expressions.codegen.UnsafeRowWriter(project_holder1, 3);
/* 447 */     this.bhj_broadcast1 = (org.apache.spark.broadcast.TorrentBroadcast) references[10];
/* 448 */
/* 449 */     bhj_relation1 = ((org.apache.spark.sql.execution.joins.LongHashedRelation) bhj_broadcast1.value()).asReadOnlyCopy();
/* 450 */     incPeakExecutionMemory(bhj_relation1.estimatedSize());
/* 451 */
/* 452 */     this.bhj_numOutputRows1 = (org.apache.spark.sql.execution.metric.SQLMetric) references[11];
/* 453 */     bhj_result1 = new UnsafeRow(4);
/* 454 */     this.bhj_holder1 = new org.apache.spark.sql.catalyst.expressions.codegen.BufferHolder(bhj_result1, 32);
/* 455 */     this.bhj_rowWriter1 = new org.apache.spark.sql.catalyst.expressions.codegen.UnsafeRowWriter(bhj_holder1, 4);
/* 456 */     project_result2 = new UnsafeRow(2);
/* 457 */     this.project_holder2 = new org.apache.spark.sql.catalyst.expressions.codegen.BufferHolder(project_result2, 32);
/* 458 */     this.project_rowWriter2 = new org.apache.spark.sql.catalyst.expressions.codegen.UnsafeRowWriter(project_holder2, 2);
/* 459 */
/* 460 */   }
/* 461 */
/* 462 */   private void wholestagecodegen_init_1() {
/* 463 */     filter_result = new UnsafeRow(3);
/* 464 */     this.filter_holder = new org.apache.spark.sql.catalyst.expressions.codegen.BufferHolder(filter_result, 0);
/* 465 */     this.filter_rowWriter = new org.apache.spark.sql.catalyst.expressions.codegen.UnsafeRowWriter(filter_holder, 3);
/* 466 */     project_result = new UnsafeRow(3);
/* 467 */     this.project_holder = new org.apache.spark.sql.catalyst.expressions.codegen.BufferHolder(project_result, 0);
/* 468 */     this.project_rowWriter = new org.apache.spark.sql.catalyst.expressions.codegen.UnsafeRowWriter(project_holder, 3);
/* 469 */     this.bhj_broadcast = (org.apache.spark.broadcast.TorrentBroadcast) references[8];
/* 470 */
/* 471 */     bhj_relation = ((org.apache.spark.sql.execution.joins.LongHashedRelation) bhj_broadcast.value()).asReadOnlyCopy();
/* 472 */     incPeakExecutionMemory(bhj_relation.estimatedSize());
/* 473 */
/* 474 */     this.bhj_numOutputRows = (org.apache.spark.sql.execution.metric.SQLMetric) references[9];
/* 475 */     bhj_result = new UnsafeRow(5);
/* 476 */     this.bhj_holder = new org.apache.spark.sql.catalyst.expressions.codegen.BufferHolder(bhj_result, 32);
/* 477 */     this.bhj_rowWriter = new org.apache.spark.sql.catalyst.expressions.codegen.UnsafeRowWriter(bhj_holder, 5);
/* 478 */
/* 479 */   }
/* 480 */
/* 481 */   protected void processNext() throws java.io.IOException {
/* 482 */     if (!agg_initAgg) {
/* 483 */       agg_initAgg = true;
/* 484 */       long wholestagecodegen_beforeAgg = System.nanoTime();
/* 485 */       agg_doAggregateWithKeys();
/* 486 */       wholestagecodegen_aggTime.add((System.nanoTime() - wholestagecodegen_beforeAgg) / 1000000);
/* 487 */     }
/* 488 */
/* 489 */     // output the result
/* 490 */
/* 491 */     while (agg_fastHashMapIter.next()) {
/* 492 */       wholestagecodegen_numOutputRows.add(1);
/* 493 */       UnsafeRow agg_aggKey = (UnsafeRow) agg_fastHashMapIter.getKey();
/* 494 */       UnsafeRow agg_aggBuffer = (UnsafeRow) agg_fastHashMapIter.getValue();
/* 495 */
/* 496 */       UnsafeRow agg_resultRow = agg_unsafeRowJoiner.join(agg_aggKey, agg_aggBuffer);
/* 497 */
/* 498 */       append(agg_resultRow);
/* 499 */
/* 500 */       if (shouldStop()) return;
/* 501 */     }
/* 502 */     agg_fastHashMap.close();
/* 503 */
...
/* 508 */
/* 509 */       UnsafeRow agg_resultRow = agg_unsafeRowJoiner.join(agg_aggKey, agg_aggBuffer);
/* 510 */
/* 511 */       append(agg_resultRow);
/* 512 */
/* 513 */       if (shouldStop()) return;
/* 514 */     }
/* 515 */
/* 516 */     agg_mapIter.close();
/* 517 */     if (agg_sorter == null) {
/* 518 */       agg_hashMap.free();
/* 519 */     }
/* 520 */   }
/* 521 */ }
