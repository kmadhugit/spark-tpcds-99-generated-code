...
/* 105 */             } else if (scan_value.equals(((UTF8String) references[4]))) {
...
/* 114 */             } else if (scan_value.equals(((UTF8String) references[5]))) {
...
/* 124 */
/* 125 */         boolean scan_isNull1 = scan_colInstance1.isNullAt(scan_rowIdx);
/* 126 */         int scan_value1 = scan_isNull1 ? -1 : (scan_colInstance1.getInt(scan_rowIdx));
/* 127 */         project_rowWriter.zeroOutNullBytes();
/* 128 */
/* 129 */         if (scan_isNull1) {
/* 130 */           project_rowWriter.setNullAt(0);
/* 131 */         } else {
/* 132 */           project_rowWriter.write(0, scan_value1);
/* 133 */         }
