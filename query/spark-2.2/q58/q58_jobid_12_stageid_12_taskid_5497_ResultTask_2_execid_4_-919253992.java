...
/* 097 */           filter_value2 = scan_value1 == 5218;
/* 098 */
/* 099 */         }
/* 100 */         if (filter_isNull2 || !filter_value2) continue;
/* 101 */
/* 102 */         filter_numOutputRows.add(1);
/* 103 */
/* 104 */         boolean scan_isNull = scan_colInstance0.isNullAt(scan_rowIdx);
/* 105 */         UTF8String scan_value = scan_isNull ? null : (scan_colInstance0.getUTF8String(scan_rowIdx));
/* 106 */         project_holder.reset();
/* 107 */
/* 108 */         project_rowWriter.zeroOutNullBytes();
/* 109 */
/* 110 */         if (scan_isNull) {
/* 111 */           project_rowWriter.setNullAt(0);
/* 112 */         } else {
/* 113 */           project_rowWriter.write(0, scan_value);
/* 114 */         }
/* 115 */         project_result.setTotalSize(project_holder.totalSize());
