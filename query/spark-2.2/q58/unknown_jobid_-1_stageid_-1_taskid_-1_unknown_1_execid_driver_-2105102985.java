...
/* 095 */         filter_value2 = scan_value.equals(((UTF8String) references[3]));
...
/* 106 */         } else {
/* 107 */           project_rowWriter.write(0, scan_value1);
/* 108 */         }
/* 109 */         append(project_result);
/* 110 */         if (shouldStop()) { scan_batchIdx = scan_rowIdx + 1; return; }
/* 111 */       }
/* 112 */       scan_batchIdx = scan_numRows;
/* 113 */       scan_batch = null;
/* 114 */       scan_nextBatch();
/* 115 */     }
