...
/* 023 */     {
/* 024 */
/* 025 */       boolean isNull2 = i.isNullAt(3);
/* 026 */       UTF8String value2 = isNull2 ? null : (i.getUTF8String(3));
...
/* 033 */     {
/* 034 */
/* 035 */       boolean isNull2 = i.isNullAt(3);
/* 036 */       UTF8String value2 = isNull2 ? null : (i.getUTF8String(3));
...
/* 056 */     {
/* 057 */
/* 058 */       boolean isNull3 = i.isNullAt(0);
/* 059 */       UTF8String value3 = isNull3 ? null : (i.getUTF8String(0));
...
/* 066 */     {
/* 067 */
/* 068 */       boolean isNull3 = i.isNullAt(0);
/* 069 */       UTF8String value3 = isNull3 ? null : (i.getUTF8String(0));
...
/* 098 */     {
/* 099 */
/* 100 */       boolean isNull = i.isNullAt(1);
/* 101 */       UTF8String value = isNull ? null : (i.getUTF8String(1));
/* 102 */       isNullA = isNull;
...
/* 108 */     {
/* 109 */
/* 110 */       boolean isNull = i.isNullAt(1);
/* 111 */       UTF8String value = isNull ? null : (i.getUTF8String(1));
/* 112 */       isNullB = isNull;
...
/* 131 */     {
/* 132 */
/* 133 */       boolean isNull1 = i.isNullAt(2);
/* 134 */       UTF8String value1 = isNull1 ? null : (i.getUTF8String(2));
...
/* 141 */     {
/* 142 */
/* 143 */       boolean isNull1 = i.isNullAt(2);
/* 144 */       UTF8String value1 = isNull1 ? null : (i.getUTF8String(2));
