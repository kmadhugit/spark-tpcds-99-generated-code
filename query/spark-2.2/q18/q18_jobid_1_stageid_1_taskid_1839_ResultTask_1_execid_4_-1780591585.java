...
/* 091 */
/* 092 */         filter_numOutputRows.add(1);
/* 093 */
...
/* 096 */         project_holder.reset();
/* 097 */
/* 098 */         project_rowWriter.zeroOutNullBytes();
/* 099 */
/* 100 */         project_rowWriter.write(0, scan_value);
/* 101 */
/* 102 */         if (scan_isNull1) {
/* 103 */           project_rowWriter.setNullAt(1);
/* 104 */         } else {
/* 105 */           project_rowWriter.write(1, scan_value1);
/* 106 */         }
/* 107 */         project_result.setTotalSize(project_holder.totalSize());
/* 108 */         append(project_result);
/* 109 */         if (shouldStop()) { scan_batchIdx = scan_rowIdx + 1; return; }
/* 110 */       }
