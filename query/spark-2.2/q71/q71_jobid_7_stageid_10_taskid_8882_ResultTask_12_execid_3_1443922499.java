...
/* 033 */
/* 034 */
/* 035 */     boolean isNull1 = i.isNullAt(4);
/* 036 */     double value1 = isNull1 ? -1.0 : (i.getDouble(4));
/* 037 */     long value = 0L;
/* 038 */     boolean isNull = isNull1;
/* 039 */     if (!isNull1) {
/* 040 */       value = org.apache.spark.util.collection.unsafe.sort.PrefixComparators$DoublePrefixComparator.computePrefix((double)value1);
/* 041 */     }
/* 042 */     if (isNull) {
