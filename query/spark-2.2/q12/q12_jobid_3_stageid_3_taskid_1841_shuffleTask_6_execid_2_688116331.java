...
/* 030 */     double value6 = isNull6 ? -1.0 : (i.getDouble(4));
/* 031 */     if (!isNull6) {
/* 032 */       value1 = org.apache.spark.unsafe.hash.Murmur3_x86_32.hashLong(Double.doubleToLongBits(value6), value1);
/* 033 */     }
/* 034 */
/* 035 */   }
/* 036 */
...
/* 059 */     UTF8String value5 = isNull5 ? null : (i.getUTF8String(3));
/* 060 */     if (!isNull5) {
