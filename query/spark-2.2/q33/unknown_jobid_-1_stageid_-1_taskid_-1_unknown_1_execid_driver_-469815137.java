...
/* 096 */             } else if (scan_value.equals(((UTF8String) references[3]))) {
...
/* 101 */
/* 102 */         }
/* 103 */         if (filter_isNull || !filter_value) continue;
/* 104 */
...
/* 110 */
/* 111 */         if (scan_isNull1) {
/* 112 */           project_rowWriter.setNullAt(0);
/* 113 */         } else {
/* 114 */           project_rowWriter.write(0, scan_value1);
/* 115 */         }
