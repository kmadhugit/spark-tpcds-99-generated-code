...
/* 262 */         boolean scan_isNull = scan_colInstance0.isNullAt(scan_rowIdx);
/* 263 */         int scan_value = scan_isNull ? -1 : (scan_colInstance0.getInt(scan_rowIdx));
/* 264 */
/* 265 */         if (!(!(scan_isNull))) continue;
/* 266 */
...
/* 294 */         if (!false) {
/* 295 */           bhj_value8 = (long) scan_value;
/* 296 */         }
...
/* 307 */         if (!false) {
/* 308 */           bhj_value15 = (long) scan_value1;
/* 309 */         }
