...
/* 091 */         double scan_value2 = scan_isNull2 ? -1.0 : (scan_colInstance2.getDouble(scan_rowIdx));
/* 092 */
...
/* 098 */         filter_value2 = org.apache.spark.util.Utils.nanSafeCompareDoubles(scan_value2, 0.99D) >= 0;
/* 099 */         if (!filter_value2) continue;
/* 100 */         boolean filter_isNull5 = false;
/* 101 */
/* 102 */         boolean filter_value5 = false;
/* 103 */         filter_value5 = org.apache.spark.util.Utils.nanSafeCompareDoubles(scan_value2, 1.49D) <= 0;
...
/* 114 */         UTF8String scan_value1 = scan_isNull1 ? null : (scan_colInstance1.getUTF8String(scan_rowIdx));
