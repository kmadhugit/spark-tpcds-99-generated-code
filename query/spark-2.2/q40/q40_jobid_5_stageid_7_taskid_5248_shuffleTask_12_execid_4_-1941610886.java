...
/* 047 */     double value7 = isNull7 ? -1.0 : (i.getDouble(7));
/* 048 */     if (isNull7) {
...
/* 061 */     int value = isNull ? -1 : (i.getInt(0));
/* 062 */     if (isNull) {
...
/* 079 */     int value2 = isNull2 ? -1 : (i.getInt(2));
/* 080 */     if (isNull2) {
...
/* 088 */     double value3 = isNull3 ? -1.0 : (i.getDouble(3));
/* 089 */     if (isNull3) {
...
/* 097 */     int value4 = isNull4 ? -1 : (i.getInt(4));
/* 098 */     if (isNull4) {
