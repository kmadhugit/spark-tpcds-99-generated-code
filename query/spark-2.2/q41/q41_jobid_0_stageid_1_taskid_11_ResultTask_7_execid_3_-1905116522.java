...
/* 058 */
/* 059 */     agg_result1 = new UnsafeRow(3);
/* 060 */     this.agg_holder1 = new org.apache.spark.sql.catalyst.expressions.codegen.BufferHolder(agg_result1, 32);
/* 061 */     this.agg_rowWriter1 = new org.apache.spark.sql.catalyst.expressions.codegen.UnsafeRowWriter(agg_holder1, 3);
...
/* 147 */     this.filter_rowWriter = new org.apache.spark.sql.catalyst.expressions.codegen.UnsafeRowWriter(filter_holder, 3);
...
/* 176 */
/* 177 */       boolean filter_isNull1 = false;
/* 178 */       long filter_value1 = -1L;
/* 179 */       if (!false && false) {
/* 180 */         filter_isNull1 = false;
/* 181 */         filter_value1 = 0L;
/* 182 */       } else {
/* 183 */         filter_isNull1 = false;
/* 184 */         filter_value1 = agg_value10;
/* 185 */       }
/* 186 */
/* 187 */       boolean filter_value = false;
/* 188 */       filter_value = filter_value1 > 0L;
/* 189 */       if (!filter_value) continue;
/* 190 */
/* 191 */       filter_numOutputRows.add(1);
/* 192 */
/* 193 */       project_holder.reset();
/* 194 */
/* 195 */       project_rowWriter.zeroOutNullBytes();
/* 196 */
/* 197 */       if (agg_isNull8) {
/* 198 */         project_rowWriter.setNullAt(0);
/* 199 */       } else {
/* 200 */         project_rowWriter.write(0, agg_value9);
/* 201 */       }
/* 202 */       project_result.setTotalSize(project_holder.totalSize());
/* 203 */       append(project_result);
/* 204 */
/* 205 */       if (shouldStop()) return;
/* 206 */     }
/* 207 */
/* 208 */     agg_mapIter.close();
/* 209 */     if (agg_sorter == null) {
/* 210 */       agg_hashMap.free();
/* 211 */     }
/* 212 */   }
/* 213 */ }
