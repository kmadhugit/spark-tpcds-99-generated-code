...
/* 091 */
/* 092 */         boolean filter_value2 = false;
/* 093 */         boolean filter_isNull2 = scan_isNull1;
/* 094 */         if (!filter_isNull2) {
/* 095 */           if (!filter_value2) {
/* 096 */             if (false) {
/* 097 */               filter_isNull2 = true;
/* 098 */             } else if (scan_value1 == 2001) {
/* 099 */               filter_isNull2 = false;
/* 100 */               filter_value2 = true;
/* 101 */             }
/* 102 */           }
/* 103 */
/* 104 */           if (!filter_value2) {
/* 105 */             if (false) {
/* 106 */               filter_isNull2 = true;
/* 107 */             } else if (scan_value1 == 2002) {
/* 108 */               filter_isNull2 = false;
/* 109 */               filter_value2 = true;
/* 110 */             }
/* 111 */           }
/* 112 */
/* 113 */         }
/* 114 */         if (!filter_value2) continue;
/* 115 */         boolean filter_isNull6 = false;
/* 116 */
/* 117 */         boolean filter_value6 = false;
/* 118 */         filter_value6 = scan_value1 == 2002;
/* 119 */         if (!filter_value6) continue;
/* 120 */
/* 121 */         boolean scan_isNull = scan_colInstance0.isNullAt(scan_rowIdx);
/* 122 */         int scan_value = scan_isNull ? -1 : (scan_colInstance0.getInt(scan_rowIdx));
/* 123 */
/* 124 */         if (!(!(scan_isNull))) continue;
/* 125 */
...
/* 132 */         if (shouldStop()) { scan_batchIdx = scan_rowIdx + 1; return; }
/* 133 */       }
/* 134 */       scan_batchIdx = scan_numRows;
/* 135 */       scan_batch = null;
/* 136 */       scan_nextBatch();
/* 137 */     }
/* 138 */     scan_scanTime.add(scan_scanTime1 / (1000 * 1000));
/* 139 */     scan_scanTime1 = 0;
/* 140 */   }
/* 141 */ }
