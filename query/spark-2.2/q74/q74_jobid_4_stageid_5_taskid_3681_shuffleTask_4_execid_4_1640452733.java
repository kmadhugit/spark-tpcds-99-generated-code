...
/* 096 */
/* 097 */         boolean scan_isNull1 = scan_colInstance1.isNullAt(scan_rowIdx);
/* 098 */         double scan_value1 = scan_isNull1 ? -1.0 : (scan_colInstance1.getDouble(scan_rowIdx));
/* 099 */         boolean scan_isNull2 = scan_colInstance2.isNullAt(scan_rowIdx);
/* 100 */         int scan_value2 = scan_isNull2 ? -1 : (scan_colInstance2.getInt(scan_rowIdx));
/* 101 */         project_rowWriter.zeroOutNullBytes();
/* 102 */
/* 103 */         project_rowWriter.write(0, scan_value);
/* 104 */
/* 105 */         if (scan_isNull1) {
/* 106 */           project_rowWriter.setNullAt(1);
/* 107 */         } else {
/* 108 */           project_rowWriter.write(1, scan_value1);
/* 109 */         }
/* 110 */
/* 111 */         if (scan_isNull2) {
/* 112 */           project_rowWriter.setNullAt(2);
/* 113 */         } else {
/* 114 */           project_rowWriter.write(2, scan_value2);
/* 115 */         }
/* 116 */         append(project_result);
/* 117 */         if (shouldStop()) { scan_batchIdx = scan_rowIdx + 1; return; }
/* 118 */       }
/* 119 */       scan_batchIdx = scan_numRows;
/* 120 */       scan_batch = null;
/* 121 */       scan_nextBatch();
/* 122 */     }
/* 123 */     scan_scanTime.add(scan_scanTime1 / (1000 * 1000));
