...
/* 102 */         int scan_value1 = scan_isNull1 ? -1 : (scan_colInstance1.getInt(scan_rowIdx));
/* 103 */
/* 104 */         if (!(!(scan_isNull1))) continue;
/* 105 */
/* 106 */         boolean scan_isNull3 = scan_colInstance3.isNullAt(scan_rowIdx);
/* 107 */         int scan_value3 = scan_isNull3 ? -1 : (scan_colInstance3.getInt(scan_rowIdx));
/* 108 */
/* 109 */         if (!(!(scan_isNull3))) continue;
/* 110 */
...
/* 113 */
/* 114 */         if (!(!(scan_isNull2))) continue;
/* 115 */
/* 116 */         filter_numOutputRows.add(1);
/* 117 */
/* 118 */         boolean scan_isNull4 = scan_colInstance4.isNullAt(scan_rowIdx);
/* 119 */         int scan_value4 = scan_isNull4 ? -1 : (scan_colInstance4.getInt(scan_rowIdx));
...
/* 129 */
/* 130 */         if (scan_isNull4) {
/* 131 */           project_rowWriter.setNullAt(4);
/* 132 */         } else {
/* 133 */           project_rowWriter.write(4, scan_value4);
/* 134 */         }
/* 135 */         append(project_result);
/* 136 */         if (shouldStop()) { scan_batchIdx = scan_rowIdx + 1; return; }
/* 137 */       }
/* 138 */       scan_batchIdx = scan_numRows;
/* 139 */       scan_batch = null;
/* 140 */       scan_nextBatch();
/* 141 */     }
