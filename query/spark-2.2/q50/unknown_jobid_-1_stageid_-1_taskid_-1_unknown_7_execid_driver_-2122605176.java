...
/* 099 */         long scan_value2 = scan_isNull2 ? -1L : (scan_colInstance2.getLong(scan_rowIdx));
/* 100 */
/* 101 */         if (!(!(scan_isNull2))) continue;
/* 102 */
/* 103 */         boolean scan_isNull1 = scan_colInstance1.isNullAt(scan_rowIdx);
/* 104 */         long scan_value1 = scan_isNull1 ? -1L : (scan_colInstance1.getLong(scan_rowIdx));
/* 105 */
...
/* 119 */
/* 120 */         if (scan_isNull3) {
/* 121 */           project_rowWriter.setNullAt(3);
/* 122 */         } else {
/* 123 */           project_rowWriter.write(3, scan_value3);
/* 124 */         }
