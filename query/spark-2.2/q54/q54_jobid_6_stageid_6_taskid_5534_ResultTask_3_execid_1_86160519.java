...
/* 091 */         UTF8String scan_value2 = scan_isNull2 ? null : (scan_colInstance2.getUTF8String(scan_rowIdx));
/* 092 */
...
/* 098 */         filter_value2 = scan_value2.equals(((UTF8String) references[3]));
...
/* 102 */
/* 103 */         if (!(!(scan_isNull1))) continue;
/* 104 */
/* 105 */         boolean filter_isNull7 = false;
/* 106 */
/* 107 */         boolean filter_value7 = false;
/* 108 */         filter_value7 = scan_value1.equals(((UTF8String) references[4]));
/* 109 */         if (!filter_value7) continue;
/* 110 */
