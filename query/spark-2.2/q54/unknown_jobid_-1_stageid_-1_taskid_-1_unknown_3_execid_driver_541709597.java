...
/* 096 */
/* 097 */         filter_numOutputRows.add(1);
/* 098 */
/* 099 */         project_holder.reset();
/* 100 */
/* 101 */         project_rowWriter.write(0, scan_value);
/* 102 */
/* 103 */         project_rowWriter.write(1, scan_value1);
/* 104 */         project_result.setTotalSize(project_holder.totalSize());
/* 105 */         append(project_result);
/* 106 */         if (shouldStop()) { scan_batchIdx = scan_rowIdx + 1; return; }
/* 107 */       }
/* 108 */       scan_batchIdx = scan_numRows;
/* 109 */       scan_batch = null;
/* 110 */       scan_nextBatch();
/* 111 */     }
/* 112 */     scan_scanTime.add(scan_scanTime1 / (1000 * 1000));
/* 113 */     scan_scanTime1 = 0;
/* 114 */   }
/* 115 */ }
