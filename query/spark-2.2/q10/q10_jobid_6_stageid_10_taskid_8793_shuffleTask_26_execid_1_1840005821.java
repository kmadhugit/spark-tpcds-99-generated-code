...
/* 007 */   private UnsafeRow out = new UnsafeRow(14);
/* 008 */
/* 009 */   public UnsafeRow join(UnsafeRow row1, UnsafeRow row2) {
/* 010 */     // row1: 8 fields, 1 words in bitset
/* 011 */     // row2: 6, 1 words in bitset
/* 012 */     // output: 14 fields, 1 words in bitset
...
/* 048 */     long numBytesVariableRow2 = row2.getSizeInBytes() - 56;
/* 049 */     Platform.copyMemory(
/* 050 */       obj2, offset2 + 56,
/* 051 */       buf, 136 + numBytesVariableRow1,
/* 052 */       numBytesVariableRow2);
/* 053 */
/* 054 */
/* 055 */     Platform.putLong(buf, 24, Platform.getLong(buf, 24) + (48L << 32));
/* 056 */
/* 057 */
/* 058 */     Platform.putLong(buf, 32, Platform.getLong(buf, 32) + (48L << 32));
/* 059 */
/* 060 */
/* 061 */     Platform.putLong(buf, 40, Platform.getLong(buf, 40) + (48L << 32));
/* 062 */
/* 063 */
/* 064 */
/* 065 */     Platform.putLong(buf, 56, Platform.getLong(buf, 56) + (48L << 32));
/* 066 */
/* 067 */
/* 068 */
/* 069 */
...
/* 075 */
/* 076 */
/* 077 */     out.pointTo(buf, sizeInBytes);
/* 078 */
/* 079 */     return out;
/* 080 */   }
/* 081 */ }
