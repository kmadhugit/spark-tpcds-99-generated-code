...
/* 123 */             } else if (scan_value1.equals(((UTF8String) references[6]))) {
...
/* 132 */             } else if (scan_value1.equals(((UTF8String) references[7]))) {
...
/* 137 */
/* 138 */         }
/* 139 */         if (filter_isNull || !filter_value) continue;
/* 140 */
