...
/* 023 */     {
/* 024 */
/* 025 */       boolean isNull4 = i.isNullAt(6);
/* 026 */       UTF8String value4 = isNull4 ? null : (i.getUTF8String(6));
...
/* 033 */     {
/* 034 */
/* 035 */       boolean isNull4 = i.isNullAt(6);
/* 036 */       UTF8String value4 = isNull4 ? null : (i.getUTF8String(6));
...
/* 056 */     {
/* 057 */
/* 058 */       boolean isNull5 = i.isNullAt(8);
/* 059 */       int value5 = isNull5 ? -1 : (i.getInt(8));
...
/* 066 */     {
/* 067 */
/* 068 */       boolean isNull5 = i.isNullAt(8);
/* 069 */       int value5 = isNull5 ? -1 : (i.getInt(8));
...
/* 131 */     {
/* 132 */
/* 133 */       boolean isNull3 = i.isNullAt(4);
/* 134 */       int value3 = isNull3 ? -1 : (i.getInt(4));
...
/* 141 */     {
/* 142 */
/* 143 */       boolean isNull3 = i.isNullAt(4);
/* 144 */       int value3 = isNull3 ? -1 : (i.getInt(4));
...
/* 173 */     {
/* 174 */
/* 175 */       boolean isNull6 = i.isNullAt(10);
/* 176 */       int value6 = isNull6 ? -1 : (i.getInt(10));
...
/* 183 */     {
/* 184 */
/* 185 */       boolean isNull6 = i.isNullAt(10);
/* 186 */       int value6 = isNull6 ? -1 : (i.getInt(10));
...
/* 195 */       return 1;
/* 196 */     } else {
/* 197 */       int comp = (primitiveA6 > primitiveB6 ? 1 : primitiveA6 < primitiveB6 ? -1 : 0);
/* 198 */       if (comp != 0) {
/* 199 */         return comp;
/* 200 */       }
/* 201 */     }
...
/* 206 */     {
/* 207 */
/* 208 */       boolean isNull7 = i.isNullAt(12);
/* 209 */       int value7 = isNull7 ? -1 : (i.getInt(12));
...
/* 216 */     {
/* 217 */
/* 218 */       boolean isNull7 = i.isNullAt(12);
/* 219 */       int value7 = isNull7 ? -1 : (i.getInt(12));
...
/* 228 */       return 1;
/* 229 */     } else {
/* 230 */       int comp = (primitiveA7 > primitiveB7 ? 1 : primitiveA7 < primitiveB7 ? -1 : 0);
/* 231 */       if (comp != 0) {
/* 232 */         return comp;
/* 233 */       }
/* 234 */     }
...
/* 245 */     i = a;
/* 246 */     boolean isNullA;
/* 247 */     UTF8String primitiveA;
/* 248 */     {
/* 249 */
/* 250 */       boolean isNull = i.isNullAt(0);
/* 251 */       UTF8String value = isNull ? null : (i.getUTF8String(0));
/* 252 */       isNullA = isNull;
/* 253 */       primitiveA = value;
/* 254 */     }
/* 255 */     i = b;
/* 256 */     boolean isNullB;
/* 257 */     UTF8String primitiveB;
/* 258 */     {
/* 259 */
/* 260 */       boolean isNull = i.isNullAt(0);
/* 261 */       UTF8String value = isNull ? null : (i.getUTF8String(0));
/* 262 */       isNullB = isNull;
...
/* 270 */       return 1;
/* 271 */     } else {
/* 272 */       int comp = primitiveA.compare(primitiveB);
/* 273 */       if (comp != 0) {
/* 274 */         return comp;
/* 275 */       }
/* 276 */     }
...
/* 280 */     UTF8String primitiveA1;
/* 281 */     {
/* 282 */
/* 283 */       boolean isNull1 = i.isNullAt(1);
/* 284 */       UTF8String value1 = isNull1 ? null : (i.getUTF8String(1));
/* 285 */       isNullA1 = isNull1;
/* 286 */       primitiveA1 = value1;
/* 287 */     }
/* 288 */     i = b;
/* 289 */     boolean isNullB1;
/* 290 */     UTF8String primitiveB1;
/* 291 */     {
/* 292 */
/* 293 */       boolean isNull1 = i.isNullAt(1);
/* 294 */       UTF8String value1 = isNull1 ? null : (i.getUTF8String(1));
...
/* 303 */       return 1;
/* 304 */     } else {
/* 305 */       int comp = primitiveA1.compare(primitiveB1);
/* 306 */       if (comp != 0) {
/* 307 */         return comp;
/* 308 */       }
/* 309 */     }
