...
/* 117 */     private org.apache.spark.sql.types.StructType keySchema = new org.apache.spark.sql.types.StructType().add("((java.lang.String) references[3])", org.apache.spark.sql.types.DataTypes.LongType)
/* 118 */     .add("((java.lang.String) references[4])", org.apache.spark.sql.types.DataTypes.LongType);
...
/* 140 */     }
/* 141 */
/* 142 */     public org.apache.spark.sql.catalyst.expressions.UnsafeRow findOrInsert(long agg_key, long agg_key1) {
...
/* 188 */     }
/* 189 */
/* 190 */     private boolean equals(int idx, long agg_key, long agg_key1) {
/* 191 */       UnsafeRow row = batch.getKeyRow(buckets[idx]);
/* 192 */       return (row.getLong(0) == agg_key) && (row.getLong(1) == agg_key1);
/* 193 */     }
/* 194 */
/* 195 */     private long hash(long agg_key, long agg_key1) {
/* 196 */       long agg_hash = 0;
/* 197 */
/* 198 */       long agg_result = agg_key;
/* 199 */       agg_hash = (agg_hash ^ (0x9e3779b9)) + agg_result + (agg_hash << 6) + (agg_hash >>> 2);
/* 200 */
/* 201 */       long agg_result1 = agg_key1;
...
/* 229 */         long scan_value1 = scan_isNull1 ? -1L : (scan_colInstance1.getLong(scan_rowIdx));
/* 230 */
...
/* 252 */         long scan_value = scan_isNull ? -1L : (scan_colInstance0.getLong(scan_rowIdx));
...
/* 259 */
/* 260 */         if (true) {
/* 261 */           if (!scan_isNull && !false) {
/* 262 */             agg_fastAggBuffer = agg_fastHashMap.findOrInsert(
/* 263 */               scan_value, scan_value1);
/* 264 */           }
/* 265 */         }
/* 266 */
...
/* 270 */
/* 271 */           if (scan_isNull) {
/* 272 */             agg_rowWriter.setNullAt(0);
/* 273 */           } else {
/* 274 */             agg_rowWriter.write(0, scan_value);
/* 275 */           }
/* 276 */
/* 277 */           agg_rowWriter.write(1, scan_value1);
/* 278 */           agg_value6 = 42;
/* 279 */
/* 280 */           if (!scan_isNull) {
/* 281 */             agg_value6 = org.apache.spark.unsafe.hash.Murmur3_x86_32.hashLong(scan_value, agg_value6);
/* 282 */           }
/* 283 */
/* 284 */           if (!false) {
/* 285 */             agg_value6 = org.apache.spark.unsafe.hash.Murmur3_x86_32.hashLong(scan_value1, agg_value6);
/* 286 */           }
/* 287 */           if (true) {
