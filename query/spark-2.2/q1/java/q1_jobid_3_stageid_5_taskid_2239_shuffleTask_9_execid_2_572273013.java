...
/* 234 */         long scan_value = scan_isNull ? -1L : (scan_colInstance0.getLong(scan_rowIdx));
/* 235 */
...
/* 266 */               scan_value, scan_value1);
/* 267 */           }
/* 268 */         }
/* 269 */
/* 270 */         if (agg_fastAggBuffer == null) {
/* 271 */           // generate grouping key
/* 272 */           agg_rowWriter.write(0, scan_value);
/* 273 */
/* 274 */           agg_rowWriter.write(1, scan_value1);
/* 275 */           agg_value6 = 42;
/* 276 */
/* 277 */           if (!false) {
/* 278 */             agg_value6 = org.apache.spark.unsafe.hash.Murmur3_x86_32.hashLong(scan_value, agg_value6);
/* 279 */           }
/* 280 */
/* 281 */           if (!false) {
/* 282 */             agg_value6 = org.apache.spark.unsafe.hash.Murmur3_x86_32.hashLong(scan_value1, agg_value6);
/* 283 */           }
/* 284 */           if (true) {
