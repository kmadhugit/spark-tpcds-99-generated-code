...
/* 092 */     private org.apache.spark.sql.types.StructType keySchema = new org.apache.spark.sql.types.StructType().add("((java.lang.String) references[3])", org.apache.spark.sql.types.DataTypes.LongType);
...
/* 115 */     }
/* 116 */
/* 117 */     public org.apache.spark.sql.catalyst.expressions.UnsafeRow findOrInsert(long agg_key) {
...
/* 162 */     }
/* 163 */
/* 164 */     private boolean equals(int idx, long agg_key) {
/* 165 */       UnsafeRow row = batch.getKeyRow(buckets[idx]);
/* 166 */       return (row.getLong(0) == agg_key);
/* 167 */     }
/* 168 */
/* 169 */     private long hash(long agg_key) {
/* 170 */       long agg_hash = 0;
/* 171 */
/* 172 */       long agg_result = agg_key;
...
/* 206 */       long agg_value22 = agg_isNull19 ? -1L : (agg_aggKey.getLong(0));
/* 207 */       boolean agg_isNull20 = agg_aggKey.isNullAt(1);
/* 208 */       long agg_value23 = agg_isNull20 ? -1L : (agg_aggKey.getLong(1));
...
/* 229 */         } else {
/* 230 */           agg_rowWriter2.write(0, agg_value23);
/* 231 */         }
/* 232 */         agg_value32 = 42;
/* 233 */
/* 234 */         if (!agg_isNull20) {
/* 235 */           agg_value32 = org.apache.spark.unsafe.hash.Murmur3_x86_32.hashLong(agg_value23, agg_value32);
/* 236 */         }
/* 237 */         if (true) {
...
/* 409 */       long inputadapter_value = inputadapter_isNull ? -1L : (inputadapter_row.getLong(0));
/* 410 */       boolean inputadapter_isNull1 = inputadapter_row.isNullAt(1);
/* 411 */       long inputadapter_value1 = inputadapter_isNull1 ? -1L : (inputadapter_row.getLong(1));
...
/* 437 */           agg_value11 = org.apache.spark.unsafe.hash.Murmur3_x86_32.hashLong(inputadapter_value, agg_value11);
/* 438 */         }
/* 439 */
/* 440 */         if (!inputadapter_isNull1) {
/* 441 */           agg_value11 = org.apache.spark.unsafe.hash.Murmur3_x86_32.hashLong(inputadapter_value1, agg_value11);
/* 442 */         }
/* 443 */         if (true) {
