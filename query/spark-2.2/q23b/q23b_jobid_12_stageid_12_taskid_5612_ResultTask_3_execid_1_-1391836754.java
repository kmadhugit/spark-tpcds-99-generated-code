...
/* 149 */
/* 150 */         if (scan_isNull1) {
/* 151 */           project_rowWriter.setNullAt(1);
/* 152 */         } else {
/* 153 */           project_rowWriter.write(1, scan_value1);
/* 154 */         }
/* 155 */         project_result.setTotalSize(project_holder.totalSize());
/* 156 */         append(project_result);
/* 157 */         if (shouldStop()) { scan_batchIdx = scan_rowIdx + 1; return; }
/* 158 */       }
/* 159 */       scan_batchIdx = scan_numRows;
/* 160 */       scan_batch = null;
/* 161 */       scan_nextBatch();
/* 162 */     }
