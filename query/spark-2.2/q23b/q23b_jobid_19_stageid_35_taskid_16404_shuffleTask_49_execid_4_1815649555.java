...
/* 030 */       boolean inputadapter_isNull2 = inputadapter_row.isNullAt(2);
/* 031 */       int inputadapter_value2 = inputadapter_isNull2 ? -1 : (inputadapter_row.getInt(2));
...
/* 039 */
/* 040 */       if (inputadapter_isNull2) {
/* 041 */         project_rowWriter.setNullAt(0);
/* 042 */       } else {
/* 043 */         project_rowWriter.write(0, inputadapter_value2);
/* 044 */       }
/* 045 */
