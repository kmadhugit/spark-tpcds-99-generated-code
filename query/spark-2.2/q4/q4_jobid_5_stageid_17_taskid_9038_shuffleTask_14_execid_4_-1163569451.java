...
/* 077 */       UTF8String inputadapter_value3 = inputadapter_isNull3 ? null : (inputadapter_row.getUTF8String(3));
...
/* 085 */       int inputadapter_value7 = inputadapter_isNull7 ? -1 : (inputadapter_row.getInt(7));
...
/* 162 */           agg_value18 = org.apache.spark.unsafe.hash.Murmur3_x86_32.hashUnsafeBytes(inputadapter_value3.getBaseObject(), inputadapter_value3.getBaseOffset(), inputadapter_value3.numBytes(), agg_value18);
/* 163 */         }
/* 164 */
...
/* 178 */           agg_value18 = org.apache.spark.unsafe.hash.Murmur3_x86_32.hashInt(inputadapter_value7, agg_value18);
/* 179 */         }
/* 180 */         if (true) {
...
/* 289 */       UTF8String agg_value38 = agg_isNull37 ? null : (agg_aggKey.getUTF8String(3));
...
/* 297 */       int agg_value42 = agg_isNull41 ? -1 : (agg_aggKey.getInt(7));
