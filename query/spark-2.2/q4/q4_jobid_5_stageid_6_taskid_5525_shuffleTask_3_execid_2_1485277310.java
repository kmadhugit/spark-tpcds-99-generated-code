...
/* 113 */         double scan_value4 = scan_isNull4 ? -1.0 : (scan_colInstance4.getDouble(scan_rowIdx));
...
/* 122 */         } else {
/* 123 */           project_rowWriter.write(1, scan_value1);
/* 124 */         }
/* 125 */
/* 126 */         if (scan_isNull2) {
/* 127 */           project_rowWriter.setNullAt(2);
/* 128 */         } else {
/* 129 */           project_rowWriter.write(2, scan_value2);
/* 130 */         }
/* 131 */
/* 132 */         if (scan_isNull3) {
/* 133 */           project_rowWriter.setNullAt(3);
/* 134 */         } else {
/* 135 */           project_rowWriter.write(3, scan_value3);
/* 136 */         }
/* 137 */
/* 138 */         if (scan_isNull4) {
/* 139 */           project_rowWriter.setNullAt(4);
/* 140 */         } else {
/* 141 */           project_rowWriter.write(4, scan_value4);
/* 142 */         }
/* 143 */
/* 144 */         if (scan_isNull5) {
/* 145 */           project_rowWriter.setNullAt(5);
/* 146 */         } else {
/* 147 */           project_rowWriter.write(5, scan_value5);
/* 148 */         }
