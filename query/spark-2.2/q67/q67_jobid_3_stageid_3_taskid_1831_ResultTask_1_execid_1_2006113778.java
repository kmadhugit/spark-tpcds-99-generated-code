...
/* 097 */         int scan_value1 = scan_isNull1 ? -1 : (scan_colInstance1.getInt(scan_rowIdx));
/* 098 */
...
/* 104 */         filter_value2 = scan_value1 >= 1200;
/* 105 */         if (!filter_value2) continue;
/* 106 */         boolean filter_isNull5 = false;
/* 107 */
/* 108 */         boolean filter_value5 = false;
/* 109 */         filter_value5 = scan_value1 <= 1211;
/* 110 */         if (!filter_value5) continue;
/* 111 */
/* 112 */         boolean scan_isNull = scan_colInstance0.isNullAt(scan_rowIdx);
/* 113 */         int scan_value = scan_isNull ? -1 : (scan_colInstance0.getInt(scan_rowIdx));
/* 114 */
/* 115 */         if (!(!(scan_isNull))) continue;
/* 116 */
...
/* 124 */         int scan_value4 = scan_isNull4 ? -1 : (scan_colInstance4.getInt(scan_rowIdx));
...
/* 131 */         } else {
/* 132 */           project_rowWriter.write(1, scan_value2);
/* 133 */         }
/* 134 */
/* 135 */         if (scan_isNull3) {
...
/* 140 */
/* 141 */         if (scan_isNull4) {
/* 142 */           project_rowWriter.setNullAt(3);
/* 143 */         } else {
/* 144 */           project_rowWriter.write(3, scan_value4);
/* 145 */         }
