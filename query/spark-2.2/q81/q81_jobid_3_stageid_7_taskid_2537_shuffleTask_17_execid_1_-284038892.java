...
/* 221 */       }
/* 222 */
/* 223 */       boolean agg_isNull20 = true;
/* 224 */       double agg_value22 = -1.0;
/* 225 */
/* 226 */       if (!agg_isNull16) {
/* 227 */         agg_isNull20 = false; // resultCode could change nullability.
/* 228 */         agg_value22 = agg_value18 * 1.2D;
/* 229 */
/* 230 */       }
/* 231 */
/* 232 */       if (!(!(agg_isNull20))) continue;
/* 233 */
/* 234 */       filter_numOutputRows.add(1);
/* 235 */
/* 236 */       filter_holder.reset();
/* 237 */
/* 238 */       filter_rowWriter.zeroOutNullBytes();
/* 239 */
/* 240 */       filter_rowWriter.write(0, agg_value22);
/* 241 */
/* 242 */       if (agg_isNull13) {
...
/* 246 */       }
/* 247 */       filter_result.setTotalSize(filter_holder.totalSize());
/* 248 */       append(filter_result);
/* 249 */
