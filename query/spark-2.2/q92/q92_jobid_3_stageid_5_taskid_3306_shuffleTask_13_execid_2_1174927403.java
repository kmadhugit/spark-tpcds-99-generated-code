...
/* 234 */       }
/* 235 */
/* 236 */       boolean agg_isNull20 = true;
/* 237 */       double agg_value22 = -1.0;
/* 238 */
/* 239 */       if (!agg_isNull16) {
/* 240 */         agg_isNull20 = false; // resultCode could change nullability.
/* 241 */         agg_value22 = 1.3D * agg_value18;
/* 242 */
/* 243 */       }
/* 244 */
/* 245 */       if (!(!(agg_isNull20))) continue;
/* 246 */
/* 247 */       filter_numOutputRows.add(1);
/* 248 */
/* 249 */       filter_rowWriter.zeroOutNullBytes();
/* 250 */
/* 251 */       filter_rowWriter.write(0, agg_value22);
/* 252 */
/* 253 */       if (agg_isNull13) {
/* 254 */         filter_rowWriter.setNullAt(1);
/* 255 */       } else {
/* 256 */         filter_rowWriter.write(1, agg_value15);
/* 257 */       }
/* 258 */       sort_sorter.insertRow((UnsafeRow)filter_result);
/* 259 */
/* 260 */       if (shouldStop()) return;
/* 261 */     }
/* 262 */
/* 263 */     agg_mapIter.close();
/* 264 */     if (agg_sorter == null) {
/* 265 */       agg_hashMap.free();
/* 266 */     }
/* 267 */
/* 268 */   }
/* 269 */
/* 270 */   protected void processNext() throws java.io.IOException {
/* 271 */     if (sort_needToSort) {
/* 272 */       long sort_spillSizeBefore = sort_metrics.memoryBytesSpilled();
/* 273 */       sort_addToSorter();
/* 274 */       sort_sortedIter = sort_sorter.sort();
/* 275 */       sort_sortTime.add(sort_sorter.getSortTimeNanos() / 1000000);
/* 276 */       sort_peakMemory.add(sort_sorter.getPeakMemoryUsage());
/* 277 */       sort_spillSize.add(sort_metrics.memoryBytesSpilled() - sort_spillSizeBefore);
/* 278 */       sort_metrics.incPeakExecutionMemory(sort_sorter.getPeakMemoryUsage());
/* 279 */       sort_needToSort = false;
/* 280 */     }
/* 281 */
/* 282 */     while (sort_sortedIter.hasNext()) {
/* 283 */       UnsafeRow sort_outputRow = (UnsafeRow)sort_sortedIter.next();
/* 284 */
/* 285 */       append(sort_outputRow);
/* 286 */
