...
/* 104 */         filter_value2 = org.apache.spark.util.Utils.nanSafeCompareDoubles(scan_value3, 10000.0D) > 0;
/* 105 */         if (!filter_value2) continue;
/* 106 */
/* 107 */         boolean scan_isNull = scan_colInstance0.isNullAt(scan_rowIdx);
/* 108 */         long scan_value = scan_isNull ? -1L : (scan_colInstance0.getLong(scan_rowIdx));
/* 109 */
/* 110 */         if (!(!(scan_isNull))) continue;
/* 111 */
/* 112 */         boolean scan_isNull1 = scan_colInstance1.isNullAt(scan_rowIdx);
/* 113 */         long scan_value1 = scan_isNull1 ? -1L : (scan_colInstance1.getLong(scan_rowIdx));
/* 114 */
...
/* 120 */         long scan_value2 = scan_isNull2 ? -1L : (scan_colInstance2.getLong(scan_rowIdx));
...
/* 135 */         if (shouldStop()) { scan_batchIdx = scan_rowIdx + 1; return; }
/* 136 */       }
/* 137 */       scan_batchIdx = scan_numRows;
/* 138 */       scan_batch = null;
/* 139 */       scan_nextBatch();
/* 140 */     }
