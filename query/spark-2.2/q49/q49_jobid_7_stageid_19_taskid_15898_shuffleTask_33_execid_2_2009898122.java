...
/* 043 */     int value = isNull ? -1 : (i.getInt(0));
/* 044 */     if (isNull) {
...
/* 052 */     Decimal value1 = isNull1 ? null : (i.getDecimal(1, 35, 20));
/* 053 */     if (isNull1) {
/* 054 */       rowWriter.write(1, (Decimal) null, 35, 20);
/* 055 */     } else {
/* 056 */       rowWriter.write(1, value1, 35, 20);
/* 057 */     }
/* 058 */
/* 059 */
