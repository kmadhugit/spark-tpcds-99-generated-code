...
/* 047 */     Decimal value1 = isNull1 ? null : (i.getDecimal(1, 35, 20));
/* 048 */     if (isNull1) {
/* 049 */       rowWriter.write(1, (Decimal) null, 35, 20);
/* 050 */     } else {
/* 051 */       rowWriter.write(1, value1, 35, 20);
/* 052 */     }
/* 053 */
/* 054 */
/* 055 */     boolean isNull2 = i.isNullAt(2);
/* 056 */     Decimal value2 = isNull2 ? null : (i.getDecimal(2, 35, 20));
/* 057 */     if (isNull2) {
/* 058 */       rowWriter.write(2, (Decimal) null, 35, 20);
/* 059 */     } else {
/* 060 */       rowWriter.write(2, value2, 35, 20);
/* 061 */     }
/* 062 */
/* 063 */
