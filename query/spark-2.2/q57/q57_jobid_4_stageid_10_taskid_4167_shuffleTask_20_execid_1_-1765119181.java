...
/* 053 */     boolean isNull4 = i.isNullAt(7);
/* 054 */     int value4 = isNull4 ? -1 : (i.getInt(7));
...
/* 061 */     if (value3) {
/* 062 */
/* 063 */       boolean isNull7 = i.isNullAt(8);
/* 064 */       int value7 = isNull7 ? -1 : (i.getInt(8));
...
/* 136 */
/* 137 */
/* 138 */     boolean isNull21 = i.isNullAt(7);
/* 139 */     int value21 = isNull21 ? -1 : (i.getInt(7));
/* 140 */     this.isNull_2 = isNull21;
/* 141 */     this.value_2 = value21;
/* 142 */
/* 143 */
/* 144 */     boolean isNull22 = i.isNullAt(8);
/* 145 */     int value22 = isNull22 ? -1 : (i.getInt(8));
