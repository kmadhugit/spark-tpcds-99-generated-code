...
/* 096 */         UTF8String scan_value2 = scan_isNull2 ? null : (scan_colInstance2.getUTF8String(scan_rowIdx));
/* 097 */
...
/* 106 */
/* 107 */         project_holder.reset();
/* 108 */
/* 109 */         project_rowWriter.write(0, scan_value);
/* 110 */
/* 111 */         project_rowWriter.write(1, scan_value1);
/* 112 */
/* 113 */         project_rowWriter.write(2, scan_value2);
/* 114 */         project_result.setTotalSize(project_holder.totalSize());
