...
/* 127 */     }
/* 128 */
/* 129 */     long value10 = i.getLong(5);
/* 130 */     if (false) {
/* 131 */       values[5] = null;
/* 132 */     } else {
/* 133 */       values[5] = value10;
/* 134 */     }
/* 135 */
/* 136 */   }
/* 137 */
/* 138 */
/* 139 */   public java.lang.Object apply(java.lang.Object _i) {
/* 140 */     InternalRow i = (InternalRow) _i;
/* 141 */
/* 142 */     values = new Object[6];
/* 143 */     apply_0(i);
/* 144 */     apply_1(i);
/* 145 */     apply_2(i);
/* 146 */     final org.apache.spark.sql.Row value = new org.apache.spark.sql.catalyst.expressions.GenericRowWithSchema(values, schema);
/* 147 */     if (false) {
/* 148 */       mutableRow.setNullAt(0);
/* 149 */     } else {
/* 150 */
/* 151 */       mutableRow.update(0, value);
/* 152 */     }
/* 153 */
/* 154 */     return mutableRow;
/* 155 */   }
/* 156 */ }
