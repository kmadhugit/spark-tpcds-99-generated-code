...
/* 033 */
/* 034 */
/* 035 */     boolean isNull1 = i.isNullAt(24);
/* 036 */     UTF8String value1 = isNull1 ? null : (i.getUTF8String(24));
/* 037 */     long value = 0L;
/* 038 */     boolean isNull = isNull1;
/* 039 */     if (!isNull1) {
/* 040 */       value = org.apache.spark.util.collection.unsafe.sort.PrefixComparators$StringPrefixComparator.computePrefix(value1);
/* 041 */     }
/* 042 */     if (isNull) {
