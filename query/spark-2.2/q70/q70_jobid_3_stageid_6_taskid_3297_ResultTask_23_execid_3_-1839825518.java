...
/* 032 */       boolean inputadapter_isNull23 = inputadapter_row.isNullAt(23);
/* 033 */       UTF8String inputadapter_value23 = inputadapter_isNull23 ? null : (inputadapter_row.getUTF8String(23));
/* 034 */       boolean inputadapter_isNull24 = inputadapter_row.isNullAt(24);
/* 035 */       UTF8String inputadapter_value24 = inputadapter_isNull24 ? null : (inputadapter_row.getUTF8String(24));
...
/* 044 */       }
/* 045 */
/* 046 */       if (inputadapter_isNull23) {
/* 047 */         project_rowWriter.setNullAt(1);
/* 048 */       } else {
/* 049 */         project_rowWriter.write(1, inputadapter_value23);
/* 050 */       }
/* 051 */
/* 052 */       if (inputadapter_isNull24) {
/* 053 */         project_rowWriter.setNullAt(2);
/* 054 */       } else {
/* 055 */         project_rowWriter.write(2, inputadapter_value24);
/* 056 */       }
