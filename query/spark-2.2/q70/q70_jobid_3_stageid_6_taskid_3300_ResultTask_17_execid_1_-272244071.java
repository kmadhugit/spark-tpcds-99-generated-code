...
/* 024 */     {
/* 025 */
/* 026 */       boolean isNull = i.isNullAt(24);
/* 027 */       UTF8String value = isNull ? null : (i.getUTF8String(24));
/* 028 */       isNullA = isNull;
...
/* 034 */     {
/* 035 */
/* 036 */       boolean isNull = i.isNullAt(24);
/* 037 */       UTF8String value = isNull ? null : (i.getUTF8String(24));
/* 038 */       isNullB = isNull;
