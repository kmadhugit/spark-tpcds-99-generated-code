...
/* 103 */         filter_value5 = scan_value2 <= 2;
...
/* 107 */
/* 108 */         boolean filter_value8 = false;
/* 109 */         boolean filter_isNull8 = scan_isNull1;
/* 110 */         if (!filter_isNull8) {
/* 111 */           if (!filter_value8) {
/* 112 */             if (false) {
/* 113 */               filter_isNull8 = true;
/* 114 */             } else if (scan_value1 == 1999) {
/* 115 */               filter_isNull8 = false;
/* 116 */               filter_value8 = true;
/* 117 */             }
/* 118 */           }
/* 119 */
/* 120 */           if (!filter_value8) {
/* 121 */             if (false) {
/* 122 */               filter_isNull8 = true;
/* 123 */             } else if (scan_value1 == 2000) {
/* 124 */               filter_isNull8 = false;
/* 125 */               filter_value8 = true;
/* 126 */             }
/* 127 */           }
/* 128 */
/* 129 */           if (!filter_value8) {
/* 130 */             if (false) {
/* 131 */               filter_isNull8 = true;
/* 132 */             } else if (scan_value1 == 2001) {
/* 133 */               filter_isNull8 = false;
/* 134 */               filter_value8 = true;
/* 135 */             }
/* 136 */           }
/* 137 */
/* 138 */         }
/* 139 */         if (filter_isNull8 || !filter_value8) continue;
/* 140 */
/* 141 */         boolean scan_isNull = scan_colInstance0.isNullAt(scan_rowIdx);
/* 142 */         int scan_value = scan_isNull ? -1 : (scan_colInstance0.getInt(scan_rowIdx));
/* 143 */
/* 144 */         if (!(!(scan_isNull))) continue;
/* 145 */
/* 146 */         filter_numOutputRows.add(1);
/* 147 */
/* 148 */         project_rowWriter.write(0, scan_value);
/* 149 */         append(project_result);
/* 150 */         if (shouldStop()) { scan_batchIdx = scan_rowIdx + 1; return; }
/* 151 */       }
/* 152 */       scan_batchIdx = scan_numRows;
/* 153 */       scan_batch = null;
/* 154 */       scan_nextBatch();
/* 155 */     }
/* 156 */     scan_scanTime.add(scan_scanTime1 / (1000 * 1000));
/* 157 */     scan_scanTime1 = 0;
/* 158 */   }
/* 159 */ }
