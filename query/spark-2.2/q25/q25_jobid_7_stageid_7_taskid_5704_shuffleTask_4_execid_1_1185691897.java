...
/* 102 */         long scan_value2 = scan_isNull2 ? -1L : (scan_colInstance2.getLong(scan_rowIdx));
/* 103 */
/* 104 */         if (!(!(scan_isNull2))) continue;
/* 105 */
/* 106 */         boolean scan_isNull = scan_colInstance0.isNullAt(scan_rowIdx);
/* 107 */         long scan_value = scan_isNull ? -1L : (scan_colInstance0.getLong(scan_rowIdx));
/* 108 */
...
/* 114 */         double scan_value3 = scan_isNull3 ? -1.0 : (scan_colInstance3.getDouble(scan_rowIdx));
/* 115 */         boolean scan_isNull4 = scan_colInstance4.isNullAt(scan_rowIdx);
/* 116 */         int scan_value4 = scan_isNull4 ? -1 : (scan_colInstance4.getInt(scan_rowIdx));
/* 117 */         project_rowWriter.zeroOutNullBytes();
/* 118 */
/* 119 */         project_rowWriter.write(0, scan_value);
/* 120 */
/* 121 */         project_rowWriter.write(1, scan_value1);
/* 122 */
/* 123 */         project_rowWriter.write(2, scan_value2);
/* 124 */
/* 125 */         if (scan_isNull3) {
/* 126 */           project_rowWriter.setNullAt(3);
/* 127 */         } else {
/* 128 */           project_rowWriter.write(3, scan_value3);
/* 129 */         }
/* 130 */
/* 131 */         if (scan_isNull4) {
/* 132 */           project_rowWriter.setNullAt(4);
/* 133 */         } else {
/* 134 */           project_rowWriter.write(4, scan_value4);
/* 135 */         }
/* 136 */         append(project_result);
/* 137 */         if (shouldStop()) { scan_batchIdx = scan_rowIdx + 1; return; }
/* 138 */       }
/* 139 */       scan_batchIdx = scan_numRows;
/* 140 */       scan_batch = null;
/* 141 */       scan_nextBatch();
/* 142 */     }
