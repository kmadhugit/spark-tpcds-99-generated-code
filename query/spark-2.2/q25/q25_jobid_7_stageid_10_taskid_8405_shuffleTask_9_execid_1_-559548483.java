...
/* 023 */     {
/* 024 */
/* 025 */       boolean isNull5 = i.isNullAt(3);
/* 026 */       int value5 = isNull5 ? -1 : (i.getInt(3));
...
/* 038 */     {
/* 039 */
/* 040 */       boolean isNull5 = i.isNullAt(3);
/* 041 */       int value5 = isNull5 ? -1 : (i.getInt(3));
...
/* 127 */     {
/* 128 */
/* 129 */       boolean isNull1 = i.isNullAt(1);
/* 130 */       int value1 = isNull1 ? -1 : (i.getInt(1));
...
/* 142 */     {
/* 143 */
/* 144 */       boolean isNull1 = i.isNullAt(1);
/* 145 */       int value1 = isNull1 ? -1 : (i.getInt(1));
