...
/* 100 */         int scan_value3 = scan_isNull3 ? -1 : (scan_colInstance3.getInt(scan_rowIdx));
/* 101 */
/* 102 */         if (!(!(scan_isNull3))) continue;
/* 103 */
...
/* 110 */         int scan_value1 = scan_isNull1 ? -1 : (scan_colInstance1.getInt(scan_rowIdx));
/* 111 */
/* 112 */         if (!(!(scan_isNull1))) continue;
/* 113 */
...
/* 124 */         int scan_value5 = scan_isNull5 ? -1 : (scan_colInstance5.getInt(scan_rowIdx));
...
/* 132 */
/* 133 */         project_rowWriter.write(3, scan_value3);
/* 134 */
/* 135 */         if (scan_isNull4) {
...
/* 140 */
/* 141 */         if (scan_isNull5) {
/* 142 */           project_rowWriter.setNullAt(5);
/* 143 */         } else {
/* 144 */           project_rowWriter.write(5, scan_value5);
/* 145 */         }
