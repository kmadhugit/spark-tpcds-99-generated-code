...
/* 401 */       }
/* 402 */
/* 403 */       agg_holder1.reset();
/* 404 */
/* 405 */       agg_rowWriter1.zeroOutNullBytes();
/* 406 */
/* 407 */       if (agg_isNull40) {
/* 408 */         agg_rowWriter1.setNullAt(0);
/* 409 */       } else {
/* 410 */         agg_rowWriter1.write(0, agg_value48);
/* 411 */       }
/* 412 */
/* 413 */       if (agg_isNull49) {
/* 414 */         agg_rowWriter1.setNullAt(1);
/* 415 */       } else {
/* 416 */         agg_rowWriter1.write(1, agg_value57);
/* 417 */       }
/* 418 */
/* 419 */       if (agg_isNull53) {
/* 420 */         agg_rowWriter1.setNullAt(2);
/* 421 */       } else {
/* 422 */         agg_rowWriter1.write(2, agg_value61);
/* 423 */       }
/* 424 */
/* 425 */       if (agg_isNull57) {
/* 426 */         agg_rowWriter1.setNullAt(3);
/* 427 */       } else {
/* 428 */         agg_rowWriter1.write(3, agg_value65);
/* 429 */       }
/* 430 */
/* 431 */       if (agg_isNull61) {
/* 432 */         agg_rowWriter1.setNullAt(4);
/* 433 */       } else {
/* 434 */         agg_rowWriter1.write(4, agg_value69);
/* 435 */       }
/* 436 */       agg_result1.setTotalSize(agg_holder1.totalSize());
/* 437 */       append(agg_result1);
/* 438 */
/* 439 */       if (shouldStop()) return;
/* 440 */     }
/* 441 */
/* 442 */     agg_mapIter.close();
/* 443 */     if (agg_sorter == null) {
/* 444 */       agg_hashMap.free();
/* 445 */     }
/* 446 */   }
/* 447 */ }
