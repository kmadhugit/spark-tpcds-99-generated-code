...
/* 088 */         long scan_value = scan_isNull ? -1L : (scan_colInstance0.getLong(scan_rowIdx));
/* 089 */
/* 090 */         if (!(!(scan_isNull))) continue;
/* 091 */
/* 092 */         filter_numOutputRows.add(1);
/* 093 */
/* 094 */         project_rowWriter.write(0, scan_value);
/* 095 */         append(project_result);
/* 096 */         if (shouldStop()) { scan_batchIdx = scan_rowIdx + 1; return; }
/* 097 */       }
/* 098 */       scan_batchIdx = scan_numRows;
/* 099 */       scan_batch = null;
/* 100 */       scan_nextBatch();
/* 101 */     }
/* 102 */     scan_scanTime.add(scan_scanTime1 / (1000 * 1000));
