...
/* 058 */     }
/* 059 */
/* 060 */     final org.apache.spark.sql.Row value = new org.apache.spark.sql.catalyst.expressions.GenericRowWithSchema(values, schema);
/* 061 */     if (false) {
/* 062 */       mutableRow.setNullAt(0);
/* 063 */     } else {
/* 064 */
/* 065 */       mutableRow.update(0, value);
/* 066 */     }
/* 067 */
