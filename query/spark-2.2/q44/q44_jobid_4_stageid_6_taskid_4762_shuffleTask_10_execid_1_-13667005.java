...
/* 033 */
/* 034 */
/* 035 */     boolean isNull = false;
/* 036 */     double value = -1.0;
/* 037 */     if (!false) {
/* 038 */       value = (double) 0;
/* 039 */     }
/* 040 */     if (isNull) {
/* 041 */       rowWriter.setNullAt(0);
/* 042 */     } else {
/* 043 */       rowWriter.write(0, value);
/* 044 */     }
/* 045 */
/* 046 */
/* 047 */     rowWriter.write(1, 0L);
/* 048 */
/* 049 */
/* 050 */     boolean isNull3 = false;
/* 051 */     double value3 = -1.0;
/* 052 */     if (!false) {
/* 053 */       value3 = (double) 0;
/* 054 */     }
/* 055 */     if (isNull3) {
...
/* 057 */     } else {
/* 058 */       rowWriter.write(2, value3);
/* 059 */     }
/* 060 */
/* 061 */
/* 062 */     rowWriter.write(3, 0L);
/* 063 */     return result;
/* 064 */   }
/* 065 */ }
