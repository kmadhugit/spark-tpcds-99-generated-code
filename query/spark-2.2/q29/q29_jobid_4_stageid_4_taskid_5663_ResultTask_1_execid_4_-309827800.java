...
/* 103 */         filter_value5 = scan_value2 <= 12;
...
/* 113 */         filter_value10 = scan_value1 == 1999;
/* 114 */         if (!filter_value10) continue;
/* 115 */
/* 116 */         boolean scan_isNull = scan_colInstance0.isNullAt(scan_rowIdx);
/* 117 */         int scan_value = scan_isNull ? -1 : (scan_colInstance0.getInt(scan_rowIdx));
/* 118 */
/* 119 */         if (!(!(scan_isNull))) continue;
/* 120 */
/* 121 */         filter_numOutputRows.add(1);
/* 122 */
/* 123 */         project_rowWriter.write(0, scan_value);
/* 124 */         append(project_result);
/* 125 */         if (shouldStop()) { scan_batchIdx = scan_rowIdx + 1; return; }
/* 126 */       }
/* 127 */       scan_batchIdx = scan_numRows;
/* 128 */       scan_batch = null;
/* 129 */       scan_nextBatch();
/* 130 */     }
/* 131 */     scan_scanTime.add(scan_scanTime1 / (1000 * 1000));
