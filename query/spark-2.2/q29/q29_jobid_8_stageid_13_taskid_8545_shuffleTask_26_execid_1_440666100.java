...
/* 162 */         long agg_value20 = -1L;
/* 163 */
/* 164 */         boolean agg_isNull19 = agg_unsafeRowAggBuffer.isNullAt(0);
/* 165 */         long agg_value22 = agg_isNull19 ? -1L : (agg_unsafeRowAggBuffer.getLong(0));
/* 166 */         boolean agg_isNull18 = agg_isNull19;
/* 167 */         long agg_value21 = agg_value22;
/* 168 */         if (agg_isNull18) {
/* 169 */           boolean agg_isNull20 = false;
/* 170 */           long agg_value23 = -1L;
/* 171 */           if (!false) {
/* 172 */             agg_value23 = (long) 0;
/* 173 */           }
/* 174 */           if (!agg_isNull20) {
...
/* 186 */         long agg_value19 = agg_value20;
/* 187 */         if (agg_isNull16) {
/* 188 */           boolean agg_isNull23 = agg_unsafeRowAggBuffer.isNullAt(0);
/* 189 */           long agg_value26 = agg_isNull23 ? -1L : (agg_unsafeRowAggBuffer.getLong(0));
/* 190 */           if (!agg_isNull23) {
...
/* 196 */         long agg_value28 = -1L;
/* 197 */
/* 198 */         boolean agg_isNull27 = agg_unsafeRowAggBuffer.isNullAt(1);
/* 199 */         long agg_value30 = agg_isNull27 ? -1L : (agg_unsafeRowAggBuffer.getLong(1));
/* 200 */         boolean agg_isNull26 = agg_isNull27;
/* 201 */         long agg_value29 = agg_value30;
/* 202 */         if (agg_isNull26) {
/* 203 */           boolean agg_isNull28 = false;
/* 204 */           long agg_value31 = -1L;
/* 205 */           if (!false) {
/* 206 */             agg_value31 = (long) 0;
/* 207 */           }
/* 208 */           if (!agg_isNull28) {
...
/* 220 */         long agg_value27 = agg_value28;
/* 221 */         if (agg_isNull24) {
/* 222 */           boolean agg_isNull31 = agg_unsafeRowAggBuffer.isNullAt(1);
/* 223 */           long agg_value34 = agg_isNull31 ? -1L : (agg_unsafeRowAggBuffer.getLong(1));
/* 224 */           if (!agg_isNull31) {
...
/* 230 */         long agg_value36 = -1L;
/* 231 */
/* 232 */         boolean agg_isNull35 = agg_unsafeRowAggBuffer.isNullAt(2);
/* 233 */         long agg_value38 = agg_isNull35 ? -1L : (agg_unsafeRowAggBuffer.getLong(2));
/* 234 */         boolean agg_isNull34 = agg_isNull35;
/* 235 */         long agg_value37 = agg_value38;
/* 236 */         if (agg_isNull34) {
/* 237 */           boolean agg_isNull36 = false;
/* 238 */           long agg_value39 = -1L;
/* 239 */           if (!false) {
/* 240 */             agg_value39 = (long) 0;
/* 241 */           }
/* 242 */           if (!agg_isNull36) {
...
/* 254 */         long agg_value35 = agg_value36;
/* 255 */         if (agg_isNull32) {
/* 256 */           boolean agg_isNull39 = agg_unsafeRowAggBuffer.isNullAt(2);
/* 257 */           long agg_value42 = agg_isNull39 ? -1L : (agg_unsafeRowAggBuffer.getLong(2));
/* 258 */           if (!agg_isNull39) {
...
/* 264 */         if (!agg_isNull16) {
/* 265 */           agg_unsafeRowAggBuffer.setLong(0, agg_value19);
/* 266 */         } else {
/* 267 */           agg_unsafeRowAggBuffer.setNullAt(0);
/* 268 */         }
/* 269 */
/* 270 */         if (!agg_isNull24) {
/* 271 */           agg_unsafeRowAggBuffer.setLong(1, agg_value27);
/* 272 */         } else {
/* 273 */           agg_unsafeRowAggBuffer.setNullAt(1);
/* 274 */         }
/* 275 */
/* 276 */         if (!agg_isNull32) {
/* 277 */           agg_unsafeRowAggBuffer.setLong(2, agg_value35);
/* 278 */         } else {
...
/* 305 */       UTF8String agg_value43 = agg_isNull40 ? null : (agg_aggKey.getUTF8String(0));
/* 306 */       boolean agg_isNull41 = agg_aggKey.isNullAt(1);
/* 307 */       UTF8String agg_value44 = agg_isNull41 ? null : (agg_aggKey.getUTF8String(1));
/* 308 */       boolean agg_isNull42 = agg_aggKey.isNullAt(2);
/* 309 */       UTF8String agg_value45 = agg_isNull42 ? null : (agg_aggKey.getUTF8String(2));
...
/* 313 */       long agg_value47 = agg_isNull44 ? -1L : (agg_aggBuffer.getLong(0));
/* 314 */       boolean agg_isNull45 = agg_aggBuffer.isNullAt(1);
/* 315 */       long agg_value48 = agg_isNull45 ? -1L : (agg_aggBuffer.getLong(1));
/* 316 */       boolean agg_isNull46 = agg_aggBuffer.isNullAt(2);
/* 317 */       long agg_value49 = agg_isNull46 ? -1L : (agg_aggBuffer.getLong(2));
/* 318 */
...
/* 337 */       } else {
/* 338 */         agg_rowWriter1.write(2, agg_value45);
/* 339 */       }
/* 340 */
/* 341 */       if (agg_isNull43) {
/* 342 */         agg_rowWriter1.setNullAt(3);
/* 343 */       } else {
/* 344 */         agg_rowWriter1.write(3, agg_value46);
/* 345 */       }
/* 346 */
/* 347 */       if (agg_isNull44) {
/* 348 */         agg_rowWriter1.setNullAt(4);
/* 349 */       } else {
/* 350 */         agg_rowWriter1.write(4, agg_value47);
/* 351 */       }
/* 352 */
/* 353 */       if (agg_isNull45) {
/* 354 */         agg_rowWriter1.setNullAt(5);
/* 355 */       } else {
/* 356 */         agg_rowWriter1.write(5, agg_value48);
/* 357 */       }
/* 358 */
/* 359 */       if (agg_isNull46) {
/* 360 */         agg_rowWriter1.setNullAt(6);
/* 361 */       } else {
/* 362 */         agg_rowWriter1.write(6, agg_value49);
/* 363 */       }
/* 364 */       agg_result1.setTotalSize(agg_holder1.totalSize());
/* 365 */       append(agg_result1);
/* 366 */
/* 367 */       if (shouldStop()) return;
/* 368 */     }
/* 369 */
/* 370 */     agg_mapIter.close();
/* 371 */     if (agg_sorter == null) {
/* 372 */       agg_hashMap.free();
/* 373 */     }
/* 374 */   }
/* 375 */ }
