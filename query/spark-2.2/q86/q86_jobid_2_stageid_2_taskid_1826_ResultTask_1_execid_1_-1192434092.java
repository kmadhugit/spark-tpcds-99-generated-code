...
/* 098 */         UTF8String scan_value1 = scan_isNull1 ? null : (scan_colInstance1.getUTF8String(scan_rowIdx));
...
/* 104 */
/* 105 */         project_rowWriter.write(0, scan_value);
/* 106 */
/* 107 */         if (scan_isNull1) {
/* 108 */           project_rowWriter.setNullAt(1);
/* 109 */         } else {
