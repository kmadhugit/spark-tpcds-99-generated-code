...
/* 023 */     {
/* 024 */
/* 025 */       boolean isNull2 = i.isNullAt(6);
/* 026 */       double value2 = isNull2 ? -1.0 : (i.getDouble(6));
...
/* 033 */     {
/* 034 */
/* 035 */       boolean isNull2 = i.isNullAt(6);
/* 036 */       double value2 = isNull2 ? -1.0 : (i.getDouble(6));
...
/* 096 */     {
/* 097 */
/* 098 */       boolean isNull1 = i.isNullAt(5);
/* 099 */       UTF8String value1 = isNull1 ? null : (i.getUTF8String(5));
...
/* 106 */     {
/* 107 */
/* 108 */       boolean isNull1 = i.isNullAt(5);
/* 109 */       UTF8String value1 = isNull1 ? null : (i.getUTF8String(5));
