...
/* 035 */
/* 036 */
/* 037 */     byte value = i.getByte(4);
/* 038 */     rowWriter.write(0, value);
/* 039 */
/* 040 */
/* 041 */     boolean isNull1 = i.isNullAt(5);
/* 042 */     UTF8String value1 = isNull1 ? null : (i.getUTF8String(5));
/* 043 */     if (isNull1) {
/* 044 */       rowWriter.setNullAt(1);
/* 045 */     } else {
/* 046 */       rowWriter.write(1, value1);
/* 047 */     }
/* 048 */     result.setTotalSize(holder.totalSize());
/* 049 */     return result;
/* 050 */   }
/* 051 */ }
