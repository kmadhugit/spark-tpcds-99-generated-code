...
/* 079 */         int scan_value = scan_isNull ? -1 : (scan_colInstance0.getInt(scan_rowIdx));
/* 080 */         boolean scan_isNull1 = scan_colInstance1.isNullAt(scan_rowIdx);
/* 081 */         int scan_value1 = scan_isNull1 ? -1 : (scan_colInstance1.getInt(scan_rowIdx));
/* 082 */         boolean scan_isNull2 = scan_colInstance2.isNullAt(scan_rowIdx);
/* 083 */         int scan_value2 = scan_isNull2 ? -1 : (scan_colInstance2.getInt(scan_rowIdx));
