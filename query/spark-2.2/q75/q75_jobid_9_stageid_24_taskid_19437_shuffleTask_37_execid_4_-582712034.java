...
/* 026 */       int value2 = isNull2 ? -1 : (i.getInt(3));
...
/* 036 */       int value2 = isNull2 ? -1 : (i.getInt(3));
...
/* 056 */     {
/* 057 */
/* 058 */       boolean isNull3 = i.isNullAt(4);
/* 059 */       int value3 = isNull3 ? -1 : (i.getInt(4));
...
/* 066 */     {
/* 067 */
/* 068 */       boolean isNull3 = i.isNullAt(4);
/* 069 */       int value3 = isNull3 ? -1 : (i.getInt(4));
...
/* 101 */       int value = isNull ? -1 : (i.getInt(1));
/* 102 */       isNullA = isNull;
...
/* 111 */       int value = isNull ? -1 : (i.getInt(1));
/* 112 */       isNullB = isNull;
...
/* 120 */       return 1;
/* 121 */     } else {
/* 122 */       int comp = (primitiveA > primitiveB ? 1 : primitiveA < primitiveB ? -1 : 0);
/* 123 */       if (comp != 0) {
/* 124 */         return comp;
/* 125 */       }
/* 126 */     }
...
/* 134 */       int value1 = isNull1 ? -1 : (i.getInt(2));
...
/* 144 */       int value1 = isNull1 ? -1 : (i.getInt(2));
