...
/* 014 */     result = new UnsafeRow(13);
/* 015 */     this.holder = new org.apache.spark.sql.catalyst.expressions.codegen.BufferHolder(result, 0);
/* 016 */     this.rowWriter = new org.apache.spark.sql.catalyst.expressions.codegen.UnsafeRowWriter(holder, 13);
/* 017 */
/* 018 */   }
/* 019 */
...
/* 065 */     int value9 = isNull9 ? -1 : (i.getInt(9));
/* 066 */     if (isNull9) {
...
/* 106 */     double value3 = isNull3 ? -1.0 : (i.getDouble(3));
/* 107 */     if (isNull3) {
...
/* 115 */     int value4 = isNull4 ? -1 : (i.getInt(4));
/* 116 */     if (isNull4) {
...
/* 129 */     int value10 = isNull10 ? -1 : (i.getInt(10));
/* 130 */     if (isNull10) {
...
/* 135 */
/* 136 */
/* 137 */     boolean isNull11 = i.isNullAt(11);
/* 138 */     int value11 = isNull11 ? -1 : (i.getInt(11));
/* 139 */     if (isNull11) {
/* 140 */       rowWriter.setNullAt(11);
/* 141 */     } else {
/* 142 */       rowWriter.write(11, value11);
/* 143 */     }
/* 144 */
/* 145 */
/* 146 */     boolean isNull12 = i.isNullAt(12);
/* 147 */     double value12 = isNull12 ? -1.0 : (i.getDouble(12));
/* 148 */     if (isNull12) {
/* 149 */       rowWriter.setNullAt(12);
/* 150 */     } else {
/* 151 */       rowWriter.write(12, value12);
/* 152 */     }
/* 153 */
/* 154 */   }
/* 155 */
/* 156 */
/* 157 */   // Scala.Function1 need this
/* 158 */   public java.lang.Object apply(java.lang.Object row) {
/* 159 */     return apply((InternalRow) row);
/* 160 */   }
/* 161 */
/* 162 */   public UnsafeRow apply(InternalRow i) {
/* 163 */     rowWriter.zeroOutNullBytes();
/* 164 */     apply_0(i);
/* 165 */     apply_1(i);
/* 166 */     apply_2(i);
/* 167 */     return result;
