...
/* 036 */     long value7 = isNull7 ? -1L : (i.getLong(6));
/* 037 */     if (isNull7) {
/* 038 */       values[6] = null;
/* 039 */     } else {
/* 040 */       values[6] = value7;
...
/* 044 */     long value8 = isNull8 ? -1L : (i.getLong(7));
/* 045 */     if (isNull8) {
/* 046 */       values[7] = null;
/* 047 */     } else {
/* 048 */       values[7] = value8;
...
/* 052 */     long value9 = isNull9 ? -1L : (i.getLong(8));
/* 053 */     if (isNull9) {
/* 054 */       values[8] = null;
/* 055 */     } else {
/* 056 */       values[8] = value9;
...
/* 097 */     int value4 = isNull4 ? -1 : (i.getInt(3));
/* 098 */     if (isNull4) {
/* 099 */       values[3] = null;
/* 100 */     } else {
/* 101 */       values[3] = value4;
...
/* 105 */     int value5 = isNull5 ? -1 : (i.getInt(4));
/* 106 */     if (isNull5) {
/* 107 */       values[4] = null;
/* 108 */     } else {
/* 109 */       values[4] = value5;
