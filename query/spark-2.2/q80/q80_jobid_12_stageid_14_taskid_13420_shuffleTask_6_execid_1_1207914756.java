...
/* 106 */
/* 107 */         boolean scan_isNull1 = scan_colInstance1.isNullAt(scan_rowIdx);
/* 108 */         int scan_value1 = scan_isNull1 ? -1 : (scan_colInstance1.getInt(scan_rowIdx));
/* 109 */
/* 110 */         if (!(!(scan_isNull1))) continue;
/* 111 */
/* 112 */         boolean scan_isNull2 = scan_colInstance2.isNullAt(scan_rowIdx);
/* 113 */         int scan_value2 = scan_isNull2 ? -1 : (scan_colInstance2.getInt(scan_rowIdx));
/* 114 */
/* 115 */         if (!(!(scan_isNull2))) continue;
/* 116 */
/* 117 */         filter_numOutputRows.add(1);
/* 118 */
/* 119 */         boolean scan_isNull3 = scan_colInstance3.isNullAt(scan_rowIdx);
/* 120 */         int scan_value3 = scan_isNull3 ? -1 : (scan_colInstance3.getInt(scan_rowIdx));
/* 121 */         boolean scan_isNull4 = scan_colInstance4.isNullAt(scan_rowIdx);
/* 122 */         double scan_value4 = scan_isNull4 ? -1.0 : (scan_colInstance4.getDouble(scan_rowIdx));
/* 123 */         boolean scan_isNull5 = scan_colInstance5.isNullAt(scan_rowIdx);
/* 124 */         double scan_value5 = scan_isNull5 ? -1.0 : (scan_colInstance5.getDouble(scan_rowIdx));
...
/* 130 */
/* 131 */         project_rowWriter.write(1, scan_value1);
/* 132 */
/* 133 */         project_rowWriter.write(2, scan_value2);
/* 134 */
/* 135 */         if (scan_isNull3) {
/* 136 */           project_rowWriter.setNullAt(3);
/* 137 */         } else {
/* 138 */           project_rowWriter.write(3, scan_value3);
/* 139 */         }
/* 140 */
/* 141 */         if (scan_isNull4) {
/* 142 */           project_rowWriter.setNullAt(4);
/* 143 */         } else {
/* 144 */           project_rowWriter.write(4, scan_value4);
/* 145 */         }
/* 146 */
/* 147 */         if (scan_isNull5) {
/* 148 */           project_rowWriter.setNullAt(5);
/* 149 */         } else {
/* 150 */           project_rowWriter.write(5, scan_value5);
/* 151 */         }
/* 152 */
/* 153 */         if (scan_isNull6) {
/* 154 */           project_rowWriter.setNullAt(6);
/* 155 */         } else {
/* 156 */           project_rowWriter.write(6, scan_value6);
/* 157 */         }
/* 158 */         append(project_result);
/* 159 */         if (shouldStop()) { scan_batchIdx = scan_rowIdx + 1; return; }
/* 160 */       }
/* 161 */       scan_batchIdx = scan_numRows;
/* 162 */       scan_batch = null;
/* 163 */       scan_nextBatch();
/* 164 */     }
/* 165 */     scan_scanTime.add(scan_scanTime1 / (1000 * 1000));
/* 166 */     scan_scanTime1 = 0;
/* 167 */   }
/* 168 */ }
