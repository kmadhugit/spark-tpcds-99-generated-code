...
/* 102 */
/* 103 */         boolean scan_isNull3 = scan_colInstance3.isNullAt(scan_rowIdx);
/* 104 */         int scan_value3 = scan_isNull3 ? -1 : (scan_colInstance3.getInt(scan_rowIdx));
/* 105 */
/* 106 */         if (!(!(scan_isNull3))) continue;
/* 107 */
/* 108 */         boolean scan_isNull2 = scan_colInstance2.isNullAt(scan_rowIdx);
/* 109 */         int scan_value2 = scan_isNull2 ? -1 : (scan_colInstance2.getInt(scan_rowIdx));
/* 110 */
/* 111 */         if (!(!(scan_isNull2))) continue;
/* 112 */
...
/* 120 */
/* 121 */         project_rowWriter.write(3, scan_value3);
