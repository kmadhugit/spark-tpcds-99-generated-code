...
/* 036 */     long value = isNull ? -1L : (i.getLong(0));
/* 037 */     if (isNull) {
...
/* 045 */     long value1 = isNull1 ? -1L : (i.getLong(1));
/* 046 */     if (isNull1) {
...
/* 054 */     long value2 = isNull2 ? -1L : (i.getLong(2));
/* 055 */     if (isNull2) {
...
/* 063 */     long value3 = isNull3 ? -1L : (i.getLong(3));
/* 064 */     if (isNull3) {
...
/* 069 */
/* 070 */
/* 071 */     boolean isNull4 = i.isNullAt(4);
/* 072 */     long value4 = isNull4 ? -1L : (i.getLong(4));
/* 073 */     if (isNull4) {
/* 074 */       rowWriter.setNullAt(4);
/* 075 */     } else {
/* 076 */       rowWriter.write(4, value4);
/* 077 */     }
/* 078 */     return result;
/* 079 */   }
/* 080 */ }
