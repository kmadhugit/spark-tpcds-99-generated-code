...
/* 026 */       int value2 = isNull2 ? -1 : (i.getInt(0));
...
/* 065 */     {
/* 066 */
/* 067 */       boolean isNull = i.isNullAt(2);
/* 068 */       double value = isNull ? -1.0 : (i.getDouble(2));
/* 069 */       isNullA = isNull;
/* 070 */       primitiveA = value;
/* 071 */     }
/* 072 */     i = b;
/* 073 */     boolean isNullB;
/* 074 */     double primitiveB;
/* 075 */     {
/* 076 */
/* 077 */       boolean isNull = i.isNullAt(2);
/* 078 */       double value = isNull ? -1.0 : (i.getDouble(2));
/* 079 */       isNullB = isNull;
...
/* 087 */       return 1;
/* 088 */     } else {
/* 089 */       int comp = org.apache.spark.util.Utils.nanSafeCompareDoubles(primitiveA, primitiveB);
/* 090 */       if (comp != 0) {
/* 091 */         return comp;
/* 092 */       }
/* 093 */     }
...
/* 097 */     double primitiveA1;
/* 098 */     {
/* 099 */
/* 100 */       boolean isNull1 = i.isNullAt(1);
/* 101 */       double value1 = isNull1 ? -1.0 : (i.getDouble(1));
/* 102 */       isNullA1 = isNull1;
/* 103 */       primitiveA1 = value1;
/* 104 */     }
/* 105 */     i = b;
/* 106 */     boolean isNullB1;
/* 107 */     double primitiveB1;
/* 108 */     {
/* 109 */
/* 110 */       boolean isNull1 = i.isNullAt(1);
/* 111 */       double value1 = isNull1 ? -1.0 : (i.getDouble(1));
...
/* 120 */       return 1;
/* 121 */     } else {
/* 122 */       int comp = org.apache.spark.util.Utils.nanSafeCompareDoubles(primitiveA1, primitiveB1);
/* 123 */       if (comp != 0) {
/* 124 */         return comp;
/* 125 */       }
/* 126 */     }
