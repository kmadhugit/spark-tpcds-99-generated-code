...
/* 309 */         boolean scan_isNull1 = scan_colInstance1.isNullAt(scan_rowIdx);
/* 310 */         int scan_value1 = scan_isNull1 ? -1 : (scan_colInstance1.getInt(scan_rowIdx));
/* 311 */
/* 312 */         if (!(!(scan_isNull1))) continue;
/* 313 */
...
/* 330 */         if (!false) {
/* 331 */           bhj_value = (long) scan_value1;
/* 332 */         }
...
/* 359 */         if (!false) {
/* 360 */           bhj_value23 = (long) scan_value;
/* 361 */         }
