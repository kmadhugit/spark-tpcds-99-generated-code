...
/* 122 */     int value9 = isNull9 ? -1 : (i.getInt(4));
/* 123 */     if (isNull9) {
/* 124 */       values[4] = null;
/* 125 */     } else {
/* 126 */       values[4] = value9;
...
/* 130 */     double value10 = isNull10 ? -1.0 : (i.getDouble(5));
/* 131 */     if (isNull10) {
/* 132 */       values[5] = null;
/* 133 */     } else {
...
/* 138 */     double value11 = isNull11 ? -1.0 : (i.getDouble(6));
/* 139 */     if (isNull11) {
/* 140 */       values[6] = null;
/* 141 */     } else {
...
/* 143 */     }
/* 144 */
/* 145 */     boolean isNull12 = i.isNullAt(7);
/* 146 */     double value12 = isNull12 ? -1.0 : (i.getDouble(7));
/* 147 */     if (isNull12) {
/* 148 */       values[7] = null;
/* 149 */     } else {
/* 150 */       values[7] = value12;
/* 151 */     }
/* 152 */
/* 153 */   }
/* 154 */
/* 155 */
/* 156 */   public java.lang.Object apply(java.lang.Object _i) {
/* 157 */     InternalRow i = (InternalRow) _i;
/* 158 */
/* 159 */     values = new Object[8];
/* 160 */     apply_0(i);
/* 161 */     apply_1(i);
/* 162 */     apply_2(i);
/* 163 */     final org.apache.spark.sql.Row value = new org.apache.spark.sql.catalyst.expressions.GenericRowWithSchema(values, schema);
/* 164 */     if (false) {
/* 165 */       mutableRow.setNullAt(0);
/* 166 */     } else {
/* 167 */
/* 168 */       mutableRow.update(0, value);
/* 169 */     }
/* 170 */
/* 171 */     return mutableRow;
/* 172 */   }
/* 173 */ }
