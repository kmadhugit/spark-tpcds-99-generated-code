...
/* 060 */     this.project_holder = new org.apache.spark.sql.catalyst.expressions.codegen.BufferHolder(project_result, 64);
/* 061 */
/* 062 */   }
/* 063 */
...
/* 097 */
/* 098 */         boolean scan_isNull1 = scan_colInstance1.isNullAt(scan_rowIdx);
/* 099 */         int scan_value1 = scan_isNull1 ? -1 : (scan_colInstance1.getInt(scan_rowIdx));
/* 100 */
/* 101 */         if (!(!(scan_isNull1))) continue;
/* 102 */
...
/* 109 */         project_holder.reset();
/* 110 */
/* 111 */         project_rowWriter.zeroOutNullBytes();
/* 112 */
/* 113 */         project_rowWriter.write(0, scan_value);
/* 114 */
/* 115 */         project_rowWriter.write(1, scan_value1);
/* 116 */
/* 117 */         if (scan_isNull2) {
/* 118 */           project_rowWriter.setNullAt(2);
/* 119 */         } else {
/* 120 */           project_rowWriter.write(2, scan_value2);
/* 121 */         }
/* 122 */
/* 123 */         if (scan_isNull3) {
...
/* 127 */         }
/* 128 */         project_result.setTotalSize(project_holder.totalSize());
/* 129 */         append(project_result);
/* 130 */         if (shouldStop()) { scan_batchIdx = scan_rowIdx + 1; return; }
/* 131 */       }
/* 132 */       scan_batchIdx = scan_numRows;
/* 133 */       scan_batch = null;
/* 134 */       scan_nextBatch();
/* 135 */     }
