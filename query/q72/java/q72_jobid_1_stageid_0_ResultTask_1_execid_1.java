...
/* 100 */         filter_value2 = scan_value3 == 1999;
...
/* 117 */         project_holder.reset();
/* 118 */
/* 119 */         project_rowWriter.zeroOutNullBytes();
/* 120 */
/* 121 */         project_rowWriter.write(0, scan_value);
/* 122 */
/* 123 */         if (scan_isNull1) {
/* 124 */           project_rowWriter.setNullAt(1);
/* 125 */         } else {
/* 126 */           project_rowWriter.write(1, scan_value1);
/* 127 */         }
/* 128 */
/* 129 */         project_rowWriter.write(2, scan_value2);
/* 130 */         project_result.setTotalSize(project_holder.totalSize());
