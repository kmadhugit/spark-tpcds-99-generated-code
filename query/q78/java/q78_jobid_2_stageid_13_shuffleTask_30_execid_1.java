...
/* 280 */     this.filter_rowWriter = new org.apache.spark.sql.catalyst.expressions.codegen.UnsafeRowWriter(filter_holder, 6);
...
/* 341 */       } else {
/* 342 */         filter_rowWriter.write(1, agg_value39);
/* 343 */       }
/* 344 */
/* 345 */       if (agg_isNull37) {
/* 346 */         filter_rowWriter.setNullAt(2);
/* 347 */       } else {
/* 348 */         filter_rowWriter.write(2, agg_value40);
/* 349 */       }
/* 350 */
/* 351 */       if (agg_isNull38) {
/* 352 */         filter_rowWriter.setNullAt(3);
/* 353 */       } else {
/* 354 */         filter_rowWriter.write(3, agg_value41);
/* 355 */       }
/* 356 */
/* 357 */       if (agg_isNull39) {
/* 358 */         filter_rowWriter.setNullAt(4);
/* 359 */       } else {
/* 360 */         filter_rowWriter.write(4, agg_value42);
/* 361 */       }
/* 362 */
/* 363 */       if (agg_isNull40) {
/* 364 */         filter_rowWriter.setNullAt(5);
/* 365 */       } else {
/* 366 */         filter_rowWriter.write(5, agg_value43);
/* 367 */       }
/* 368 */       append(filter_result);
/* 369 */
