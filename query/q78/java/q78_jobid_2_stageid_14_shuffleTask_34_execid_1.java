...
/* 015 */   private java.util.ArrayList smj_matches;
...
/* 150 */         } else {
/* 151 */           smj_matches.add(smj_rightRow.copy());
...
/* 161 */       int smj_size = smj_matches.size();
/* 162 */       smj_isNull6 = smj_leftRow.isNullAt(0);
/* 163 */       smj_value12 = smj_isNull6 ? -1 : (smj_leftRow.getInt(0));
/* 164 */       smj_isNull7 = smj_leftRow.isNullAt(1);
/* 165 */       smj_value13 = smj_isNull7 ? -1 : (smj_leftRow.getInt(1));
/* 166 */       smj_isNull8 = smj_leftRow.isNullAt(2);
/* 167 */       smj_value14 = smj_isNull8 ? -1 : (smj_leftRow.getInt(2));
/* 168 */       smj_isNull9 = smj_leftRow.isNullAt(3);
/* 169 */       smj_value15 = smj_isNull9 ? -1L : (smj_leftRow.getLong(3));
/* 170 */       smj_isNull10 = smj_leftRow.isNullAt(4);
/* 171 */       smj_value16 = smj_isNull10 ? -1.0 : (smj_leftRow.getDouble(4));
/* 172 */       smj_isNull11 = smj_leftRow.isNullAt(5);
/* 173 */       smj_value17 = smj_isNull11 ? -1.0 : (smj_leftRow.getDouble(5));
/* 174 */       for (int smj_i = 0; smj_i < smj_size; smj_i ++) {
/* 175 */         InternalRow smj_rightRow1 = (InternalRow) smj_matches.get(smj_i);
/* 176 */
...
/* 195 */         } else {
/* 196 */           project_rowWriter.write(1, smj_value14);
/* 197 */         }
/* 198 */
/* 199 */         if (smj_isNull9) {
/* 200 */           project_rowWriter.setNullAt(2);
/* 201 */         } else {
/* 202 */           project_rowWriter.write(2, smj_value15);
/* 203 */         }
/* 204 */
/* 205 */         if (smj_isNull10) {
/* 206 */           project_rowWriter.setNullAt(3);
/* 207 */         } else {
/* 208 */           project_rowWriter.write(3, smj_value16);
/* 209 */         }
/* 210 */
/* 211 */         if (smj_isNull11) {
/* 212 */           project_rowWriter.setNullAt(4);
/* 213 */         } else {
/* 214 */           project_rowWriter.write(4, smj_value17);
/* 215 */         }
/* 216 */
/* 217 */         if (smj_isNull15) {
/* 218 */           project_rowWriter.setNullAt(5);
/* 219 */         } else {
/* 220 */           project_rowWriter.write(5, smj_value21);
/* 221 */         }
/* 222 */
/* 223 */         if (smj_isNull16) {
/* 224 */           project_rowWriter.setNullAt(6);
/* 225 */         } else {
/* 226 */           project_rowWriter.write(6, smj_value22);
/* 227 */         }
/* 228 */
/* 229 */         if (smj_isNull17) {
/* 230 */           project_rowWriter.setNullAt(7);
/* 231 */         } else {
/* 232 */           project_rowWriter.write(7, smj_value23);
/* 233 */         }
/* 234 */         append(project_result.copy());
/* 235 */
/* 236 */       }
