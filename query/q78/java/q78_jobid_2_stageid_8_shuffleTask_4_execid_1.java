...
/* 023 */     {
/* 024 */
/* 025 */       boolean isNull1 = i.isNullAt(2);
/* 026 */       int value1 = isNull1 ? -1 : (i.getInt(2));
...
/* 038 */     {
/* 039 */
/* 040 */       boolean isNull1 = i.isNullAt(2);
/* 041 */       int value1 = isNull1 ? -1 : (i.getInt(2));
...
/* 067 */     {
/* 068 */
/* 069 */       boolean isNull3 = i.isNullAt(0);
/* 070 */       int value3 = isNull3 ? -1 : (i.getInt(0));
...
/* 082 */     {
/* 083 */
/* 084 */       boolean isNull3 = i.isNullAt(0);
/* 085 */       int value3 = isNull3 ? -1 : (i.getInt(0));
