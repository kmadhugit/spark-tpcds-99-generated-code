...
/* 097 */             } else if (scan_value.equals(filter_value2)) {
...
/* 108 */             } else if (scan_value.equals(filter_value3)) {
...
/* 119 */             } else if (scan_value.equals(filter_value4)) {
...
/* 124 */
/* 125 */         }
/* 126 */         if (filter_isNull || !filter_value) continue;
/* 127 */
...
/* 133 */
/* 134 */         if (scan_isNull1) {
/* 135 */           project_rowWriter.setNullAt(0);
/* 136 */         } else {
/* 137 */           project_rowWriter.write(0, scan_value1);
/* 138 */         }
/* 139 */         append(project_result);
