...
/* 038 */
/* 039 */     smj_matches = new java.util.ArrayList();
/* 040 */
...
/* 108 */         } else {
/* 109 */           smj_matches.add(smj_rightRow.copy());
...
/* 119 */       int smj_size = smj_matches.size();
/* 120 */       smj_isNull2 = smj_leftRow.isNullAt(0);
/* 121 */       smj_value4 = smj_isNull2 ? null : (smj_leftRow.getUTF8String(0));
/* 122 */       smj_isNull3 = smj_leftRow.isNullAt(1);
/* 123 */       smj_value5 = smj_isNull3 ? -1L : (smj_leftRow.getLong(1));
/* 124 */       for (int smj_i = 0; smj_i < smj_size; smj_i ++) {
/* 125 */         InternalRow smj_rightRow1 = (InternalRow) smj_matches.get(smj_i);
/* 126 */
