...
/* 047 */     this.agg_holder1 = new org.apache.spark.sql.catalyst.expressions.codegen.BufferHolder(agg_result1, 64);
...
/* 151 */           agg_value18 = org.apache.spark.unsafe.hash.Murmur3_x86_32.hashInt(inputadapter_value3, agg_value18);
/* 152 */         }
/* 153 */
...
/* 167 */           agg_value18 = org.apache.spark.unsafe.hash.Murmur3_x86_32.hashUnsafeBytes(inputadapter_value7.getBaseObject(), inputadapter_value7.getBaseOffset(), inputadapter_value7.numBytes(), agg_value18);
/* 168 */         }
/* 169 */         if (true) {
...
/* 271 */       int agg_value38 = agg_isNull37 ? -1 : (agg_aggKey.getInt(3));
...
/* 279 */       UTF8String agg_value42 = agg_isNull41 ? null : (agg_aggKey.getUTF8String(7));
...
/* 295 */       } else {
/* 296 */         agg_rowWriter1.write(1, agg_value39);
/* 297 */       }
/* 298 */
/* 299 */       if (agg_isNull42) {
/* 300 */         agg_rowWriter1.setNullAt(2);
/* 301 */       } else {
/* 302 */         agg_rowWriter1.write(2, agg_value43);
/* 303 */       }
/* 304 */       agg_result1.setTotalSize(agg_holder1.totalSize());
/* 305 */       append(agg_result1);
/* 306 */
/* 307 */       if (shouldStop()) return;
/* 308 */     }
/* 309 */
/* 310 */     agg_mapIter.close();
/* 311 */     if (agg_sorter == null) {
/* 312 */       agg_hashMap.free();
/* 313 */     }
/* 314 */   }
/* 315 */ }
