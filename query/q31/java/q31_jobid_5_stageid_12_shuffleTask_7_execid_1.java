...
/* 099 */           agg_value8 = org.apache.spark.unsafe.hash.Murmur3_x86_32.hashUnsafeBytes(inputadapter_value.getBaseObject(), inputadapter_value.getBaseOffset(), inputadapter_value.numBytes(), agg_value8);
/* 100 */         }
/* 101 */
...
/* 107 */           agg_value8 = org.apache.spark.unsafe.hash.Murmur3_x86_32.hashInt(inputadapter_value2, agg_value8);
/* 108 */         }
/* 109 */         if (true) {
...
/* 205 */       UTF8String agg_value20 = agg_isNull19 ? null : (agg_aggKey.getUTF8String(0));
...
/* 209 */       int agg_value22 = agg_isNull21 ? -1 : (agg_aggKey.getInt(2));
...
/* 225 */       } else {
/* 226 */         agg_rowWriter1.write(1, agg_value22);
/* 227 */       }
/* 228 */
/* 229 */       if (agg_isNull22) {
/* 230 */         agg_rowWriter1.setNullAt(2);
/* 231 */       } else {
/* 232 */         agg_rowWriter1.write(2, agg_value23);
/* 233 */       }
/* 234 */       agg_result1.setTotalSize(agg_holder1.totalSize());
/* 235 */       append(agg_result1);
/* 236 */
/* 237 */       if (shouldStop()) return;
/* 238 */     }
/* 239 */
/* 240 */     agg_mapIter.close();
/* 241 */     if (agg_sorter == null) {
/* 242 */       agg_hashMap.free();
/* 243 */     }
/* 244 */   }
/* 245 */ }
