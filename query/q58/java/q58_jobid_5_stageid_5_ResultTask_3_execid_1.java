...
/* 192 */       int numRows = scan_batch.numRows();
/* 193 */       while (scan_batchIdx < numRows) {
/* 194 */         int scan_rowIdx = scan_batchIdx++;
...
/* 199 */
/* 200 */         filter_numOutputRows.add(1);
/* 201 */
/* 202 */         boolean scan_isNull2 = scan_colInstance2.isNullAt(scan_rowIdx);
/* 203 */         UTF8String scan_value2 = scan_isNull2 ? null : (scan_colInstance2.getUTF8String(scan_rowIdx));
/* 204 */
/* 205 */         // generate join key for stream side
/* 206 */
/* 207 */         bhj_holder.reset();
/* 208 */
/* 209 */         bhj_rowWriter.zeroOutNullBytes();
/* 210 */
/* 211 */         if (scan_isNull2) {
/* 212 */           bhj_rowWriter.setNullAt(0);
/* 213 */         } else {
/* 214 */           bhj_rowWriter.write(0, scan_value2);
/* 215 */         }
/* 216 */         bhj_result.setTotalSize(bhj_holder.totalSize());
/* 217 */
/* 218 */         // find matches from HashedRelation
/* 219 */         UnsafeRow bhj_matched = bhj_result.anyNull() ? null: (UnsafeRow)bhj_relation.getValue(bhj_result);
/* 220 */         if (bhj_matched == null) continue;
/* 221 */
/* 222 */         bhj_numOutputRows.add(1);
/* 223 */
/* 224 */         project_rowWriter1.write(0, scan_value);
