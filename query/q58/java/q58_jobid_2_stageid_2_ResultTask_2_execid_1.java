...
/* 090 */
/* 091 */         boolean filter_isNull2 = true;
/* 092 */         boolean filter_value2 = false;
/* 093 */
/* 094 */         if (!false) {
/* 095 */           filter_isNull2 = false; // resultCode could change nullability.
/* 096 */           filter_value2 = scan_value1 == 5218;
/* 097 */
/* 098 */         }
/* 099 */         if (filter_isNull2 || !filter_value2) continue;
/* 100 */
/* 101 */         filter_numOutputRows.add(1);
/* 102 */
/* 103 */         boolean scan_isNull = scan_colInstance0.isNullAt(scan_rowIdx);
/* 104 */         UTF8String scan_value = scan_isNull ? null : (scan_colInstance0.getUTF8String(scan_rowIdx));
/* 105 */         project_holder.reset();
/* 106 */
/* 107 */         project_rowWriter.zeroOutNullBytes();
/* 108 */
/* 109 */         if (scan_isNull) {
/* 110 */           project_rowWriter.setNullAt(0);
/* 111 */         } else {
...
/* 119 */       scan_nextBatch();
/* 120 */     }
/* 121 */     scan_scanTime.add(scan_scanTime1 / (1000 * 1000));
