...
/* 192 */     double primitiveA5;
/* 193 */     {
/* 194 */
/* 195 */       boolean isNull5 = i.isNullAt(5);
/* 196 */       double value5 = isNull5 ? -1.0 : (i.getDouble(5));
/* 197 */       isNullA5 = isNull5;
/* 198 */       primitiveA5 = value5;
/* 199 */     }
/* 200 */     i = b;
/* 201 */     boolean isNullB5;
/* 202 */     double primitiveB5;
/* 203 */     {
/* 204 */
/* 205 */       boolean isNull5 = i.isNullAt(5);
/* 206 */       double value5 = isNull5 ? -1.0 : (i.getDouble(5));
...
/* 215 */       return 1;
/* 216 */     } else {
/* 217 */       int comp = org.apache.spark.util.Utils.nanSafeCompareDoubles(primitiveA5, primitiveB5);
/* 218 */       if (comp != 0) {
/* 219 */         return comp;
/* 220 */       }
/* 221 */     }
...
/* 230 */       double value6 = isNull6 ? -1.0 : (i.getDouble(6));
...
/* 240 */       double value6 = isNull6 ? -1.0 : (i.getDouble(6));
...
/* 264 */       double value7 = isNull7 ? -1.0 : (i.getDouble(7));
...
/* 274 */       double value7 = isNull7 ? -1.0 : (i.getDouble(7));
