...
/* 057 */     this.scan_holder = new org.apache.spark.sql.catalyst.expressions.codegen.BufferHolder(scan_result, 64);
...
/* 061 */     this.filter_holder = new org.apache.spark.sql.catalyst.expressions.codegen.BufferHolder(filter_result, 64);
...
/* 085 */     this.project_holder = new org.apache.spark.sql.catalyst.expressions.codegen.BufferHolder(project_result, 64);
...
/* 099 */         int scan_value5 = scan_isNull5 ? -1 : (scan_colInstance5.getInt(scan_rowIdx));
/* 100 */
/* 101 */         if (!(!(scan_isNull5))) continue;
/* 102 */
/* 103 */         boolean filter_isNull2 = false;
/* 104 */
/* 105 */         boolean filter_value2 = false;
/* 106 */         filter_value2 = scan_value5 == 7;
/* 107 */         if (!filter_value2) continue;
/* 108 */
...
/* 113 */
/* 114 */         filter_numOutputRows.add(1);
/* 115 */
/* 116 */         boolean scan_isNull1 = scan_colInstance1.isNullAt(scan_rowIdx);
/* 117 */         int scan_value1 = scan_isNull1 ? -1 : (scan_colInstance1.getInt(scan_rowIdx));
/* 118 */         boolean scan_isNull2 = scan_colInstance2.isNullAt(scan_rowIdx);
/* 119 */         UTF8String scan_value2 = scan_isNull2 ? null : (scan_colInstance2.getUTF8String(scan_rowIdx));
...
/* 123 */         UTF8String scan_value4 = scan_isNull4 ? null : (scan_colInstance4.getUTF8String(scan_rowIdx));
/* 124 */         project_holder.reset();
/* 125 */
...
/* 135 */
/* 136 */         if (scan_isNull2) {
/* 137 */           project_rowWriter.setNullAt(2);
/* 138 */         } else {
/* 139 */           project_rowWriter.write(2, scan_value2);
/* 140 */         }
/* 141 */
/* 142 */         if (scan_isNull3) {
/* 143 */           project_rowWriter.setNullAt(3);
/* 144 */         } else {
/* 145 */           project_rowWriter.write(3, scan_value3);
/* 146 */         }
/* 147 */
/* 148 */         if (scan_isNull4) {
...
/* 152 */         }
/* 153 */         project_result.setTotalSize(project_holder.totalSize());
/* 154 */         append(project_result);
/* 155 */         if (shouldStop()) return;
/* 156 */       }
/* 157 */       scan_batch = null;
/* 158 */       scan_nextBatch();
/* 159 */     }
/* 160 */     scan_scanTime.add(scan_scanTime1 / (1000 * 1000));
/* 161 */     scan_scanTime1 = 0;
/* 162 */   }
/* 163 */ }
