...
/* 022 */
/* 023 */     Platform.putLong(buf, 24, Platform.getLong(obj1, offset1 + 0) | (Platform.getLong(obj2, offset2) << 5));
/* 024 */
...
/* 053 */
/* 054 */
/* 055 */     Platform.putLong(buf, 32, Platform.getLong(buf, 32) + (24L << 32));
/* 056 */
/* 057 */
/* 058 */     Platform.putLong(buf, 40, Platform.getLong(buf, 40) + (24L << 32));
/* 059 */
/* 060 */
/* 061 */     Platform.putLong(buf, 48, Platform.getLong(buf, 48) + (24L << 32));
/* 062 */
/* 063 */
/* 064 */
/* 065 */     Platform.putLong(buf, 64, Platform.getLong(buf, 64) + (24L << 32));
/* 066 */
/* 067 */
/* 068 */
/* 069 */
