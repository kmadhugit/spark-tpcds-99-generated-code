...
/* 038 */       boolean inputadapter_isNull2 = inputadapter_row.isNullAt(2);
/* 039 */       int inputadapter_value2 = inputadapter_isNull2 ? -1 : (inputadapter_row.getInt(2));
/* 040 */       boolean inputadapter_isNull3 = inputadapter_row.isNullAt(3);
/* 041 */       int inputadapter_value3 = inputadapter_isNull3 ? -1 : (inputadapter_row.getInt(3));
/* 042 */
...
/* 058 */
/* 059 */         if (!inputadapter_isNull2) {
/* 060 */           filter_isNull4 = false; // resultCode could change nullability.
/* 061 */           filter_value4 = inputadapter_value2 <= 10;
/* 062 */
/* 063 */         }
...
/* 103 */       }
/* 104 */
/* 105 */       if (inputadapter_isNull2) {
/* 106 */         project_rowWriter.setNullAt(4);
/* 107 */       } else {
/* 108 */         project_rowWriter.write(4, inputadapter_value2);
/* 109 */       }
