...
/* 111 */           agg_value10 = org.apache.spark.unsafe.hash.Murmur3_x86_32.hashUnsafeBytes(inputadapter_value1.getBaseObject(), inputadapter_value1.getBaseOffset(), inputadapter_value1.numBytes(), agg_value10);
/* 112 */         }
/* 113 */
/* 114 */         if (!inputadapter_isNull2) {
/* 115 */           agg_value10 = org.apache.spark.unsafe.hash.Murmur3_x86_32.hashUnsafeBytes(inputadapter_value2.getBaseObject(), inputadapter_value2.getBaseOffset(), inputadapter_value2.numBytes(), agg_value10);
/* 116 */         }
/* 117 */
...
/* 219 */       UTF8String agg_value24 = agg_isNull23 ? null : (agg_aggKey.getUTF8String(1));
/* 220 */       boolean agg_isNull24 = agg_aggKey.isNullAt(2);
/* 221 */       UTF8String agg_value25 = agg_isNull24 ? null : (agg_aggKey.getUTF8String(2));
...
/* 233 */       } else {
/* 234 */         agg_rowWriter1.write(0, agg_value23);
/* 235 */       }
/* 236 */
/* 237 */       if (agg_isNull23) {
/* 238 */         agg_rowWriter1.setNullAt(1);
/* 239 */       } else {
/* 240 */         agg_rowWriter1.write(1, agg_value24);
/* 241 */       }
/* 242 */
/* 243 */       if (agg_isNull24) {
...
/* 251 */       } else {
/* 252 */         agg_rowWriter1.write(3, agg_value27);
/* 253 */       }
/* 254 */       agg_result1.setTotalSize(agg_holder1.totalSize());
