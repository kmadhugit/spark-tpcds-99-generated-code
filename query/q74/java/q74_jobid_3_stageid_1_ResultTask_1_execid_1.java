...
/* 055 */     project_result = new UnsafeRow(2);
...
/* 087 */         int scan_value1 = scan_isNull1 ? -1 : (scan_colInstance1.getInt(scan_rowIdx));
/* 088 */
/* 089 */         if (!(!(scan_isNull1))) continue;
/* 090 */
/* 091 */         boolean filter_value2 = false;
/* 092 */         boolean filter_isNull2 = scan_isNull1;
/* 093 */         if (!filter_isNull2) {
/* 094 */           if (!filter_value2) {
/* 095 */             if (false) {
/* 096 */               filter_isNull2 = true;
/* 097 */             } else if (scan_value1 == 2001) {
/* 098 */               filter_isNull2 = false;
/* 099 */               filter_value2 = true;
/* 100 */             }
/* 101 */           }
/* 102 */
/* 103 */           if (!filter_value2) {
/* 104 */             if (false) {
/* 105 */               filter_isNull2 = true;
/* 106 */             } else if (scan_value1 == 2002) {
/* 107 */               filter_isNull2 = false;
/* 108 */               filter_value2 = true;
/* 109 */             }
/* 110 */           }
/* 111 */
/* 112 */         }
/* 113 */         if (!filter_value2) continue;
/* 114 */         boolean filter_isNull6 = false;
/* 115 */
/* 116 */         boolean filter_value6 = false;
/* 117 */         filter_value6 = scan_value1 == 2001;
/* 118 */         if (!filter_value6) continue;
/* 119 */
/* 120 */         boolean scan_isNull = scan_colInstance0.isNullAt(scan_rowIdx);
/* 121 */         int scan_value = scan_isNull ? -1 : (scan_colInstance0.getInt(scan_rowIdx));
/* 122 */
/* 123 */         if (!(!(scan_isNull))) continue;
/* 124 */
...
/* 134 */       scan_nextBatch();
/* 135 */     }
/* 136 */     scan_scanTime.add(scan_scanTime1 / (1000 * 1000));
/* 137 */     scan_scanTime1 = 0;
/* 138 */   }
/* 139 */ }
