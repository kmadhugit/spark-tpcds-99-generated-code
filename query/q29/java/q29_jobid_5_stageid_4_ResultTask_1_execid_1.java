...
/* 097 */         filter_value2 = scan_value2 >= 9;
...
/* 114 */
/* 115 */         boolean scan_isNull = scan_colInstance0.isNullAt(scan_rowIdx);
/* 116 */         int scan_value = scan_isNull ? -1 : (scan_colInstance0.getInt(scan_rowIdx));
/* 117 */
/* 118 */         if (!(!(scan_isNull))) continue;
/* 119 */
