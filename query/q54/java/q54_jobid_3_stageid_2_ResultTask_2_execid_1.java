...
/* 090 */
/* 091 */         boolean scan_isNull = scan_colInstance0.isNullAt(scan_rowIdx);
/* 092 */         UTF8String scan_value = scan_isNull ? null : (scan_colInstance0.getUTF8String(scan_rowIdx));
/* 093 */
/* 094 */         if (!(!(scan_isNull))) continue;
/* 095 */
/* 096 */         filter_numOutputRows.add(1);
/* 097 */
/* 098 */         project_holder.reset();
/* 099 */
/* 100 */         project_rowWriter.write(0, scan_value);
/* 101 */
/* 102 */         project_rowWriter.write(1, scan_value1);
/* 103 */         project_result.setTotalSize(project_holder.totalSize());
...
/* 108 */       scan_nextBatch();
/* 109 */     }
/* 110 */     scan_scanTime.add(scan_scanTime1 / (1000 * 1000));
