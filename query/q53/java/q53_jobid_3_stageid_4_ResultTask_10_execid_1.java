...
/* 026 */       double value = isNull ? -1.0 : (i.getDouble(2));
/* 027 */       isNullA = isNull;
...
/* 036 */       double value = isNull ? -1.0 : (i.getDouble(2));
/* 037 */       isNullB = isNull;
...
/* 094 */       int value2 = isNull2 ? -1 : (i.getInt(0));
...
/* 104 */       int value2 = isNull2 ? -1 : (i.getInt(0));
