...
/* 169 */       int numRows = scan_batch.numRows();
/* 170 */       while (scan_batchIdx < numRows) {
/* 171 */         int scan_rowIdx = scan_batchIdx++;
/* 172 */         boolean scan_isNull = scan_colInstance0.isNullAt(scan_rowIdx);
/* 173 */         int scan_value = scan_isNull ? -1 : (scan_colInstance0.getInt(scan_rowIdx));
/* 174 */
/* 175 */         if (!(!(scan_isNull))) continue;
/* 176 */
/* 177 */         filter_numOutputRows.add(1);
/* 178 */
/* 179 */         boolean scan_isNull13 = scan_colInstance13.isNullAt(scan_rowIdx);
/* 180 */         int scan_value13 = scan_isNull13 ? -1 : (scan_colInstance13.getInt(scan_rowIdx));
/* 181 */
/* 182 */         // generate join key for stream side
/* 183 */
/* 184 */         boolean bhj_isNull = scan_isNull13;
/* 185 */         long bhj_value = -1L;
/* 186 */         if (!scan_isNull13) {
/* 187 */           bhj_value = (long) scan_value13;
/* 188 */         }
/* 189 */         // find matches from HashRelation
/* 190 */         scala.collection.Iterator bhj_matches = bhj_isNull ? null : (scala.collection.Iterator)bhj_relation.get(bhj_value);
/* 191 */         if (bhj_matches == null) continue;
/* 192 */         boolean bhj_found = false;
/* 193 */         while (!bhj_found && bhj_matches.hasNext()) {
/* 194 */           UnsafeRow bhj_matched = (UnsafeRow) bhj_matches.next();
/* 195 */
/* 196 */           bhj_found = true;
/* 197 */         }
/* 198 */         if (!bhj_found) continue;
/* 199 */         bhj_numOutputRows.add(1);
/* 200 */
/* 201 */         project_rowWriter1.zeroOutNullBytes();
/* 202 */
/* 203 */         project_rowWriter1.write(0, scan_value);
/* 204 */
/* 205 */         if (scan_isNull13) {
/* 206 */           project_rowWriter1.setNullAt(1);
/* 207 */         } else {
/* 208 */           project_rowWriter1.write(1, scan_value13);
/* 209 */         }
/* 210 */         append(project_result1);
/* 211 */         if (shouldStop()) return;
/* 212 */       }
/* 213 */       scan_batch = null;
/* 214 */       scan_nextBatch();
/* 215 */     }
/* 216 */     scan_scanTime.add(scan_scanTime1 / (1000 * 1000));
/* 217 */     scan_scanTime1 = 0;
/* 218 */   }
/* 219 */ }
