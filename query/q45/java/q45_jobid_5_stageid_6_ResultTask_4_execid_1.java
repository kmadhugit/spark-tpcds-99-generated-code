...
/* 043 */     this.agg_holder = new org.apache.spark.sql.catalyst.expressions.codegen.BufferHolder(agg_result, 64);
...
/* 095 */           agg_value6 = org.apache.spark.unsafe.hash.Murmur3_x86_32.hashUnsafeBytes(inputadapter_value1.getBaseObject(), inputadapter_value1.getBaseOffset(), inputadapter_value1.numBytes(), agg_value6);
/* 096 */         }
/* 097 */         if (true) {
...
/* 195 */       UTF8String agg_value18 = agg_isNull17 ? null : (agg_aggKey.getUTF8String(1));
...
/* 205 */       } else {
/* 206 */         agg_rowWriter1.write(0, agg_value17);
/* 207 */       }
/* 208 */
/* 209 */       if (agg_isNull17) {
/* 210 */         agg_rowWriter1.setNullAt(1);
/* 211 */       } else {
/* 212 */         agg_rowWriter1.write(1, agg_value18);
/* 213 */       }
/* 214 */
/* 215 */       if (agg_isNull18) {
