...
/* 118 */       int numRows = scan_batch.numRows();
/* 119 */       while (scan_batchIdx < numRows) {
/* 120 */         int scan_rowIdx = scan_batchIdx++;
/* 121 */         boolean scan_isNull1 = scan_colInstance1.isNullAt(scan_rowIdx);
/* 122 */         double scan_value1 = scan_isNull1 ? -1.0 : (scan_colInstance1.getDouble(scan_rowIdx));
/* 123 */
...
/* 132 */         UTF8String scan_value2 = scan_isNull2 ? null : (scan_colInstance2.getUTF8String(scan_rowIdx));
/* 133 */
...
/* 139 */
/* 140 */         bhj_holder.reset();
/* 141 */
/* 142 */         bhj_rowWriter.write(0, scan_value2);
/* 143 */         bhj_result.setTotalSize(bhj_holder.totalSize());
/* 144 */
/* 145 */         // find matches from HashedRelation
/* 146 */         UnsafeRow bhj_matched = bhj_result.anyNull() ? null: (UnsafeRow)bhj_relation.getValue(bhj_result);
/* 147 */         if (bhj_matched == null) continue;
/* 148 */
/* 149 */         double bhj_value1 = bhj_matched.getDouble(0);
/* 150 */
/* 151 */         boolean bhj_isNull3 = true;
/* 152 */         boolean bhj_value3 = false;
/* 153 */
/* 154 */         if (!false) {
/* 155 */           boolean bhj_isNull5 = false;
/* 156 */
/* 157 */           double bhj_value5 = -1.0;
/* 158 */           bhj_value5 = 1.2D * bhj_value1;
/* 159 */
/* 160 */           bhj_isNull3 = false; // resultCode could change nullability.
/* 161 */           bhj_value3 = org.apache.spark.util.Utils.nanSafeCompareDoubles(scan_value1, bhj_value5) > 0;
/* 162 */
/* 163 */         }
/* 164 */         if (bhj_isNull3 || !bhj_value3) continue;
/* 165 */
/* 166 */         bhj_numOutputRows.add(1);
/* 167 */
/* 168 */         project_rowWriter1.write(0, scan_value);
/* 169 */         append(project_result1);
/* 170 */         if (shouldStop()) return;
/* 171 */       }
/* 172 */       scan_batch = null;
/* 173 */       scan_nextBatch();
/* 174 */     }
/* 175 */     scan_scanTime.add(scan_scanTime1 / (1000 * 1000));
/* 176 */     scan_scanTime1 = 0;
/* 177 */   }
/* 178 */ }
