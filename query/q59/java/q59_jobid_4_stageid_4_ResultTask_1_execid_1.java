...
/* 095 */         UTF8String scan_value1 = scan_isNull1 ? null : (scan_colInstance1.getUTF8String(scan_rowIdx));
/* 096 */
/* 097 */         if (!(!(scan_isNull1))) continue;
/* 098 */
/* 099 */         filter_numOutputRows.add(1);
/* 100 */
/* 101 */         boolean scan_isNull2 = scan_colInstance2.isNullAt(scan_rowIdx);
/* 102 */         UTF8String scan_value2 = scan_isNull2 ? null : (scan_colInstance2.getUTF8String(scan_rowIdx));
/* 103 */         project_holder.reset();
/* 104 */
/* 105 */         project_rowWriter.zeroOutNullBytes();
/* 106 */
/* 107 */         project_rowWriter.write(0, scan_value);
/* 108 */
/* 109 */         project_rowWriter.write(1, scan_value1);
/* 110 */
/* 111 */         if (scan_isNull2) {
...
/* 115 */         }
/* 116 */         project_result.setTotalSize(project_holder.totalSize());
/* 117 */         append(project_result);
/* 118 */         if (shouldStop()) return;
/* 119 */       }
/* 120 */       scan_batch = null;
/* 121 */       scan_nextBatch();
/* 122 */     }
