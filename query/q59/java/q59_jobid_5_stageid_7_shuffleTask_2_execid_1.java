...
/* 435 */     this.bhj_rowWriter1 = new org.apache.spark.sql.catalyst.expressions.codegen.UnsafeRowWriter(bhj_holder1, 11);
/* 436 */     project_result1 = new UnsafeRow(10);
/* 437 */     this.project_holder1 = new org.apache.spark.sql.catalyst.expressions.codegen.BufferHolder(project_result1, 64);
/* 438 */     this.project_rowWriter1 = new org.apache.spark.sql.catalyst.expressions.codegen.UnsafeRowWriter(project_holder1, 10);
...
/* 446 */     bhj_result = new UnsafeRow(12);
/* 447 */     this.bhj_holder = new org.apache.spark.sql.catalyst.expressions.codegen.BufferHolder(bhj_result, 64);
/* 448 */     this.bhj_rowWriter = new org.apache.spark.sql.catalyst.expressions.codegen.UnsafeRowWriter(bhj_holder, 12);
/* 449 */     project_result = new UnsafeRow(10);
/* 450 */     this.project_holder = new org.apache.spark.sql.catalyst.expressions.codegen.BufferHolder(project_result, 64);
/* 451 */     this.project_rowWriter = new org.apache.spark.sql.catalyst.expressions.codegen.UnsafeRowWriter(project_holder, 10);
...
/* 458 */     bhj_result1 = new UnsafeRow(11);
/* 459 */     this.bhj_holder1 = new org.apache.spark.sql.catalyst.expressions.codegen.BufferHolder(bhj_result1, 64);
/* 460 */
/* 461 */   }
/* 462 */
...
/* 511 */
/* 512 */       boolean bhj_isNull17 = agg_isNull58;
/* 513 */       long bhj_value17 = -1L;
/* 514 */       if (!agg_isNull58) {
/* 515 */         bhj_value17 = (long) agg_value65;
/* 516 */       }
/* 517 */       // find matches from HashRelation
/* 518 */       scala.collection.Iterator bhj_matches = bhj_isNull17 ? null : (scala.collection.Iterator)bhj_relation1.get(bhj_value17);
...
/* 524 */
/* 525 */         boolean bhj_isNull4 = bhj_matched.isNullAt(2);
/* 526 */         UTF8String bhj_value4 = bhj_isNull4 ? null : (bhj_matched.getUTF8String(2));
/* 527 */         boolean bhj_isNull3 = bhj_matched.isNullAt(1);
/* 528 */         UTF8String bhj_value3 = bhj_isNull3 ? null : (bhj_matched.getUTF8String(1));
/* 529 */         project_holder1.reset();
/* 530 */
/* 531 */         project_rowWriter1.zeroOutNullBytes();
/* 532 */
/* 533 */         if (bhj_isNull4) {
/* 534 */           project_rowWriter1.setNullAt(0);
/* 535 */         } else {
/* 536 */           project_rowWriter1.write(0, bhj_value4);
/* 537 */         }
/* 538 */
/* 539 */         if (agg_isNull58) {
/* 540 */           project_rowWriter1.setNullAt(1);
/* 541 */         } else {
/* 542 */           project_rowWriter1.write(1, agg_value65);
/* 543 */         }
/* 544 */
/* 545 */         if (bhj_isNull3) {
/* 546 */           project_rowWriter1.setNullAt(2);
/* 547 */         } else {
/* 548 */           project_rowWriter1.write(2, bhj_value3);
/* 549 */         }
/* 550 */
/* 551 */         if (agg_isNull60) {
/* 552 */           project_rowWriter1.setNullAt(3);
/* 553 */         } else {
/* 554 */           project_rowWriter1.write(3, agg_value67);
/* 555 */         }
/* 556 */
/* 557 */         if (agg_isNull61) {
/* 558 */           project_rowWriter1.setNullAt(4);
/* 559 */         } else {
/* 560 */           project_rowWriter1.write(4, agg_value68);
/* 561 */         }
/* 562 */
/* 563 */         if (agg_isNull62) {
/* 564 */           project_rowWriter1.setNullAt(5);
/* 565 */         } else {
/* 566 */           project_rowWriter1.write(5, agg_value69);
/* 567 */         }
/* 568 */
/* 569 */         if (agg_isNull63) {
/* 570 */           project_rowWriter1.setNullAt(6);
/* 571 */         } else {
/* 572 */           project_rowWriter1.write(6, agg_value70);
/* 573 */         }
/* 574 */
/* 575 */         if (agg_isNull64) {
/* 576 */           project_rowWriter1.setNullAt(7);
/* 577 */         } else {
/* 578 */           project_rowWriter1.write(7, agg_value71);
/* 579 */         }
/* 580 */
/* 581 */         if (agg_isNull65) {
/* 582 */           project_rowWriter1.setNullAt(8);
/* 583 */         } else {
/* 584 */           project_rowWriter1.write(8, agg_value72);
/* 585 */         }
/* 586 */
/* 587 */         if (agg_isNull66) {
/* 588 */           project_rowWriter1.setNullAt(9);
/* 589 */         } else {
/* 590 */           project_rowWriter1.write(9, agg_value73);
/* 591 */         }
/* 592 */         project_result1.setTotalSize(project_holder1.totalSize());
/* 593 */         append(project_result1.copy());
/* 594 */
/* 595 */       }
/* 596 */
