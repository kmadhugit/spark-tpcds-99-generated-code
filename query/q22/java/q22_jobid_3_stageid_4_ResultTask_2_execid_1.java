...
/* 060 */       UTF8String value1 = isNull1 ? null : (i.getUTF8String(0));
...
/* 070 */       UTF8String value1 = isNull1 ? null : (i.getUTF8String(0));
...
/* 125 */     {
/* 126 */
/* 127 */       boolean isNull3 = i.isNullAt(2);
/* 128 */       UTF8String value3 = isNull3 ? null : (i.getUTF8String(2));
...
/* 135 */     {
/* 136 */
/* 137 */       boolean isNull3 = i.isNullAt(2);
/* 138 */       UTF8String value3 = isNull3 ? null : (i.getUTF8String(2));
...
/* 159 */     {
/* 160 */
/* 161 */       boolean isNull4 = i.isNullAt(3);
/* 162 */       UTF8String value4 = isNull4 ? null : (i.getUTF8String(3));
...
/* 169 */     {
/* 170 */
/* 171 */       boolean isNull4 = i.isNullAt(3);
/* 172 */       UTF8String value4 = isNull4 ? null : (i.getUTF8String(3));
